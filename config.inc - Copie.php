...
$TYPEBUDGET = array(""=>"Choisirle type de budget...","FAIR"=>"Budget Sp&eacute;cial du FAIR",
"FRDA"=>"Budget Sp&eacute;cial du FRDA",
"ORGANES"=>"Budget des Organes",
"EXTERIEUR"=>"Prise en charge ext&eacute;rieure",
"CONTRIBUTION"=>"Contribution aux projets ext&eacute;rieurs");
...
// root directory path
//$root_directory = 'C:/wamp/www/portailnomade/';
$root_directory = 'C:/xampp/htdocs/portailnomade/';
