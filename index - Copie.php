...
header("Location: index.php?action=DetailView&module=Tiers&record=1994");
*/
...
//echo "profilid=$current_user->profilid";
	$defmodule=$default_module;
  	switch ($current_user->profilid) {
		case 20 : {$defmodule=$default_module;break;}
		case 21 : {$defmodule=$default_module;break;}
		case 22 : {$defmodule=$default_dfb_module;break;}
		case 23 : {$defmodule=$default_mod_module;break;}
