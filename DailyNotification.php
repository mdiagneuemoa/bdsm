...
$body_content .= "<span style='font-family:Verdana;font-size:11px;'>".$app_strings["DAILY_NOTIFICATION_INCIDENTS_INFO_ONE"]." ".decode_html(utf8_encode (strftime("%A %d %B %Y %T", mktime(0, 0, 0, date('m'), date('d')-1, date('y'))))).".</span></br>";
...
$body_content.="<table style='border: 1px #6495ed; width:98%;background-color: #6495ed;'>";
	...
	$body_content.="	<td style='border: thin  #6495ed;font-size:11px; font-family:Verdana; background-color: #D0E3FA;' colspan='2'>".$app_strings["DAILY_NOTIFICATION_INCIDENTS_NON_TRAITES"]." </td>";
	$body_content.="    <td style='border: thin  #6495ed;font-size:11px; font-family:Verdana; background-color: #D0E3FA;'  rowspan='2'>".$app_strings["DAILY_NOTIFICATION_INCIDENTS_CLOTURE_AVANT_TR"]."</td>";	
	...
	$body_content.="<tr style='text-align: center;'>";
	$body_content.="	<td style='border: thin  #6495ed;font-size:11px; font-family:Verdana; background-color: #D0E3FA;'> ".$app_strings["DAILY_NOTIFICATION_INCIDENTS_ATTENTE_CLOTURE"]." </td>";
	$body_content.="	<td style='border: thin  #6495ed;font-size:11px; font-family:Verdana; background-color: #D0E3FA;'> ".$app_strings["DAILY_NOTIFICATION_INCIDENTS_CLOTURE"]."</td>";
...
while ($myrow = $adb->fetch_array($result)) // nb_incidents_en_souffrance   incidents_nonsouffrants  nb_incidents_dslesdelais
{
	$body_content.="<tr>";
...
if ($isContainStatistic == false) {
	...
	$body_content.="	<td style='border: thin  #6495ed;font-size:11px; font-family:Verdana; background-color: #e3d8f6;text-align:center;font-weight:bold;'> &nbsp; </td>";
	$body_content.="</tr>";																				
...
$subject=" Rapport des incidents du " .strftime("%d.%m.%Y", mktime(0, 0, 0, date('m'), date('d')-1, date('y')));//date('d.m.Y'); 
...
// $addCC=array("mndiouf@pcci.sn","mediagne@pcci.sn");
 ...
 sendmail($add,'reportgidpcci@pcci.sn',$subject,$body_content,$mailserver,$mailuname,$mailpwd,"",$smtp_auth,$addCC);
