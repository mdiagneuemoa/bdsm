...
// hodar CRM selection d'un user pour champs Publié par et Assigné A module HReports
...
session_unregister('fieldname'); // le champ qui prend la valeur de selection dans la liste des users est supprimé Hodar CRM
