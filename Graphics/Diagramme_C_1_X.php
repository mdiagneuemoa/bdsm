...
//$graph->setPadding(null, null, 40, 250);

$graph->title->set("Total incident par campagne");

session_start();

$data			= $_SESSION['data_campagne'];
$data_legende 	= $data[0][0];
$data_values 	= $data[1];
...
file_put_contents( "GRAPH_IMG/STAT_C_1.png", $graph->draw(Graph::DRAW_RETURN));
