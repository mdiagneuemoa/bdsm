(function () {
	...
	var listContacts = document.getElementById("contacts");
	//var submitcate = document.getElementById("savecategorie");

   var form = document.getElementById("contactform");
   var submitButton = document.getElementById("savetiersBut");    
   var submitCatBut = document.getElementById("submitCatBut");
  // var submitTiersBut = document.getElementById("savetiersBut");
  ...
  /*  var addPasswordInputEventListeners = function() {
    ...
    var formSubmissionAttempted = function() {
	 ...
	 var formSubmissionCategorie = function() {
      /*  form.classList.add("submission-attempted");*/
	//  alert("Add CAtegory Successful");
	  var newcategorie = document.getElementById("newcategorie");
	   ...
	   $.ajax({
		...
		$('#addcontactbut').click( function() {
		//alert("TEST");
       	   document.getElementById("form-addcontact").style.display='block';
	...
	$('#emailtype').focusin( function() {
	if(document.getElementById("typeemail").options[document.getElementById("typeemail").selectedIndex].value=='professionel')
		{
			document.getElementById("addemailpro").style.display='block';
			document.getElementById("addemailpro").focus();  
		}
	if(document.getElementById("typeemail").options[document.getElementById("typeemail").selectedIndex].value=='personnel')
		{
			document.getElementById("addemailperso").style.display='block';
			document.getElementById("emailperso").focus();  
		}	
		document.getElementById("addemailtype").style.display='none';
		document.getElementById("idemaillink").style.display='block';

    });
	$('#emailperso').focusin( function() {
		document.getElementById("addemailtype").style.display='none';
		document.getElementById("addemaillink").style.display='block';

    });
	$('#addemaillink').click( function() {
		document.getElementById("addemailtype").style.display='block';
		document.getElementById("idemaillink").style.display='none';

    });
	$('#delemailperso').click( function() {
		document.getElementById("addemailperso").style.display='none';
		document.getElementById("addemailperso").value="";
    });
	$('#delemailpro').click( function() {
	document.getElementById("addemailpro").style.display='none';
	document.getElementById("addemailpro").style.value="";

    });
	
	$('#telephonetype').focusin( function() {
	if(document.getElementById("typetel").options[document.getElementById("typetel").selectedIndex].value=='domicile')
		{
			document.getElementById("addtelephonedom").style.display='block';
			document.getElementById("telephonedom").focus();  
		}
	if(document.getElementById("typetel").options[document.getElementById("typetel").selectedIndex].value=='bureau')
		{
			document.getElementById("addtelephonebureau").style.display='block';
			document.getElementById("telephonebureau").focus();  
		}
	if(document.getElementById("typetel").options[document.getElementById("typetel").selectedIndex].value=='mobileperso')
		{
			document.getElementById("addtelephoneperso").style.display='block';
			document.getElementById("telephoneperso").focus();  
		}
	if(document.getElementById("typetel").options[document.getElementById("typetel").selectedIndex].value=='mobilepro')
		{
			document.getElementById("addtelephonepro").style.display='block';
			document.getElementById("telephonepro").focus();  
		}		
		document.getElementById("addtelephonetype").style.display='none';
		document.getElementById("idtellink").style.display='block';

    });
	$('#addtellink').click( function() {
		document.getElementById("addtelephonetype").style.display='block';
		document.getElementById("idtellink").style.display='none';

    });
	$('#deltelephonedom').click( function() {
		document.getElementById("addtelephonedom").style.display='none';
		document.getElementById("addtelephonedom").value="";
    });
	$('#deltelephonebureau').click( function() {
	document.getElementById("addtelephonebureau").style.display='none';
	document.getElementById("addtelephonebureau").style.value="";

    });
	$('#deltelephonepro').click( function() {
		document.getElementById("addtelephonepro").style.display='none';
		document.getElementById("addtelephonepro").value="";
    });
	$('#deltelephoneperso').click( function() {
	document.getElementById("addtelephoneperso").style.display='none';
	document.getElementById("addtelephoneperso").style.value="";

    });
	$('#checkAll').click( function() {
	var inputs = $("form input[name='contacts[]']");
	...
	$('#UncheckAll').click( function() {
		...
		//dellink.attr('disabled',true);
		//exportlink.attr('disabled',true);
	}
	...
	$('#matricule').focusout( function()
	{
		...
		//alert("test:"+matricule);
		 ...
		 $.ajax({
				...
				{
					alert("Matricule non valide!!! Vérifier votre matricule UEMOA");
	...
	$('#mescontacts').click( function() {
	   document.getElementById("form-addcontact").style.display='none';
		document.getElementById("contacts").style.display='block';
		showAllContacts();
	 });
	 $('#addcategorie').click( function() {
		document.getElementById("more-infoscontact").style.display='none';
		document.getElementById("moreconts").style.display='block';
		document.getElementById("moreconts2").style.display='none';

	 });
	 $('#moreconts').click( function() {
		document.getElementById("more-infoscontact").style.display='block';
		document.getElementById("moreconts2").style.display='block';
		document.getElementById("moreconts").style.display='none';

	 });
	
	$('#moreconts2').click( function() {
		document.getElementById("more-infoscontact").style.display='none';
		document.getElementById("moreconts").style.display='block';
		document.getElementById("moreconts2").style.display='none';
	...
	var addSubmitCatClickEventListener = function() {
        submitCatBut.addEventListener("click", formSubmissionCategorie, false);
    };
/*	
   var addSubmitTiersClickEventListener = function() {
	...
	var downloadCategories = function() {
	   $.ajax({
			...
			//displaySchedule();
			   ...
			   alert("Category list not available.");
		});
	};
	/*var showAllContacts = function() {
	   $.ajax({
			...
			listContacts.innerHTML=response;
			//alert(response);
			//schedule = response.schedule;
			//displaySchedule();
		}).fail(function() {
	...
	//addSubmitCatClickEventListener();
	//downloadCategories();
	//showAllContacts();
...
function showContacts(idcategorie)
{
		var listContacts = document.getElementById("contacts");
	 ...
	 $.ajax({
			type: "POST",
			url: "dao/contactsUtils.php",
			data:"action=getContactsByCat&idcategorie="+idcategorie,
		}).done(function(response) {
			listContacts.innerHTML=response;
			//alert(response);
			//schedule = response.schedule;
...
function clickinfocom()
{

	var infocom =  document.getElementById('infocom');
	var reclamation =  document.getElementById('reclamation');
	var activationsav =  document.getElementById('activationsav');

	var info =  document.getElementById('info');
	var recla =  document.getElementById('recla');
	var sav =  document.getElementById('sav');

	infocom.style.display='block';
	reclamation.style.display='none';
	activationsav.style.display='none';

	info.className = 'dvtSelectedCell';
	recla.className = 'dvtUnSelectedCell';
	sav.className = 'dvtUnSelectedCell';
}

function clickreclamation()
{
	...
	info.className = 'dvtUnSelectedCell';
	recla.className = 'dvtSelectedCell';
	sav.className = 'dvtUnSelectedCell';
...
document.getElementById('raisonsociale').value=tiers.raisonsociale;
...
function clickactivationsav()
{
	...
	infocom.style.display='none';
	reclamation.style.display='none';
	activationsav.style.display='block';

	info.className = 'dvtUnSelectedCell';
	recla.className = 'dvtUnSelectedCell';
	sav.className = 'dvtSelectedCell';
