(function () {
  ...
  // var form = document.getElementById("contactform");
   //var submitButton = form.querySelector("button");    
	...
	var inputs = $("form input[name='messages[]']");
	...
	var showAllMessages = function() {
	   $.ajax({
			...
			listMessages.innerHTML=response;
		}).fail(function() {
			   alert("Messages list not available.");
		});
	};
...
function showMessages(idcategorie)
{
		var listMessages = document.getElementById("messages");
	 ...
	 $.ajax({
			type: "POST",
			url: "dao/messagesUtils.php",
			data:"action=getMessagesByCat&idcategorie="+idcategorie,
		}).done(function(response) {
			listMessages.innerHTML=response;
		}).fail(function() {
			   alert("Messages list not available.");
...
function viewMessages(idmessage)
{
		var messagezone = document.getElementById("messages");

	 $.ajax({
			type: "POST",
			url: "dao/messagesUtils.php",
			data:"action=getMessageById&idmessage="+idmessage,
		}).done(function(response) {
			messagezone.innerHTML=response;
		}).fail(function() {
			   alert("Message info is not available.");
		});
