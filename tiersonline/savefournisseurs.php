             ...
             <div class="container">
               	<table width="99%">
					<tbody>
							<tr>
					          <td width="20%" nowrap>
									<a href="fournisseurs.php"><img src="images/logo_uemoa.png" height=50 alt="COLLECTE DE DONNEES RH " title="COLLECTE DE DONNEES RH" border=0></a>
								</td>
...
if($tiersdao->verifExistIdentFiscale($_REQUEST['identificationfiscale'])==1)
{
	$tiers = $tiersdao->updateFournisseurs($_REQUEST);
}
else
{
	$tiers = $tiersdao->saveFournisseurs($_REQUEST);
}
//print_r($tiers);
