 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /cvs/repository/siprodPCCI/data/Tracker.php,v 1.1 2010/01/15 18:43:16 isene Exp $
...
class Tracker {
    ...
    /**
     * Add this new item to the tracker vtiger_table.  If there are too many items (global config for now)
...
//        $query = "SELECT * from $this->table_name WHERE user_id='$user_id' ORDER BY id DESC";
	$query = "SELECT * from $this->table_name inner join vtiger_crmentity on vtiger_crmentity.crmid=tracker.item_id WHERE user_id=? and vtiger_crmentity.deleted=0 ORDER BY id DESC";
