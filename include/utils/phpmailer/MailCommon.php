...
function sendNotificationCandidature($canditat)
{
			...
			<tbody>
				...
				<tr>
					...
					<table width="100%">
						<tbody>
							<tr>
								<td align="left" width="100%" height="150" valign="top" style="font-size: 14px;">
								<div style="margin-bottom: 15px; color: rgb(59, 89, 152);"><br>';
								$list .= 'Bonjour '.$candidat['nom'].',<br><br>';
							   	$list .='Votre candidature à la Bourse de Soutien à la recherche et à la formation de la Commission de l\'UEMOA  a été enregistrée avec succès.
									Une fois la selection effectuée, la liste des candidats retenus par pays sera publiée sur le site officiel de la Commission de l\'UEMOA <a href="http://www.uemoa.int/fr/bourses/bourses-dexcellence">ici </a>(http://www.uemoa.int/fr/bourses/bourses-dexcellence)
									
								<div style="margin: 0pt; font-size: 14px; color: rgb(59, 89, 152); padding: 0px 0px 10px;"><br>';
...
function correctImg2($imgbalise)
{
