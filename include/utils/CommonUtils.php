...
/**
 * Retourne le numero du ticket corespondant à l'ID
 */
...
/**
 * Cette méthode fournit le nom et prénom d'un posteur d'une demande ou d'un incident
 *
...
/**
 * Cette méthode fournit le nom et prénom d'un traiteur d'une demande 
...
/**
 * Cette méthode fournit le nom et prénom d'un traiteur d'un incident 
 * et le group de traitement auquel il appartient
 *
