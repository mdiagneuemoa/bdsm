...
{
	//$list_query .=	" AND tiers_informations.active=1";
}
//echo "list_query=".$list_query;break;
...
$list_query .= ' ORDER BY nationalite asc,dipmoyenne desc'; //. $sorder;
