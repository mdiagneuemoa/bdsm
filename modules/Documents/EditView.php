 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /cvs/repository/siprodPCCI/modules/Documents/EditView.php,v 1.2 2010/02/09 18:42:40 isene Exp $
...
// le rapport est placé dans le dossier en paramètre hodar crm 24/08/09
if(isset($_REQUEST['folderid']) && $focus->mode != 'edit')
{
	$folderid=$_REQUEST['folderid'];
}

//echo "fid=",$_REQUEST['folderid'];
