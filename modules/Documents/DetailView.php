 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /cvs/repository/siprodPCCI/modules/Documents/DetailView.php,v 1.1 2010/01/15 18:43:51 isene Exp $
...
$dbQuery="select filename,folderid,filelocationtype,filestatus,docstatus from vtiger_notes where notesid = ?";
...
$docstatus=$adb->query_result($result,0,'docstatus');

//test pour afficher bouton de validation 
if($docstatus=="Provisoire" || $docstatus=="En cours de validation")
{
	$smarty->assign("ISVALIDABLE","true");
}

$folder = "select foldername from vtiger_attachmentsfolder where folderid = ?";
...
if((isPermitted("Documents","EditView",$_REQUEST['record']) == 'yes') && $docstatus!='Archive')
	$smarty->assign("EDIT_DUPLICATE","permitted");

if((isPermitted("Documents","Delete",$_REQUEST['record']) == 'yes') && $docstatus!='Archive')
