...
$smarty->assign('LISTDIRECTEURS', getListDirecteur());
$smarty->assign("LISTINTERIMAIRES",getListInterimaire());
$curentusermat = $current_user->user_matricule;
$curentuserprofil = $current_user->profilid;
if ($curentuserprofil==21) 
	$smarty->assign("MATDIRECTEUR",$curentusermat);
else	
	$smarty->assign("MATCORRENTUSER",$curentusermat);
