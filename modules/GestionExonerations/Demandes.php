...
class Demandes extends CRMEntity {
	 ...
	 */
	//var $customFieldTable = Array('siprod_demandecf', 'demandeid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'siprod_demande', 'siprod_demandecf');
	...
	var $tab_name_index = Array(
		...
		'siprod_demande'   => 'demandeid',
	    'siprod_demandecf' => 'demandeid');
	...
	var $list_fields = Array (
		...
		'Ticket'=> Array('siprod_demande', 'ticket'),
		'Statut'=> Array('siprod_demande', 'statut'),
		'Date Creation' => Array('crmentity','createdtime'),
		'TypeDemande' => Array('siprod_demande','typedemande'),
		'TypeDemande2' => Array('siprod_demande','typedemande2'),
		'TypeDemande3' => Array('siprod_demande','typedemande3'),
		'TypeDemande4' => Array('siprod_demande','typedemande4'),
		'TypeDemande5' => Array('siprod_demande','typedemande5'),
		'Campagne' => Array('siprod_demande','campagne'),
		'Quantite' => Array('siprod_demande','quantite'),
		'Quantite2' => Array('siprod_demande','quantite2'),
		'Quantite3' => Array('siprod_demande','quantite3'),
		'Quantite4' => Array('siprod_demande','quantite4'),
		'Quantite5' => Array('siprod_demande','quantite5'),
		'Justifdemande' => Array('siprod_demande','justifdemande'),
		'Justifdemande2' => Array('siprod_demande','justifdemande2'),
		'Justifdemande3' => Array('siprod_demande','justifdemande3'),
		'Justifdemande4' => Array('siprod_demande','justifdemande4'),
		'Justifdemande5' => Array('siprod_demande','justifdemande5'),
		'Desc1' => Array('siprod_demande','desc1'),
		'Desc2' => Array('siprod_demande','desc2'),
		'Desc3' => Array('siprod_demande','desc3'),
		'Desc4' => Array('siprod_demande','desc4'),
		'Desc5' => Array('siprod_demande','desc5'),
		'Service' => Array('siprod_demande','service'),
		'Nom' => Array('siprod_demande','nom'),
		'Anneebudgetaire' => Array('siprod_demande','anneebudgetaire'),
		'Anneebudgetaire2' => Array('siprod_demande','anneebudgetaire2'),
		'Anneebudgetaire3' => Array('siprod_demande','anneebudgetaire3'),
		'Anneebudgetaire4' => Array('siprod_demande','anneebudgetaire4'),
		'Anneebudgetaire5' => Array('siprod_demande','anneebudgetaire5'),
...
//		
	...
	{	
		...
		$query = "select count(*) as nb from siprod_demande where ticket = ? " ;
		$result = $adb->pquery($query, array($ticket));
	...
	{	
		...
		$query = "SELECT typedemande2,quantite2 FROM siprod_demande WHERE demandeid=? " ;
	...
	{	
		...
		$query = "SELECT typedemande3,quantite3 FROM siprod_demande WHERE demandeid=? " ;
		$result = $adb->pquery($query, array($record));
		$row1 = $adb->fetchByAssoc($result);
	...
	{	
		...
		$query = "SELECT typedemande4,quantite4 FROM siprod_demande WHERE demandeid=? " ;
		$result = $adb->pquery($query, array($record));
		$row1 = $adb->fetchByAssoc($result);
	...
	{	
		...
		$query = "SELECT typedemande5,quantite5 FROM siprod_demande WHERE demandeid=? " ;
		$result = $adb->pquery($query, array($record));
		$row1 = $adb->fetchByAssoc($result);
	...
	function traiterdemande($demandeid)
	{
		...
		$dbQuery = "UPDATE siprod_demande SET statut='traited',datelivraison=NOW() WHERE demandeid=? ";
