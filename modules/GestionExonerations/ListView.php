...
if(  $module == 'Demandes' ){
	$list_query = "SELECT DISTINCT 
		...
		siprod_demande.statut, 
		vtiger_crmentity.createdtime, 
		siprod_demande.service,
		siprod_demande.nom,
		siprod_demande.prenom,
		vtiger_crmentity.crmid
		FROM siprod_demande
		INNER JOIN vtiger_crmentity ON vtiger_crmentity.crmid = siprod_demande.demandeid AND vtiger_crmentity.deleted =0 ";
