...
$list_query = "SELECT DEMANDE.matricule,DEMANDE.ticket,DEMANDE.objet,(CASE WHEN DEMANDE.codebudget='' THEN 'SANS FRAIS' ELSE DEMANDE.codebudget END) AS codebudget,
				(CASE WHEN DEMANDE.sourcefin='0000-00-00' THEN 'Ressource Propre' 
					  WHEN DEMANDE.sourcefin='0000-00-01' THEN 'SANS FRAIS' 
...
else
{
	...
	elseif ($curentuserprofil=='22' || $curentuserprofil=='25') /********** DIR CAB ou COMMISSAIRE ************/
	{	
