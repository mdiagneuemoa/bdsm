...
<table id="Table_01" width="801" height="438" border="0" cellpadding="0" cellspacing="0" align="center" <?php echo $idlogin; ?>>
	...
	<tr>
		<td colspan="2" rowspan="2" background="themes/images-login/login_06.jpg" width="300" height="188"  ><table width="95%" border="0">
			<?php
		  ...
		  <tr>
		    ...
		    <td width="40%">
		      <label>
		        <input type="text" name="user_name" id="textfield" value="<?php echo $login_user_name ?>">
	          </label>
	        </td>
	      </tr>
		  <tr>
		    ...
		    <td>
		      <label>
		        <input type="password" name="user_password" id="textfield2" type="password" value="<?php echo $login_password ?>">
	          </label>
	       </td>
	      </tr>
		   <tr>
