...
function send_mail($module,$to_email,$from_name,$from_email,$subject,$contents,$cc='',$bcc='',$attachment='',$emailid='',$logo='')
{
	...
	$mail->AddReplyTo("mdiagne@uemoa.int");
	...
	//echo "mail_error=",$mail_error;break;
	return $mail_error;
}
...
function addSignature($contents, $fromname)
{
	...
	//$contents .= '<br><br> L\'équipe Bourse Soutien UEMOA';
	return $contents;
}
...
function setMailServerProperties($mail)
{
	...
	$mail->Host = "mail.uemoa.int";		// specify main and backup server
	$mail->Username = "bourseonline" ;	// SMTP username
	$mail->Password = "bourse@online" ;	// SMTP password
