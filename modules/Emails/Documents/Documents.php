 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /cvs/repository/siprodPCCI/modules/Emails/Documents/Documents.php,v 1.1 2010/01/15 18:43:57 isene Exp $
		...
		if($noofnotes > 0)
		{
            ...
            if($noofdeffolders == 0)
            {
			   // $insertQuery = "insert into vtiger_attachmentsfolder values (0,'Default','Contains all attachments for which a folder is not set',1,0)";
			    $insertQuery = "insert into vtiger_attachmentsfolder values (0,'Documents','Contient les documents',1,0)";
