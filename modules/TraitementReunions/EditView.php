...
$smarty->assign('MOTIFSREJET', $focus->getListMotifsRejet());
...
$idd=$_REQUEST['dmd'];
	if (!isset ($_REQUEST['ticket']) || $ticket == '') 
	 $ticket = $reunion_focus->getTicketReunion($idd);
	$smarty->assign('TICKET',$ticket );
	$matricule = getmatriculeByTicket($ticket);
	
	$smarty->display('CreateViewTraitementReunions.tpl');
