...
class TypeIncidents extends CRMEntity {
	var $db, $log; // Used in class functions of CRMEntity

	var $table_name = "siprod_type_incidents";
	var $table_index= 'typeincidentid';
	 ...
	 */
	var $customFieldTable = Array('siprod_type_incidentscf', 'typeincidentid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'siprod_type_incidents', 'siprod_type_incidentscf');
	...
	var $tab_name_index = Array(
		...
		'siprod_type_incidents'   => 'typeincidentid',
	    'siprod_type_incidentscf' => 'typeincidentid');

	/**
	 * Mandatory for Listing (Related listview)
	 */
	var $list_fields = Array(
        	'Nom' => Array('siprod_type_incidents','nom'),
        	'Delais' => Array('siprod_type_incidents','delais'),
        	'Groupe' => Array('siprod_type_incidents','groupid'),
