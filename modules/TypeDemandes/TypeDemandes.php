...
class TypeDemandes extends CRMEntity {
	var $db, $log; // Used in class functions of CRMEntity

	var $table_name = "siprod_type_demandes";
	var $table_index= 'typedemandeid';
	 ...
	 */
	var $customFieldTable = Array('siprod_type_demandescf', 'typedemandeid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'siprod_type_demandes', 'siprod_type_demandescf');
	...
	var $tab_name_index = Array(
		...
		'siprod_type_demandes'   => 'typedemandeid',
	    'siprod_type_demandescf' => 'typedemandeid');

	/**
	 * Mandatory for Listing (Related listview)
	 */
	var $list_fields = Array(
        	'Nom' => Array('siprod_type_demandes','nom'),
        	'Delais' => Array('siprod_type_demandes','delais'),
