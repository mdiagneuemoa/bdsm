...
if(isPermitted($currentModule,"EditView",$_REQUEST['record']) == 'yes')
	$smarty->assign('EDIT_DUPLICATE','permitted');
if(isPermitted($currentModule,"Delete",$_REQUEST['record']) == 'yes')
...
$smarty->display('DetailViewTimesheets.tpl');
