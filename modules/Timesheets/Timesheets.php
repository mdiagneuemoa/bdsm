...
class Timesheets extends CRMEntity {
	...
	var $table_name = 'vtiger_timesheets';
	 ...
	 */
	//var $customFieldTable = Array('vtiger_timesheetscf', 'timesheetid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_timesheets');
	...
	var $list_fields = Array (
		...
		'Timesheet Name'=> Array('timesheets', 'timesheetname'),
		'Consultant Name'=> Array('timesheets', 'consultantname'),
		'Start Date'=> Array('timesheets', 'start_date'),
		'End Date'=> Array('timesheets', 'end_date'),
		'Total Duration Interventions'=> Array('timesheets', 'duration_hours')
		/*,'Assigned To' => Array('crmentity','smownerid'),
		'Intervention Date' => Array('tshtinterv'=>'date_interv'),
		'Account Name' => Array('tshtinterv'=>'accountid'),
		'Potential Name' => Array('tshtinterv'=>'potentialid'),
		'Intervention Task' => Array('tshtinterv'=>'intervtask'),
		'Intervention Duration' => Array('tshtinterv'=>'duration_interv')*/
		
	);
	var $list_fields_name = Array(
		/* Format: Field Label => fieldname */
		'Tiemesheet Name'=> 'timesheetname',
		'Consultant Name'=> 'consultantname',
		'Start Date'=> 'start_date',
		'End Date'=> 'end_date',
		'Total Duration Interventions'=>  'duration_hours'
		/*,'Assigned To'=>'assigned_user_id',
		'Intervention Date' => 'date_interv',
		'Account Name' => 'accountid',
		'Potential Name' => 'potentialid',
		'Intervention Task' => 'intervtask',
		'Intervention Duration' =>'duration_interv'*/
		
	);

	// Make the field link to detail view from list view (Fieldname)
	var $list_link_field = 'timesheetname';

	// For Popup listview and UI type support
	var $search_fields = Array(
		/* Format: Field Label => Array(tablename, columnname) */
		// tablename should not have prefix 'vtiger_'
		'Tiemesheet Name'=> Array('timesheets', 'timesheetname')
	);
	...
	var $popup_fields = Array('timesheetname');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	var $sortby_fields = Array();

	// For Alphabetical search
	var $def_basicsearch_col = 'timesheetname';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'timesheetname';

	// Required Information for enabling Import feature
	var $required_fields = Array('timesheetname'=>1);

	// Callback function list during Importing
	var $special_functions = Array('set_import_assigned_user');

	var $default_order_by = 'timesheetname';
	var $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'timesheetname','consultantname','duration_hours');
	...
	// récupération des interventions d'un timesheet
