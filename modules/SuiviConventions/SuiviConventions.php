...
class SuiviConventions extends CRMEntity {
	...
	var $list_fields = Array (
		...
		// tablename should not have prefix 'vtiger_'
		 'Reffournisseur'=> Array('sigc_execution_conventions', 'reffournisseur'),
		  'Refpayement'=> Array('sigc_execution_conventions', 'refpayement'),
		  'Montant'=> Array('sigc_execution_conventions', 'montant'),
		  'Datepayement'=> Array('sigc_execution_conventions', 'datepayement'),
