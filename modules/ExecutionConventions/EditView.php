...
if($record) {
	...
	$smarty->assign("TICKET",$focus->column_fields['ticket']);
}
...
if(getFieldVisibilityPermission('ExecutionIncidents',$current_user->id,'description') != '0')
...
$smarty->assign('ID',$idd);

if ($focus->mode == 'edit') {
	$smarty->display('salesEditView.tpl');
} else {
	//$smarty->assign("LOCALITES", getAllLocalitesByCountry("SENEGAL"));
