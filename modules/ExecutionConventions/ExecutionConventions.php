...
class ExecutionConventions extends CRMEntity {
	var $db, $log; // Used in class functions of CRMEntity

	var $table_name = 'sigc_execution_conventions';
	var $table_index= 'idexecution';
	 ...
	 */
	var $customFieldTable = Array('sigc_execution_conventionscf', 'idexecution');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'sigc_execution_conventions', 'sigc_execution_conventionscf');
	...
	var $tab_name_index = Array(
		...
		'sigc_execution_conventions'   => 'idexecution',
	    'sigc_execution_conventionscf' => 'idexecution');
	...
	var $list_fields = Array (
		...
		// tablename should not have prefix 'vtiger_'
		 'Reffournisseur'=> Array('sigc_execution_conventions', 'reffournisseur'),
		  'Refpaiement'=> Array('sigc_execution_conventions', 'refpaiement'),
		  'Modepaiement'=> Array('sigc_execution_conventions', 'modepaiement'),
		  'Montant'=> Array('sigc_execution_conventions', 'montant'),
		  'Datepaiement'=> Array('sigc_execution_conventions', 'datepaiement'),
		  'Localite'=> Array('sigc_execution_conventions', 'localite'),
		  'Filename'=> Array('sigc_execution_conventions', 'filename'),
		  'Maitriseouvrage'=> Array('sigc_execution_conventions', 'maitriseouvrage'),
		  'Ticket'=> Array('sigc_execution_conventions', 'ticket')
	...
	{	
		...
		$query = "select count(*) from siprod_incident where ticket = ? and statut= ?" ;
