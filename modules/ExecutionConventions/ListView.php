...
if( $currentModule == 'ExecutionConventions' )
	$currentModule = 'Conventions';
elseif( $currentModule == 'Conventions' )
	$currentModule = 'ExecutionConventions';
...
require_once('modules/ExecutionConventions/ExecutionConventions.php');
...
$list_query .=" AND sigc_convention.statut IN('validated','running','completed') AND deleted =0";
...
if($record1 != '' && $currentModule=='ExecutionConventions') {
