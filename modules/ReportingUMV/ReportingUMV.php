...
class ReportingUMV extends CRMEntity {
	var $db, $log; // Used in class functions of CRMEntity

	var $table_name = 'nomade_statmission';
	var $table_index= 'matricule';
	 ...
	 */
	var $tab_name = Array('vtiger_crmentity', 'nomade_statmission', 'nomade_statmissioncf');
	...
	var $tab_name_index = Array(
		...
		'nomade_statmission'   => 'matricule',
	    'nomade_statmissioncf' => 'matricule');
	...
	var $list_fields = Array (
		...
		'Matricule'=> Array('nomade_statmission', 'matricule'),
		'Nomcomplet'=> Array('nomade_statmission', 'nomcomplet'),
		'Departement'=> Array('nomade_statmission', 'departement'),
		'Periode'=> Array('nomade_statmission', 'periode'),
		'Montant'=> Array('nomade_statmission', 'montant'),
		'Duree'=> Array('nomade_statmission', 'duree'),
		'Nbmission'=> Array('nomade_statmission', 'nbmission'),
	...
	var $search_fields = Array(
		...
		'Numom'=> Array('nomade_statmission', 'matricule')
	);
