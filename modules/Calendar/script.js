...
function getcalChangeStatus(obj,Lay,id,view,hour,dateVal,type){
...
function getcalAction(obj,Lay,id,view,hour,dateVal,type){
	...
	var ECstatus = "status=En cours";
    var RDstatus = "status=revue documentaire";
	var ADstatus = "status=analyse documentaire";
	var RPstatus = "status=rapport provisoire";
	var RFstatus = "status=rapport final";
	var Astatus = "status=actif";
	var Cstatus = "status=closed";
	
	var activity_mode = "Task";
	var ec = document.getElementById("taskstatus_0");
	var rd = document.getElementById("taskstatus_1");
	var ad = document.getElementById("taskstatus_2");
	var rp = document.getElementById("taskstatus_3");
	var rf = document.getElementById("taskstatus_4");	
	var a = document.getElementById("taskstatus_5");	
	var c = document.getElementById("taskstatus_6");	
	var OptionData = '';
    }
    document.getElementById("idlist").value = id;
	...
	if(ec) 
	{
		ec.href="javascript:updateStatus("+id+",'"+ECstatus+"','"+view+"',"+hour+","+day+","+month+","+year+",'"+type+"')";
    }
	if(rd) 
	{
		rd.href="javascript:updateStatus("+id+",'"+RDstatus+"','"+view+"',"+hour+","+day+","+month+","+year+",'"+type+"')";
    }
	if(ad) 
	{
		ad.href="javascript:updateStatus("+id+",'"+ADstatus+"','"+view+"',"+hour+","+day+","+month+","+year+",'"+type+"')";
    }
	if(rp) 
	{
		rp.href="javascript:updateStatus("+id+",'"+RPstatus+"','"+view+"',"+hour+","+day+","+month+","+year+",'"+type+"')";
    }
	if(rf) 
	{
		rf.href="javascript:updateStatus("+id+",'"+RFstatus+"','"+view+"',"+hour+","+day+","+month+","+year+",'"+type+"')";
    }
	if(a) 
	{
		a.href="javascript:updateStatus("+id+",'"+Astatus+"','"+view+"',"+hour+","+day+","+month+","+year+",'"+type+"')";
    }
	if(c) 
	{
		c.href="javascript:updateStatus("+id+",'"+Cstatus+"','"+view+"',"+hour+","+day+","+month+","+year+",'"+type+"')";
    }
