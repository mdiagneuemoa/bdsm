...
if($current_user->hour_format == '')
	$calendar_arr['calendar']->hour_format = '24';
else
...
?>
	...
	<input type="hidden" name="dateformat" value="<?php echo $date_format ?>">
		...
		<td class=small >
			...
			-->
			<input type="hidden" name="activitytype" value="rencontre">
			<tr>
				<td nowrap align="right" width="20%"><b><font color="red">*</font><?php echo $mod_strings['LBL_EVENTNAME']?></b></td>
				<td align="left" width="80%"><input name="subject" type="text" class="textbox" value="" style="width:50%">&nbsp;&nbsp;&nbsp; 
			...
			<tr>
				<td valign="top" align="right" width="20%"><b><?php echo $mod_strings['Description']?></b></td>
				<td align="left" width="80%"><textarea style = "width:100%; height : 60px;" name="description"></textarea></td>
			</tr>
			<?php } ?>
...
<input type="hidden" name="return_module" value="Calendar">
  ...
  <input type="hidden" name="maintab" value="Calendar">
	...
	<table border=0 cellspacing=0 cellpadding=3 width=95% bgcolor="#FFFFFF" >
		<tr>
			<td width="20%" align="right"><b><font color="red">*</font><?php echo $mod_strings['LBL_TODONAME'] ?></b></td>
            <td width="80%" align="left"  colspan="3"><input name="task_subject" type="text" value="" class="textbox" style="width:70%"></td>
                </tr>
		...
		<tr>
			...
			<td align="left" colspan="3"><textarea style="width: 100%; height: 60px;" name="task_description"></textarea></td>
		</tr>
		<?php } ?>
		<tr>
			<td align="right">
					...
					<tr>
						<td valign=top> 
							<table border=0 cellspacing=0 cellpadding=1 width=100%>
								<tr>
									<td align=center><b><?php //echo $mod_strings['LBL_AVL_USERS']?></b></td>
									<td>&nbsp;</td>
									<td align=center><b><?php //echo $mod_strings['LBL_SEL_USERS']?></b></td>
								</tr>
								<tr>
									<td  align=center valign=top>
										<select name="teamusers" id="teamusers" class=small size=5 multiple style="height:70px;width:80%">
											<?php
												//foreach($userDetails as $id=>$name)
												//{
												//	if($id != '')
									...
									<td  align=center valign=top>
										<input type=button value="<?php // echo $mod_strings['LBL_ADD_BUTTON'] ?> >>" class="crm button small save" style="width:80%" onClick="incUser('teamusers','selectedteamusers')"><br>
										<input type=button value="<< <?php //echo $mod_strings['LBL_RMV_BUTTON'] ?> " class="crm button small cancel" style="width:80%" onClick="rmvUser('selectedteamusers')">
									</td>
									<td  align=center valign=top>
										<select name="selectedteamusers" id="selectedteamusers" class=small size=5 multiple style="height:70px;width:80%">
										</select>
									</td>
								</tr>
							</table>
	...
	<table cellspacing=0 cellpadding=3 width=95% id="team_task">
	<tr>
	<td align="right"><b>Chef d'Equipe</b></td>
		<td align=left>
			<input readonly name="chefequipe" id="chefequipe" class="small" type="text" value=''>
			&nbsp;<input title="Change [Alt+C]" accessKey="C" type="button" class="small" value='Choisir' name=btn1 LANGUAGE=javascript onclick='return window.open("index.php?module=Users&action=Popup&form=UsersEditView&form_submit=false&fldname=chefequipe","test","width=640,height=603,resizable=0,scrollbars=0");'>
			&nbsp;<input type="image" src="<?php echo  vtiger_imageurl('clear_field.gif', $theme)?>" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.chefequipe.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;

		</td>
		<td align="right"><b>Coordonnateur</b></td>
		<td align=left>
			<input readonly name="coordonnateur" id="coordonnateur" class="small" type="text" value=''>
			&nbsp;<input title="Change [Alt+C]" accessKey="C" type="button" class="small" value='Choisir' name=btn1 LANGUAGE=javascript onclick='return window.open("index.php?module=Users&action=Popup&form=UsersEditView&form_submit=false&fldname=coordonnateur","test","width=640,height=603,resizable=0,scrollbars=0");'>
			&nbsp;<input type="image" src="<?php echo  vtiger_imageurl('clear_field.gif', $theme)?>" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.coordonnateur.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
	...
	<tr>
		...
		<td align=left>
			<input readonly name="consultant1" id="consultant1" class="small" type="text" value=''>
			&nbsp;<input title="Change [Alt+C]" accessKey="C" type="button" class="small" value='Choisir' name=btn1 LANGUAGE=javascript onclick='return window.open("index.php?module=Users&action=Popup&form=UsersEditView&form_submit=false&fldname=consultant1","test","width=640,height=603,resizable=0,scrollbars=0");'>
			&nbsp;<input type="image" src="<?php echo  vtiger_imageurl('clear_field.gif', $theme)?>" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.consultant1.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;

		</td>
		<td align="right"><b>Consultant2</b></td>
		<td align=left>
			<input readonly name="consultant2" id="consultant2" class="small" type="text" value=''>
			&nbsp;<input title="Change [Alt+C]" accessKey="C" type="button" class="small" value='Choisir' name=btn1 LANGUAGE=javascript onclick='return window.open("index.php?module=Users&action=Popup&form=UsersEditView&form_submit=false&fldname=consultant2","test","width=640,height=603,resizable=0,scrollbars=0");'>
			&nbsp;<input type="image" src="<?php echo  vtiger_imageurl('clear_field.gif', $theme)?>" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.consultant2.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
	...
	<tr>
		...
		<td align=left>
			<input readonly name="assistant1" id="assistant1" class="small" type="text" value=''>
			&nbsp;<input title="Change [Alt+C]" accessKey="C" type="button" class="small" value='Choisir' name=btn1 LANGUAGE=javascript onclick='return window.open("index.php?module=Users&action=Popup&form=UsersEditView&form_submit=false&fldname=assistant1","test","width=640,height=603,resizable=0,scrollbars=0");'>
			&nbsp;<input type="image" src="<?php echo  vtiger_imageurl('clear_field.gif', $theme)?>" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.assistant1.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
		
		</td>
		<td align="right"><b>Assistant2</b></td>
		<td align=left>
			<input readonly name="assistant2" id="assistant2" class="small" type="text" value=''>
			&nbsp;<input title="Change [Alt+C]" accessKey="C" type="button" class="small" value='Choisir' name=btn1 LANGUAGE=javascript onclick='return window.open("index.php?module=Users&action=Popup&form=UsersEditView&form_submit=false&fldname=assistant2","test","width=640,height=603,resizable=0,scrollbars=0");'>
			&nbsp;<input type="image" src="<?php echo  vtiger_imageurl('clear_field.gif', $theme)?>" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.assistant2.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
