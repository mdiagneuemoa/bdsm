...
if( $currentModule == 'TraitementIncidents' )
	$currentModule = 'Incidents';
elseif( $currentModule == 'Incidents' )
	$currentModule = 'TraitementIncidents';
...
if($record1 != '' && $currentModule=='TraitementIncidents') {
	$ticket= getTicketIncident($record1);
	$list_query .=" AND siprod_traitement_incidents.ticket=" .$ticket ;
}
