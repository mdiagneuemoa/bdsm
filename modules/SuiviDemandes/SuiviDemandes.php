...
class SuiviDemandes extends CRMEntity {
	...
	var $list_fields = Array (
		...
		'Type Demande' => Array('siprod_type_demandes','nom'),
		'Campagne' => Array('siprod_demande','campagne'),
		//'Population impactee' => Array('siprod_demande','popimpactee'),
		//'Satut' => Array('siprod_demande','statut'),
