 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /cvs/repository/siprodPCCI/modules/Users/Save.php,v 1.1 2010/01/15 18:42:25 isene Exp $
...
if($_REQUEST['mode'] == 'create') {
	...
	$email_body = $app_strings['MSG_DETAILS']." ". $focus->column_fields['last_name'] .",<br>";
	$email_body .= $mod_strings['LBL_PLEASE_CLICK'] . " <a href='" . $site_URL . "' target='_blank'>". $app_strings['LBL_HERE']."</a><br><br>";
	//. $mod_strings['LBL_TO_LOGIN'] . "<br><br>";
