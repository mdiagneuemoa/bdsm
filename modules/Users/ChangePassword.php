 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /cvs/repository/siprodPCCI/modules/Users/ChangePassword.php,v 1.1 2010/01/15 18:42:26 isene Exp $
...
function verify_password(password)
{
	...
	{
		alert("<?php echo $mod_strings['ERR_EXREG_PASSWORD']; ?>");
		return false;
	}
	else
	{
...
function set_password(form) {
	...
	if(verify_password(form.new_password.value))
	{
