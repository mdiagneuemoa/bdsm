...
class TypeConventions extends CRMEntity {
	var $db, $log; // Used in class functions of CRMEntity

	var $table_name = "sigc_type_conventions";
	var $table_index= 'typeconventionid';
	 ...
	 */
	var $customFieldTable = Array('sigc_type_conventionscf', 'typeconventionid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'sigc_type_conventions', 'sigc_type_conventionscf');
	...
	var $tab_name_index = Array(
		...
		'sigc_type_conventions'   => 'typeconventionid',
	    'sigc_type_conventionscf' => 'typeconventionid');

	/**
	 * Mandatory for Listing (Related listview)
	 */
	var $list_fields = Array(
        	'Nom' => Array('sigc_type_conventions','nom'),
        	'Delais' => Array('sigc_type_conventions','delais'),
        	'Groupe' => Array('sigc_type_conventions','groupid'),
	...
	var $required_fields = Array('nom'=>1);
