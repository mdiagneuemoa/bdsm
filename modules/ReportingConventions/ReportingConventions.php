...
class ReportingConventions extends CRMEntity {
	var $db, $log, $adb_statelop; // Used in class functions of CRMEntity
	 ...
	 */
	//var $customFieldTable = Array('agentcf', 'ag_id');
	...
	var $search_fields = Array(
		/* Format: Field Label => Array(tablename, columnname) */
		// tablename should not have prefix 'vtiger_'
		'Payslip Name'=> Array('payslip', 'ticket')
	);
...
//	var $default_order_by = 'ag_id';
	var $default_order_by = 'datedemarrage';
	var $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'conventionid');
