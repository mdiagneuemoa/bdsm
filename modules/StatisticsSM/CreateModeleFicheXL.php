...
$worksheet->write(2,0, 'Statistiques Surveillance Multimatérale UEMOA',$merged_cells3);
...
$filename = 'TEMPLATE_'.str_replace(" ","_",$statistics['fiche']['flibelle']).'_'.$serie.'-'.$pays;
