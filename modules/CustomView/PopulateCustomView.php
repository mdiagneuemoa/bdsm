		    ...
		    Array('viewname'=>'Paid Invoices',
			  ...
			  'cvmodule'=>'Invoice','stdfilterid'=>'','advfilterid'=>'13'),
	            ...
	            Array('viewname'=>'Pending Sales Orders',
                          'setdefault'=>'0','setmetrics'=>'0','status'=>'3','userid'=>'1',
                          'cvmodule'=>'Timesheets','stdfilterid'=>'','advfilterid'=>'14'),
						  
			// pour hodar crm ajout module timesheet 29/07/09			  
				Array('viewname'=>'All',
                          'setdefault'=>'1','setmetrics'=>'0','status'=>'0','userid'=>'1',
                          'cvmodule'=>'Timesheets','stdfilterid'=>'','advfilterid'=>''),
			Array('viewname'=>'All',
                          'setdefault'=>'1','setmetrics'=>'0','status'=>'0','userid'=>'1',
                          'cvmodule'=>'Interventions','stdfilterid'=>'','advfilterid'=>''),	
			// pour hodar crm ajout module rapport 04/08/09			  
			Array('viewname'=>'All',
                          'setdefault'=>'1','setmetrics'=>'0','status'=>'0','userid'=>'1',
                          'cvmodule'=>'HReports','stdfilterid'=>'','advfilterid'=>''),						  
...
$cvcolumns = Array(Array('vtiger_leaddetails:lead_no:lead_no:Leads_Lead_No:V',
		...
		// pour module rapport hodar crm 03/08/09
		
		Array('vtiger_hreports:hreport_no:hreport_no:HReports_HReport_No:V',
		  				'vtiger_hreports:title:hreports_title:HReports_Title:V',
                        'vtiger_hreports:filename:filename:HReports_File:V',
                        'vtiger_crmentity:modifiedtime:modifiedtime:HReports_Modified_Time:V',
		  				'vtiger_crmentity:smownerid:assigned_user_id:HReports_Assigned_To:V'),
		 ...
		 Array(	 'vtiger_salesorder:subject:subject:SalesOrder_Subject:V',
			 ...
			 // pour hodar crm ajout module timesheet 29/07/09	
		Array('vtiger_timesheets:timesheetname:timesheetname:Timesheets_Timesheet_Name:V',
			'vtiger_timesheets:consultantname:consultantname:Timesheets_Consultant_Name:V',
			'vtiger_timesheets:date_start:date_start:Timesheets_Start_Date:D',
			'vtiger_timesheets:due_date:due_date:Timesheets_End_Date:D',
			'vtiger_timesheets:duration_hours:duration_hours:Timesheets_Duration_Hours:V',
			'vtiger_crmentity:smownerid:assigned_user_id:Timesheets_Assigned_To:V'),
		
		Array('vtiger_tshtinterv:date_interv:date_interv:Timesheets_Date_Interv:D',
			'vtiger_timesheets:accountname:accountname:Timesheets_Account_Name:V',
			'vtiger_timesheets:potentialname:potentialname:Timesheets_Potential_Name:V',
			'vtiger_timesheets:task:task:Timesheets_Task:V',
			'vtiger_timesheets:duration_interv:duration_interv:Timesheets_Duration_Interv:V'),		
