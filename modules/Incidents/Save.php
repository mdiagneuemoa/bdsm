...
$heuredebut_relle = $_REQUEST['heuredebut_relle'];
$time_start = $_REQUEST['time_start'];
$dt = new DateTime($heuredebut_relle." ".$time_start.":00");
$date = $dt->format("Y-m-d H:i:s");
$focus->column_fields['heuredebut_relle'] = $date;
...
if($focus->existTicket($ticket) == 1 || ($focus->existTicket($ticket) == 0  && $mode == 'edit')){
	if($mode != 'edit'){
		$RealTicket = getNextTickectIncident();
