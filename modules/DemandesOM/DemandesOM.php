...
class DemandesOM extends CRMEntity {
	 ...
	 */
	var $tab_name = Array('vtiger_crmentity', 'nomade_demande', 'siprod_demandecf');
	...
	var $list_fields = Array (
		...
		'Campagne' => Array('nomade_demande','campagne'),
		//'Population impactee' => Array('nomade_demande','popimpactee'),
		//'Satut' => Array('nomade_demande','statut'),
...
//		
		$query="SELECT DISTINCT 
				...
				nomade_demande.typedemande,
				nomade_demande.statut,
				vtiger_crmentity.createdtime,
				nomade_demande.campagne ,
				vtiger_crmentity.crmid ,
				...
				INNER JOIN siprod_type_demandes ON siprod_type_demandes.typedemandeid=nomade_demande.typedemande 
