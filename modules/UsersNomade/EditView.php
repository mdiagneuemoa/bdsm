...
if($isduplicate == 'true') {
	...
	$focus->column_fields['user_profil'] = $focus->getProfilIDUser($record);
...
$smarty->assign("DIRECTIONS", $focus->getAllDirections());
$smarty->assign("PROFILS", $focus->getAllProfils());
$smarty->assign("CATEGORIES", $focus->getAllCategories());
$smarty->assign("CIVILITES", $SEXE);
