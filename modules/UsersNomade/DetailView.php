...
$focus->column_fields['user_profil'] = $focus->getProfilNameUser($record);
//print_r($focus);
//echo "profilname=",$focus->getProfilUser($record);
...
// echo "  ",$focus->id," ==== ",$currentModule ,"  ", getEntityName($currentModule, $focus->id);
