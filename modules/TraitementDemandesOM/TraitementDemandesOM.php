...
class TraitementDemandesOM extends CRMEntity {
	...
	var $list_fields = Array (
		...
		'Origine'=> Array('nomade_traitement_demandes', 'origine'),
		'Description' => Array('nomade_traitement_demandes','description'),
		'Destination' => Array('nomade_traitement_demandes','destination'),
		'Cause' => Array('nomade_traitement_demandes','cause'),
	...
	{	
		...
		$query = "select count(*) from siprod_demande where ticket = ? and statut= ?" ;
