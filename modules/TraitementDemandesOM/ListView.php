...
// Siprod change
/*
if( $currentModule == 'TraitementDemandesOM' )
	$currentModule = 'Demandes';
elseif( $currentModule == 'Demandes' )
	$currentModule = 'TraitementDemandesOM';
	*/
//echo $currentModule;
//elseif()
// Siprod change end
...
require_once('modules/TraitementDemandesOM/TraitementDemandesOM.php');
...
if($record1 != '' && $currentModule=='TraitementDemandesOM') {
	$ticket= getTicketDemande($record1);
	$list_query .=" AND nomade_traitement_demandes.ticket=" .$ticket ;
}
