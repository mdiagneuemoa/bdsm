...
/*
$list_query="select distinct users.user_id, users.user_matricule, users.user_name, users.user_firstname, vtiger_profile.profileid, vtiger_profile.profilename 
	...
	and siprod_users.statut=1 and siprod_users.profilid=vtiger_profile.profileid ";
*/

/*$list_query="select distinct users.user_id, users.user_matricule, user_numerologin, users.user_name, users.user_firstname, vtiger_profile.profileid, vtiger_profile.profilename, siprod_users.statut 
	from vtiger_profile, users
	right join siprod_users 
	on users.user_id = siprod_users.userid
	where users.user_locked=0 and users.user_matricule not like '%E20%' 
	and siprod_users.profilid=vtiger_profile.profileid ";
*/
...
if(isset($_REQUEST['ajax']) && $_REQUEST['ajax'] != '')
	$smarty->display("ListViewEntriesUsersGID.tpl");
else 
	$smarty->display("ListViewUsersGID.tpl");
