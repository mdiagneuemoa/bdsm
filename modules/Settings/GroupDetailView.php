...
function getStdOutput($groupInfoArr,$groupId, $mod_strings)
{
    ...
    $tabSupCoord = $groupInfoArr[3];

//    echo "Nom : ".$tabSupCoord["supId"]." ==> ".$tabSupCoord["supName"];
//    echo "Nom : ".$tabSupCoord["coordId"]." ==> ".$tabSupCoord["coordName"];
...
//				$memberName=getUserFullName($memberId);
				...
				$memberName=getNomPrenomUserEdited($memberId);
...
//	$returndata=array($groupfields,$information);
	$returndata=array($groupfields,$information, $tabSupCoord);
	return $returndata;
}
