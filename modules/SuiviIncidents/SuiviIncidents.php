...
class SuiviIncidents extends CRMEntity {
	...
	var $list_fields = Array (
		...
		'Type Incident' => Array('siprod_type_incidents','nom'),
	...
	function getListQuery($module, $where='') {
		$query = "SELECT vtiger_crmentity.*, $this->table_name.* ,siprod_type_incidents.*,operations.*";
		...
		$query .= "	INNER JOIN siprod_type_incidents ON siprod_type_incidents.typeincidentid=".$this->table_name.".typeincident"; 
	...
	{	
		...
		$query = "select siprod_traitement_incidents.statut,
					siprod_traitement_incidents.datemodification,
					siprod_traitement_incidents.cause,
					siprod_traitement_incidents.origine,vtiger_groups.groupname as groupe,
					concat(users.user_firstname,'  ',users.user_name) as nom,		
					siprod_traitement_incidents.description
					FROM siprod_traitement_incidents,vtiger_groups,users 
					where vtiger_groups.groupid = siprod_traitement_incidents.destination 
					and users.user_id = siprod_traitement_incidents.user		
				    and siprod_traitement_incidents.ticket= ?" ;
