...
{	
		$list_query = "SELECT DISTINCT REUNION.ticket,REUNION.libdepartement departement,REUNION.ticket,REUNION.objet, REUNION.lieu, REUNION.datedebut,REUNION.datefin,
						REUNION.statut, REUNION.crmid 
						FROM ( 
							SELECT DISTINCT ticket,libdepartement,objet,lieu,datedebut,datefin,statut,crmid 
							FROM nomade_reunion,vtiger_crmentity,nomade_services 
							WHERE nomade_reunion.reunionid=vtiger_crmentity.crmid 
							AND vtiger_crmentity.deleted=0 
							AND nomade_reunion.departement=nomade_services.codedepartement COLLATE utf8_unicode_ci
							)REUNION";
}
else
{
	$list_query = "SELECT DISTINCT REUNION.ticket,REUNION.libdepartement departement,REUNION.ticket,REUNION.objet, REUNION.lieu, REUNION.datedebut,REUNION.datefin,
		...
		FROM ( 
			...
			WHERE nomade_reunion.reunionid=vtiger_crmentity.crmid 
			AND vtiger_crmentity.deleted=0 
			AND nomade_reunion.departement='".$currentuserdepartement."'
			AND nomade_reunion.departement=nomade_services.codedepartement COLLATE utf8_unicode_ci
			)REUNION ";
}
if($where != '') {
...
$list_query .=" ORDER BY REUNION.ticket DESC  ";
...
*/
//echo 'list_query = ',$list_query, '<br>' ;break;
