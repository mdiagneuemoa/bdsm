 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /cvs/repository/siprodPCCI/modules/Contacts/Contacts.php,v 1.1 2010/01/15 18:44:42 isene Exp $
...
class Contacts extends CRMEntity {
	...
	var $sortby_fields = Array('lastname','firstname');
	...
	'Fonction' => Array('contactscf'=>'cf_494'),
	...
	// hcrm suppression de  imagename comme champ obligatoire 27/07/09
	var $mandatory_fields = Array('assigned_user_id','lastname','createdtime' ,'modifiedtime');
	
	//Default Fields for Email Templates -- Pavani
	var $emailTemplate_defaultFields = array('firstname','lastname','salutation','email','department','phone','mobile','support_start_date','support_end_date');
