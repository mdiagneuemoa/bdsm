...
$_SESSION["authenticated_user_id"]='11994';
  ...
  /*	switch ($current_user->profilid) {
	...
	*/
	//echo $current_user->profilid."  --  ".$defmodule;break;
    	header("Location: index.php?action=$default_action&module=$defmodule");
...
//		$_SESSION['internal_mailer'] = $adb->query_result($qry_res,0,"internal_mailer");
	...
	$log->debug("We are authenticating user Candidate now");
}else{
...
if(!$skipSecurityCheck)
{
	...
	if(ereg('Ajax',$action))
        ...
        //	echo "display = ",$module,$now_action,$_REQUEST['record'];break;
...
{
//		echo "action = ",$module," - ",$action," - ",$currentModuleFile," - ",$currentModule;break;
