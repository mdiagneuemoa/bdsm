<?php /* Smarty version 2.6.18, created on 2011-07-05 13:51:18
         compiled from SetMenu.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getTranslatedString', 'SetMenu.tpl', 36, false),array('modifier', 'vtiger_imageurl', 'SetMenu.tpl', 62, false),)), $this); ?>
<?php 
...
?>
					...
					<?php if (( $_REQUEST['action'] == $this->_tpl_vars['data']['action'] && $_REQUEST['module'] == $this->_tpl_vars['data']['module'] ) || $_REQUEST['action'] == 'DetailView' || $_REQUEST['action'] == 'EditView' || $_REQUEST['action'] == 'ListView'): ?>
						<tr>
