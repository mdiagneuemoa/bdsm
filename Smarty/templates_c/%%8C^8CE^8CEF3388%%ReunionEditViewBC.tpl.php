<?php /* Smarty version 2.6.18, created on 2019-01-29 14:41:16
         compiled from ReunionEditViewBC.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'ReunionEditViewBC.tpl', 67, false),array('modifier', 'count', 'ReunionEditViewBC.tpl', 218, false),)), $this); ?>
...
"></td>
 ...
 <?php echo $this->_tpl_vars['SINGLE_MOD_LABEL']; ?>
			...
			<?php elseif ($this->_tpl_vars['OP_MODE'] == 'openbc'): ?>
...
" class="crmButton small save" onclick="this.form.action.value='Save'; displaydeleted(); if(!isFieldsFormValide(this.form)) return false; return formValidate() " type="submit" name="button" value="  G&eacute;n&eacute;rer l'Ordre de Mission  " style="width:200px">
											...
											<input class="crmButton small save" onclick="this.form.action.value='SaveBC'; displaydeleted(); return formValidate() " type="submit" name="button" value="  <?php echo $this->_tpl_vars['APP']['LBL_VALIDATE_BUTTON_LABEL']; ?>
  " style="width:70px" >
...
" class="crmButton small save" onclick="this.form.action.value='Save'; displaydeleted(); if(!isFieldsFormValide(this.form)) return false; return formValidate() " type="submit" name="button" value="  <?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
  " style="width:95px">
              				                        <!--input title="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_TITLE']; ?>
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_KEY']; ?>
" class="crmbutton small save" onclick="this.form.action.value='SaveBC';return formValidate()" type="submit" name="button" value="  <?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
  " style="width:75px" -->
												<?php endif; ?>
...
_lib_1" id="naturesdepense_<?php echo $this->_tpl_vars['comptenat']; ?>
_lib_1"  size=70></td>
																	<td align="center"><input type="text" name="naturesdepense_<?php echo $this->_tpl_vars['comptenat']; ?>
_qte_1" id="naturesdepense_<?php echo $this->_tpl_vars['comptenat']; ?>
_qte_1" onmouseout="calculTotalDepense('<?php echo $this->_tpl_vars['comptenat']; ?>
','1')" size=10></td>
																	<td align="center"><input type="text" name="naturesdepense_<?php echo $this->_tpl_vars['comptenat']; ?>
_nb_1" id="naturesdepense_<?php echo $this->_tpl_vars['comptenat']; ?>
_nb_1" onmouseout="calculTotalDepense('<?php echo $this->_tpl_vars['comptenat']; ?>
','1')" size=10></td>
																	<td align=right><input type="text" name="naturesdepense_<?php echo $this->_tpl_vars['comptenat']; ?>
_pu_1" id="naturesdepense_<?php echo $this->_tpl_vars['comptenat']; ?>
_pu_1" onmouseout="calculTotalDepense('<?php echo $this->_tpl_vars['comptenat']; ?>
','1')" size=20></td>
																	<td align=right><input type="text" name="naturesdepense_<?php echo $this->_tpl_vars['comptenat']; ?>
_pt_1" id="naturesdepense_<?php echo $this->_tpl_vars['comptenat']; ?>
_pt_1"  size=20></td>
																	<td nowrap>
...
" class="crmButton small save" onclick="this.form.action.value='Save'; displaydeleted(); if(!isFieldsFormValide(this.form)) return false; return formValidate() " type="submit" name="button" value="  G&eacute;n&eacute;rer l'Ordre de Mission  " style="width:200px">
  ...
  " style="width:70px" >
										...
										<?php else: ?>
													<input title="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_TITLE']; ?>
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_KEY']; ?>
" class="crmButton small save" onclick="this.form.action.value='SaveBC'; displaydeleted(); if(!isFieldsFormValide(this.form)) return false; return formValidate() " type="submit" name="button" value="  <?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
  " style="width:95px">
              				                                	<!--input title="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_TITLE']; ?>
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_KEY']; ?>
