<?php /* Smarty version 2.6.18, created on 2009-10-07 11:52:14
         compiled from ActivityDetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'ActivityDetailView.tpl', 122, false),array('modifier', 'count', 'ActivityDetailView.tpl', 261, false),array('modifier', 'getTranslatedString', 'ActivityDetailView.tpl', 614, false),)), $this); ?>
...
'; <?php if ($this->_tpl_vars['VIEWTYPE'] == 'calendar'): ?> this.form.return_action.value='index'; <?php else: ?> this.form.return_action.value='ListView'; <?php endif; ?>  this.form.action.value='Delete'; return confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
						     ...
						     <table border=0 cellspacing=0 cellpadding=5 width=100% >
               					<!--	 <tr>
											...
											<td class="cellLabel" width="20%" align="right"><b><?php echo $this->_tpl_vars['LABEL']['visibility']; ?>
			                                                                ...
			                                                                <td class="cellInfo" width="30%" align="left" ><?php echo $this->_tpl_vars['MOD'][$this->_tpl_vars['vblty']]; ?>
</td>
											<?php endif; ?>
							 </tr> -->
							 <tr>
...
&nbsp;</td>
							...
							<?php if ($this->_tpl_vars['LABEL']['location'] != ''): ?>
								...
								<td class="cellInfo" align="left" ><?php echo $this->_tpl_vars['ACTIVITYDATA']['location']; ?>
&nbsp;</td>
							<?php endif; ?>	
							...
							<tr>							
								...
								<?php endif; ?>
								<?php if ($this->_tpl_vars['LABEL']['assigned_group_id'] != ''): ?>
									<td class="cellLabel" align="right" nowrap valign="top"><b><?php echo $this->_tpl_vars['LABEL']['assigned_group_id']; ?>
</b></td>
									<td class="cellInfo" align="left" nowrap valign="top"><?php echo $this->_tpl_vars['ACTIVITYDATA']['assigned_group_id']; ?>
</td>
								<?php endif; ?>
...
<?php endif; ?></td>
						    ...
						    <tr>
								...
								<td class="cellInfo" align="left"><?php echo $this->_tpl_vars['ACTIVITYDATA']['date_start']; ?>
&nbsp;<?php echo $this->_tpl_vars['ACTIVITYDATA']['starthr']; ?>
:<?php echo $this->_tpl_vars['ACTIVITYDATA']['startmin']; ?>
</td>
								<td  class="cellLabel" align="right"><b><?php echo $this->_tpl_vars['MOD']['LBL_EVENTEDAT']; ?>
</b></td>
								<td class="cellInfo" align="left"><?php echo $this->_tpl_vars['ACTIVITYDATA']['due_date']; ?>
&nbsp;<?php echo $this->_tpl_vars['ACTIVITYDATA']['endhr']; ?>
...
?>
							...
							<!-- detailed view of a ToDo -->
					 	     <table border="0" cellpadding="5" cellspacing="0" width="100%">
							<tr>
								<td class="cellLabel"  align="right"><b><?php echo $this->_tpl_vars['MOD']['LBL_TODO']; ?>
</b></td>
								<td class="cellInfo" colspan="3" align="left"><?php echo $this->_tpl_vars['ACTIVITYDATA']['subject']; ?>
</td>
							</tr>
							<?php if ($this->_tpl_vars['LABEL']['description'] != ''): ?>
								<tr>
	                                ...
	                                <td class="cellInfo" colspan="3" align="left" colspan="3" valign="top" height="40px"><?php echo $this->_tpl_vars['ACTIVITYDATA']['description']; ?>
&nbsp;</td>
	                			</tr>
							<?php endif; ?>
							 <tr>
...
<?php endif; ?>
								...
								<?php if ($this->_tpl_vars['LABEL']['taskstatus'] != ''): ?>
                                	<td class="cellLabel"  align="right"><b><?php echo $this->_tpl_vars['LABEL']['taskstatus']; ?>
</b></td>
									<td class="cellInfo" align="left" valign="top">
										...
										<?php else: ?> 
											<?php echo $this->_tpl_vars['ACTIVITYDATA']['taskstatus']; ?>
<?php endif; ?>
                                    </td>
								<?php endif; ?>
								</tr>
							<tr>
								<td class="cellLabel"  align="right"><b><?php echo $this->_tpl_vars['MOD']['LBL_TIMEDATE']; ?>
</b></td>
								<td class="cellInfo"><?php echo $this->_tpl_vars['ACTIVITYDATA']['date_start']; ?>
...
<?php echo $this->_tpl_vars['ACTIVITYDATA']['startfmt']; ?>
								...
								<td class="cellInfo"><?php echo $this->_tpl_vars['ACTIVITYDATA']['due_date']; ?>
</td>
							</tr>	
							<tr>
								<?php if ($this->_tpl_vars['LABEL']['createdtime'] != ''): ?>
									<td class="cellLabel" align=right nowrap><b><?php echo $this->_tpl_vars['LABEL']['createdtime']; ?>
</b></td>
									<td class="cellInfo" align=left nowrap><?php echo $this->_tpl_vars['ACTIVITYDATA']['createdtime']; ?>
</td>
								<?php endif; ?>	
								<?php if ($this->_tpl_vars['LABEL']['modifiedtime'] != ''): ?>
									<td class="cellLabel" align=right nowrap ><b><?php echo $this->_tpl_vars['LABEL']['modifiedtime']; ?>
</b></td>
									<td class="cellInfo" align=left  nowrap><?php echo $this->_tpl_vars['ACTIVITYDATA']['modifiedtime']; ?>
</td>
								<?php endif; ?>
                            </tr>    		
							...
							<tr>
								...
								<td class="cellInfo" align="left"><?php echo $this->_tpl_vars['ACTIVITYDATA']['assigned_user_id']; ?>
</td>
								<td class="cellLabel" align="right"><b>Equipe</b></td>
								<td class="cellInfo" align="left">
									<table cellpadding="2" cellspacing="5">
										<tr>
											<?php if ($this->_tpl_vars['ACTIVITYDATA']['chefequipe'] != ''): ?>
												<td align="right"><b>Chef Equipe :</b></td> 
												<td align="left"><?php echo $this->_tpl_vars['ACTIVITYDATA']['chefequipe']; ?>
</td>
											<?php endif; ?>	
											<?php if ($this->_tpl_vars['ACTIVITYDATA']['coordonnateur'] != ''): ?>	
												<td><b>Coordonnateur :</b></td> 
												<td align="left"><?php echo $this->_tpl_vars['ACTIVITYDATA']['coordonnateur']; ?>
</td>
											<?php endif; ?>
										</tr>
										<tr>	
											<?php if ($this->_tpl_vars['ACTIVITYDATA']['consultant1'] != ''): ?>
												<td align="right"><b>Consultant 1 :</b></td> 
												<td align="left"><?php echo $this->_tpl_vars['ACTIVITYDATA']['consultant1']; ?>
</td>
											<?php endif; ?>
											<?php if ($this->_tpl_vars['ACTIVITYDATA']['consultant2'] != ''): ?>
												<td><b>Consultant 2 :</b></td> 
												<td align="left"><?php echo $this->_tpl_vars['ACTIVITYDATA']['consultant2']; ?>
</td>
											<?php endif; ?>
										</tr>
										<tr>								
											<?php if ($this->_tpl_vars['ACTIVITYDATA']['assistant1'] != ''): ?>
												<td align="right"><b>Assistant 1 :</b></td> 
												<td align="left"><?php echo $this->_tpl_vars['ACTIVITYDATA']['assistant1']; ?>
</td>
											<?php endif; ?>
											<?php if ($this->_tpl_vars['ACTIVITYDATA']['assistant2'] != ''): ?>
												<td align="right"><b>Assistant 2 :</b></td> 
												<td align="left"><?php echo $this->_tpl_vars['ACTIVITYDATA']['assistant2']; ?>
</td>
											<?php endif; ?>
										</tr>	
									</table>	
