<?php /* Smarty version 2.6.18, created on 2011-07-05 13:51:37
...
" class="crmButton small edit" type="submit" name="Edit" >
					...
					<table width="100%"  border="0" cellspacing="0" cellpadding="5">
                      ...
                      <tr class="small">
                        <td width="15%" class="small cellLabel"><strong><?php echo $this->_tpl_vars['CMOD']['LBL_SUPERIEUR_H']; ?>
</strong></td>
                        <td width="85%" class="cellText" ><?php echo $this->_tpl_vars['GROUPINFO']['2']['supName']; ?>
</td>
                      </tr>
                      <tr class="small">
                        <td class="small cellLabel"><strong><?php echo $this->_tpl_vars['CMOD']['LBL_COORDONNATEUR']; ?>
</strong></td>
                        <td class="cellText"><?php echo $this->_tpl_vars['GROUPINFO']['2']['coordName']; ?>
</td>
                      </tr>
