<?php /* Smarty version 2.6.18, created on 2018-04-03 12:46:38
         compiled from EditViewTraitementReunionsUI.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'EditViewTraitementReunionsUI.tpl', 34, false),array('modifier', 'substr', 'EditViewTraitementReunionsUI.tpl', 532, false),array('function', 'html_options', 'EditViewTraitementReunionsUI.tpl', 179, false),)), $this); ?>
...
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
				...
				<?php elseif ($this->_tpl_vars['fldname'] == 'ticket' && $this->_tpl_vars['MODULE'] == 'TraitementReunions'): ?>
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="<?php echo $this->_tpl_vars['fldname']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
