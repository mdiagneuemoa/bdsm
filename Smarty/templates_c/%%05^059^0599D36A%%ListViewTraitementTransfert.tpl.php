<?php /* Smarty version 2.6.18, created on 2019-02-19 08:47:46
         compiled from ListViewTraitementTransfert.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'ListViewTraitementTransfert.tpl', 80, false),)), $this); ?>
...
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
							...
							<?php elseif ($this->_tpl_vars['value'] == 'submitted'): ?>
								<td  class="submitted" width=180 height=30 onClick="javascript:displayTraitementById('tab_<?php echo $this->_tpl_vars['i']; ?>
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
);">
							<?php elseif ($this->_tpl_vars['value'] == 'dir_accepted' || $this->_tpl_vars['value'] == 'dc_submitted'): ?>
...
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
							...
							<?php elseif ($this->_tpl_vars['value'] == 'dc_accepted' || $this->_tpl_vars['value'] == 'dc_authorized' || $this->_tpl_vars['value'] == 'db_accepted' || $this->_tpl_vars['value'] == 'dcf_accepted'): ?>
								<td  class="accepted" width=180 height=80 onClick="javascript:displayTraitementById('tab_<?php echo $this->_tpl_vars['i']; ?>
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
);">
							<?php elseif ($this->_tpl_vars['value'] == 'com_accepted'): ?>
								<td  class="accepted" width=180 height=80 onClick="javascript:displayTraitementById('tab_<?php echo $this->_tpl_vars['i']; ?>
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
);">
							<?php elseif ($this->_tpl_vars['value'] == 'umv_accepted'): ?>
								<td  class="accepted" width=180 height=80 onClick="javascript:displayTraitementById('tab_<?php echo $this->_tpl_vars['i']; ?>
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
);">
							<?php elseif ($this->_tpl_vars['value'] == 'authorized'): ?>
								<td  class="authorized" width=180 height=80 onClick="javascript:displayTraitementById('tab_<?php echo $this->_tpl_vars['i']; ?>
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
);">
							<?php elseif ($this->_tpl_vars['value'] == 'ch_cancelled'): ?>
...
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
							...
							<?php elseif ($this->_tpl_vars['value'] == 'dc_denied' || $this->_tpl_vars['value'] == 'db_denied' || $this->_tpl_vars['value'] == 'dcf_denied'): ?>
								<td  class="denied" width=180 height=80 onClick="javascript:displayTraitementById('tab_<?php echo $this->_tpl_vars['i']; ?>
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
);">	
...
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
							...
							<?php elseif ($this->_tpl_vars['value'] == 'db_denied' || $this->_tpl_vars['value'] == 'dcf_accepted'): ?>
								<td  class="denied" width=180 height=80 onClick="javascript:displayTraitementById('tab_<?php echo $this->_tpl_vars['i']; ?>
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
);">	
...
?>
							...
							<?php if ($this->_tpl_vars['libelle'] == 'statut'): ?>
							 	 ...
							 	 <?php if ($this->_tpl_vars['value'] == $this->_tpl_vars['APP']['reopen']): ?>
							 		<tr>
								 		<td colspan='2' align="center" class=dvInnerHeader><b>Statut:</b> <?php echo $this->_tpl_vars['APP']['reopen']; ?>
 </td>
								 	</tr>
								 <?php elseif ($this->_tpl_vars['value'] == $this->_tpl_vars['APP']['closed']): ?>
									<tr>
								 		<td colspan='2' align="center" class=dvInnerHeader><b>Statut:</b> <?php echo $this->_tpl_vars['APP']['closed']; ?>
 </td>
								 	</tr>
								 <?php elseif ($this->_tpl_vars['value'] == $this->_tpl_vars['APP']['submitted']): ?>
									<tr>
								 		<td colspan='2' align="center" class=dvInnerHeader><b>Statut:</b> <?php echo $this->_tpl_vars['APP']['submitted']; ?>
 </td>
								 	</tr>
								 <?php elseif ($this->_tpl_vars['value'] == $this->_tpl_vars['APP']['transfered']): ?>
									<tr>
								 		<td colspan='2' align="center" class=dvInnerHeader><b>Statut:</b> <?php echo $this->_tpl_vars['APP']['transfered']; ?>
 </td>
								 	</tr>
								 <?php elseif ($this->_tpl_vars['value'] == $this->_tpl_vars['APP']['open']): ?>
									<tr>
								 		<td colspan='2' align="center" class=dvInnerHeader><b>Statut:</b> <?php echo $this->_tpl_vars['APP']['open']; ?>
 </td>
								 	</tr>
