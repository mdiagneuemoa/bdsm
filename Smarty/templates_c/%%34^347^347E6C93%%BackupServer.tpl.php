<?php /* Smarty version 2.6.18, created on 2009-03-31 16:43:25
...
" class="crmButton small cancel" onclick="document.tandc.enable_backup.checked=false;clearBackupServer(this);" type="button" name="Clear" value="<?php echo $this->_tpl_vars['MOD']['LBL_CLEAR_DATA']; ?>
">
													<?php else: ?>
														<input title="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_KEY']; ?>
