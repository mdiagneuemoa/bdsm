<?php /* Smarty version 2.6.18, created on 2010-03-02 15:54:28
         compiled from Reports.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'Reports.tpl', 78, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?></td>		
	...
	<td>
		<table border=0 cellspacing=0 cellpadding=0>
			<tr>
				<td style="padding-right:5px"><a href="javascript:;" onclick="gcurrepfolderid=0;fnvshobj(this,'reportLay');"><img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
reportsCreate.gif" alt="<?php echo $this->_tpl_vars['MOD']['LBL_CREATE_REPORT']; ?>
..." title="<?php echo $this->_tpl_vars['MOD']['LBL_CREATE_REPORT']; ?>
..." border=0></a></td>
                        <td>&nbsp;</td>
            <td style="padding-right:5px"><a href="javascript:;" onclick="createrepFolder(this,'orgLay');"><img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
reportsFolderCreate.gif" alt="<?php echo $this->_tpl_vars['MOD']['Create_New_Folder']; ?>
..." title="<?php echo $this->_tpl_vars['MOD']['Create_New_Folder']; ?>
..." border=0></a></td>
                        <td>&nbsp;</td>
            <td style="padding-right:5px"><a href="javascript:;" onclick="fnvshobj(this,'folderLay');"><img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
reportsMove.gif" alt="<?php echo $this->_tpl_vars['MOD']['Move_Reports']; ?>
..." title="<?php echo $this->_tpl_vars['MOD']['Move_Reports']; ?>
..." border=0></a></td>
                        <td>&nbsp;</td>
            <td style="padding-right:5px"><a href="javascript:;" onClick="massDeleteReport();"><img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
reportsDelete.gif" alt="<?php echo $this->_tpl_vars['MOD']['LBL_DELETE_FOLDER']; ?>
