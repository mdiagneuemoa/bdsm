<?php /* Smarty version 2.6.18, created on 2015-12-11 01:05:22
         compiled from ListViewTraitementConvention.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'ListViewTraitementConvention.tpl', 62, false),)), $this); ?>

 <tr>
	<td colspan=4 class="dvInnerHeader">
    	<b><?php echo $this->_tpl_vars['APP']['LBL_ETAPES_CONVENTION']; ?>
</b>
	</td>
 </tr>
 <tr><td>&nbsp;</td></tr>	
...
?>
					   ...
					   <?php if ($this->_tpl_vars['libelle'] == 'statut'): ?>
						    ...
						    <?php if ($this->_tpl_vars['value'] == $this->_tpl_vars['APP']['initiated']): ?>
								<td  class="initiate" width=180 height=80 onClick="javascript:displayTraitementById('tab_<?php echo $this->_tpl_vars['i']; ?>
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
);">
							<?php elseif ($this->_tpl_vars['value'] == $this->_tpl_vars['APP']['denied']): ?>
								<td  class="denied" width=180 height=80 onClick="javascript:displayTraitementById('tab_<?php echo $this->_tpl_vars['i']; ?>
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
);">
							<?php elseif ($this->_tpl_vars['value'] == $this->_tpl_vars['APP']['certifiedDFB']): ?>
								<td  class="certifiedDFB" width=180 height=80 onClick="javascript:displayTraitementById('tab_<?php echo $this->_tpl_vars['i']; ?>
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
);">
							<?php elseif ($this->_tpl_vars['value'] == $this->_tpl_vars['APP']['certifiedDAJ']): ?>
								<td  class="certifiedDAJ" width=180 height=80 onClick="javascript:displayTraitementById('tab_<?php echo $this->_tpl_vars['i']; ?>
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
);">
							<?php elseif ($this->_tpl_vars['value'] == $this->_tpl_vars['APP']['approve']): ?>
								<td  class="approve" width=180 height=80 onClick="javascript:displayTraitementById('tab_<?php echo $this->_tpl_vars['i']; ?>
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
);">
							<?php elseif ($this->_tpl_vars['value'] == $this->_tpl_vars['APP']['validate']): ?>
								<td  class="validate" width=180 height=80 onClick="javascript:displayTraitementById('tab_<?php echo $this->_tpl_vars['i']; ?>
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
);">
							<?php elseif ($this->_tpl_vars['value'] == $this->_tpl_vars['APP']['closed']): ?>
								<td  class="closed" width=180 height=80 onClick="javascript:displayTraitementById('tab_<?php echo $this->_tpl_vars['i']; ?>
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
);">
							<?php elseif ($this->_tpl_vars['value'] == $this->_tpl_vars['APP']['running']): ?>
								<td  class="running" width=180 height=80 onClick="javascript:displayTraitementById('tab_<?php echo $this->_tpl_vars['i']; ?>
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
);">
							<?php elseif ($this->_tpl_vars['value'] == $this->_tpl_vars['APP']['approveDAJ']): ?>
								<td  class="approveDAJ" width=180 height=80 onClick="javascript:displayTraitementById('tab_<?php echo $this->_tpl_vars['i']; ?>
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
);">
							<?php elseif ($this->_tpl_vars['value'] == $this->_tpl_vars['APP']['finalised']): ?>
								<td  class="complete" width=180 height=80 onClick="javascript:displayTraitementById('tab_<?php echo $this->_tpl_vars['i']; ?>
' , <?php echo $this->_tpl_vars['NBTRAITEMENT']; ?>
);">
							<?php endif; ?>
