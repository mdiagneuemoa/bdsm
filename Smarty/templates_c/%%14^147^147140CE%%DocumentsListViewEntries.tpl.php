<?php /* Smarty version 2.6.18, created on 2009-10-08 12:05:43
         compiled from DocumentsListViewEntries.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'DocumentsListViewEntries.tpl', 68, false),array('modifier', 'count', 'DocumentsListViewEntries.tpl', 89, false),array('function', 'html_options', 'DocumentsListViewEntries.tpl', 319, false),)), $this); ?>
...
">				
								...
								<!--<input title="Nouveau Document" class="button" onclick="this.form.action.value='EditView';this.form.module.value='<?php echo $this->_tpl_vars['MODULE']; ?>
';this.form.return_action.value='DetailView';this.form.folderid.value='<?php echo $this->_tpl_vars['folder']['folderid']; ?>
';" type="submit" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CREATE_BUTTON_LABEL']; ?>
