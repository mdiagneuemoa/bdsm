...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'Home/HomeButtons.tpl', 27, false),)), $this); ?>
...
" style="cursor:pointer;">
	...
	-->
	<!--
<?php if ($this->_tpl_vars['CHECK']['Calendar'] == 'yes' && $this->_tpl_vars['CALENDAR_ACTIVE'] == 'yes'): ?>
	<td>
		<img width="27" height="27" src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
...
?>
							<?php $this->assign('MODULE_LABEL', $this->_tpl_vars['arr']['1']); ?>
							<?php if ($this->_tpl_vars['APP'][$this->_tpl_vars['arr']['1']] != ''): ?>		
								<?php $this->assign('MODULE_LABEL', $this->_tpl_vars['APP'][$this->_tpl_vars['arr']['1']]); ?>
							<?php endif; ?>
