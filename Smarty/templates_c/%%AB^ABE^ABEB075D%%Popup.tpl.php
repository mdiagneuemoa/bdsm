<?php /* Smarty version 2.6.18, created on 2009-03-26 18:26:57
         compiled from Popup.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'Popup.tpl', 83, false),array('function', 'html_options', 'Popup.tpl', 95, false),)), $this); ?>
<script>
var z=<?php echo $this->_tpl_vars['LISTENTITYACTION']; ?>
;
...
">
								<input name="from_link" id="from_link" type="hidden" value="<?php echo $_REQUEST['fromlink']['value']; ?>
">
...
">
									...
									<input name="form"  id="popupform" type="hidden" value="<?php echo $_REQUEST['form']; ?>
">
									<input name="forfield"  id="forfield" type="hidden" value="<?php echo $_REQUEST['forfield']; ?>
">
									<input name="srcmodule"  id="srcmodule" type="hidden" value="<?php echo $_REQUEST['srcmodule']; ?>
">
									<input name="forrecord"  id="forrecord" type="hidden" value="<?php echo $_REQUEST['forrecord']; ?>
">
								<?php endif; ?>
															</td>
