<?php /* Smarty version 2.6.18, created on 2018-09-28 09:35:04
         compiled from ListView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'ListView.tpl', 339, false),array('modifier', 'date_format', 'ListView.tpl', 460, false),array('function', 'html_options', 'ListView.tpl', 376, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
		<?php elseif ($this->_tpl_vars['MODULE'] == 'ReportingRegie'): ?>	
			<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'Buttons_List_ReportingRegie.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
		<?php elseif ($this->_tpl_vars['MODULE'] == 'UsersNomade'): ?>	
			<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'Buttons_List_UsersNomade.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>		
		<?php else: ?>
...
">
				...
				<!--tr><td><marquee direction="left" color="red"><font color="blue"><b>Les délégations de pouvoir sont désormais opérationnelles dans le système.</b></font></MARQUEE></td></tr-->
...
<?php if ($this->_tpl_vars['MODULE'] == 'ReportingUMV'): ?>
<div id="filterAcc3" style="z-index:1;display:block;position:relative;">
	<form name="basicFilter3" method="post" action="index.php" onSubmit="return callFilter3();">
		<table width="70%" cellpadding="2" cellspacing="5"  class="searchUIBasic small" align="center" border=0>
			<tr>
				<td class="searchUIName small" nowrap align="left" rowspan=4 colspan=2>
				<span class="moduleName"><?php echo $this->_tpl_vars['APP']['LBL_FILTER']; ?>
 :</span><br>
				</td>
				<!--td class="small" valign="top" colspan=3 align="right" onMouseOver="this.style.cursor='pointer';" onclick="moveMe('filterAcc3');searchshowhide('filterAcc3','advSearch')">[x]</td-->
			</tr>
			<tr>
				<td class="small" nowrap width=50 nowrap><b>D&eacute;partement</b>&nbsp;:</td>
				<td class="small" nowrap align=left colspan=2>
					<div id="filter_depart">
						<select name="depart_field" id="filter_depart_field" class="txtBox" style="width:200px">
						 <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['DEPARTEMENTS']), $this);?>
				...
				<tr>
				<td class="small" nowrap width=50 nowrap><b>Agent</b>&nbsp;:</td>
				<td class="small" nowrap align=left colspan=2>
					<div id="filter_agent">
						<select name="agent_field" id="filter_agent_field" class="txtBox" style="width:200px">
						 <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['AGENTS']), $this);?>
				...
				<b> <?php echo $this->_tpl_vars['APP']['LNK_LIST_START']; ?>
					...
					<input name="date_start" id="jscal_field_date_start2" type="text" style="border:1px solid #bababa;" size="11" maxlength="10" value="<?php echo $this->_tpl_vars['DATEDEBFILTER']; ?>
">&nbsp;
					<img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
btnL3Calendar.gif" id="jscal_trigger_date_start2">
					<font size="1"><em old="(yyyy-mm-dd)">(<?php echo $this->_tpl_vars['DATEFORMAT']; ?>
)</em></font>
						<script type="text/javascript" id='massedit_calendar_date_start'>
							Calendar.setup ({
							inputField : "jscal_field_date_start2", ifFormat : "<?php echo $this->_tpl_vars['JS_DATEFORMAT']; ?>
", showsTime : false, button : "jscal_trigger_date_start2", singleClick : true, step : 1
							});
						</script>
				...
				<td  align=left>					
					...
					<input name="date_end" id="jscal_field_date_end2" type="text" style="border:1px solid #bababa;" size="11" maxlength="10" value="<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d-%m-%Y") : smarty_modifier_date_format($_tmp, "%d-%m-%Y")); ?>
">&nbsp;
					<img src="<?php echo $this->_tpl_vars['IMAGE_PATH']; ?>
btnL3Calendar.gif" id="jscal_trigger_date_end2">
					<font size="1"><em old="(yyyy-mm-dd)">(<?php echo $this->_tpl_vars['DATEFORMAT']; ?>
)</em></font>
						<script type="text/javascript" id='massedit_calendar_date_end'>
							Calendar.setup ({
							inputField : "jscal_field_date_end2", ifFormat : "<?php echo $this->_tpl_vars['JS_DATEFORMAT']; ?>
", showsTime : false, button : "jscal_trigger_date_end2", singleClick : true, step : 1
							});
						</script>
...
">
				...
				<tr>
					<td class="small" nowrap width=40% colspan =4 align = center>
						  <input name="submit" type="button" class="crmbutton small create" onClick="callFilter3();" value=" <?php echo $this->_tpl_vars['APP']['LBL_FILTER']; ?>
 ">&nbsp;
					</td>
				</tr>
...
<br>
<?php if ($this->_tpl_vars['MODULE'] == 'Candidats'): ?>
<div align=center><span style="color: #27AE60; font-size: 14px;font-family: Arial, Helvetica, sans-serif;font-weight: bold;">Liste des Candidats à la bourse de Soutien de l’UEMOA à la formation et à la recherche Edition <?php echo $this->_tpl_vars['BOURSEEDITION']; ?>
</span>	</div>										
<?php endif; ?>

	   <!-- PUBLIC CONTENTS STARTS-->
	  <div id="ListViewContents" class="small" style="width:100%;">
	  <?php echo $this->_tpl_vars['WHERECLAUSE']; ?>
