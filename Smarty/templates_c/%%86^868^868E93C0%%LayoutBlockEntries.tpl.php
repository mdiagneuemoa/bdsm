<?php /* Smarty version 2.6.18, created on 2009-04-01 09:06:32
         compiled from Settings/LayoutBlockEntries.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'Settings/LayoutBlockEntries.tpl', 24, false),array('modifier', 'count', 'Settings/LayoutBlockEntries.tpl', 386, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['value']['fieldlabel']; ?>
												...
												<table border=0 cellspacing=0 cellpadding=5 width=100% class="layerPopupTransport">
													<tr>
														<td align="center">
															<input type="button" name="save" value="<?php echo $this->_tpl_vars['APP']['LBL_ASSIGN_BUTTON_LABEL']; ?>
...
,<?php echo $this->_tpl_vars['value']['massedit']; ?>
							 		...
							 		<?php if ($this->_tpl_vars['value']['mandatory'] == '0' || $this->_tpl_vars['value']['mandatory'] == '2'): ?>
							 			<font color='red'> *</font>
							 		<?php endif; ?>
							 	</td>
...
"  type="checkbox" 
														<?php if ($this->_tpl_vars['value']['mandatory'] == '0'): ?> 
															checked  disabled 
														<?php endif; ?>
														<?php if ($this->_tpl_vars['value']['mandatory'] == '3'): ?> 
															disabled 
														<?php endif; ?>
														<?php if ($this->_tpl_vars['value']['mandatory'] == '2'): ?>
														 	checked 
														<?php endif; ?>
