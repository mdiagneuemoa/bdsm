<?php /* Smarty version 2.6.18, created on 2011-03-01 10:05:54
         compiled from EditViewTransfertUI.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'EditViewTransfertUI.tpl', 34, false),array('modifier', 'substr', 'EditViewTransfertUI.tpl', 450, false),)), $this); ?>
...
_display.value=''; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
			...
			<?php if ($this->_tpl_vars['fldname'] == 'ticket'): ?>
				<td width=20% class="dvtCellLabel" align=right>
...
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'"  size="20">
				</td> 
			<?php elseif ($this->_tpl_vars['fldname'] == 'datemodification'): ?>
						<input type="hidden" name="<?php echo $this->_tpl_vars['fldname']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" readonly="true" value="<?php echo $this->_tpl_vars['DATEMODIF']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'"  size="20">
			<?php elseif ($this->_tpl_vars['fldname'] == 'user'): ?>
				<input type="hidden" name="<?php echo $this->_tpl_vars['fldname']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" readonly="true" value="<?php echo $this->_tpl_vars['USER_ID']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'"  size="20">
			<?php endif; ?>
...
'>
			...
			<?php endif; ?>
		<?php elseif ($this->_tpl_vars['fldname'] == 'description'): ?>
			<td width=20% class="dvtCellLabel" align=right>
...
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'" rows=2><?php echo $this->_tpl_vars['fldvalue']; ?>
		...
		<?php elseif ($this->_tpl_vars['fldname'] == 'destination'): ?> <!-- uitype 111 added for noneditable existing picklist values - ahmed -->
			<td width="20%" class="dvtCellLabel" align=right>
...
_mass_edit_check" class="small"  disabled >
			...
			<td colspan="1" width="30%" align=left class="dvtCellInfo">
				<input name="<?php echo $this->_tpl_vars['fldname']; ?>
"  class="detailedViewTextBox"  type="file" value="<?php echo $this->_tpl_vars['secondvalue']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
