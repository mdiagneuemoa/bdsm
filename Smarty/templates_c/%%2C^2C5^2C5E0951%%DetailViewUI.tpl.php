<?php /* Smarty version 2.6.18, created on 2018-07-12 17:27:25
         compiled from DetailViewUI.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'DetailViewUI.tpl', 34, false),array('modifier', 'count', 'DetailViewUI.tpl', 91, false),array('modifier', 'cat', 'DetailViewUI.tpl', 185, false),array('modifier', 'replace', 'DetailViewUI.tpl', 193, false),array('modifier', 'wordwrap', 'DetailViewUI.tpl', 195, false),array('modifier', 'regex_replace', 'DetailViewUI.tpl', 254, false),)), $this); ?>

<!-- This file is used to display the fields based on the ui type in detailview -->

		<?php if ($this->_tpl_vars['keyid'] == '1' || $this->_tpl_vars['keyid'] == 2 || $this->_tpl_vars['keyid'] == '11' || $this->_tpl_vars['keyid'] == '7' || $this->_tpl_vars['keyid'] == '9' || $this->_tpl_vars['keyid'] == '55' || $this->_tpl_vars['keyid'] == '71' || $this->_tpl_vars['keyid'] == '72' || $this->_tpl_vars['keyid'] == '103' || $this->_tpl_vars['keyid'] == '255' || $this->_tpl_vars['keyid'] == '300'): ?> <!--TextBox-->
...
"><?php echo $this->_tpl_vars['keyval']; ?>
					...
					<?php endif; ?>
				<?php endif; ?>
				<?php if ($this->_tpl_vars['keyid'] == 1 && $this->_tpl_vars['keyfldname'] == 'folderid'): ?>	
...
"><?php echo $this->_tpl_vars['FOLDERNAME']; ?>
				...
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'nom' && ( $this->_tpl_vars['MODULE'] == 'Demandes' )): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['AGENTNOM']; ?>
</span>
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'prenom' && ( $this->_tpl_vars['MODULE'] == 'Demandes' )): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['AGENTPRENOM']; ?>
</span>
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'service' && ( $this->_tpl_vars['MODULE'] == 'Demandes' )): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['AGENTSERVICE']; ?>
</span>
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'matricule' && ( $this->_tpl_vars['MODULE'] == 'Demandes' )): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['AGENTMATRICULE']; ?>
</span>
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'datedernmission' && ( $this->_tpl_vars['MODULE'] == 'Demandes' )): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['DATEDERNMISSION']; ?>
</span>	
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'intervalmission' && $this->_tpl_vars['MODULE'] == 'Demandes'): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['INTERVALMISSION']; ?>
</span>	
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'nbjourannee' && $this->_tpl_vars['MODULE'] == 'Demandes'): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['NBJOURCONSOMME']; ?>
</span>
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'nom' && ( $this->_tpl_vars['MODULE'] == 'OrdresMission' )): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['AGENTNOM']; ?>
</span>
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'prenom' && ( $this->_tpl_vars['MODULE'] == 'OrdresMission' )): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['AGENTPRENOM']; ?>
</span>
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'service' && ( $this->_tpl_vars['MODULE'] == 'OrdresMission' )): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['AGENTSERVICE']; ?>
</span>
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'matricule' && ( $this->_tpl_vars['MODULE'] == 'OrdresMission' )): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['AGENTMATRICULE']; ?>
</span>
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'datedernmission' && ( $this->_tpl_vars['MODULE'] == 'OrdresMission' )): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['DATEDERNMISSION']; ?>
</span>						
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'lieu' && $this->_tpl_vars['MODULE'] == 'OrdresMission'): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['DEMANDELIEU']; ?>
</span>	
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'objet' && $this->_tpl_vars['MODULE'] == 'OrdresMission'): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['DEMANDEOBJET']; ?>
</span>	
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'fonction' && $this->_tpl_vars['MODULE'] == 'OrdresMission'): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['AGENTFONCTION']; ?>
</span>	
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'datedebut' && $this->_tpl_vars['MODULE'] == 'OrdresMission'): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['DEMANDEDATEDEB']; ?>
</span>	
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'datefin' && $this->_tpl_vars['MODULE'] == 'OrdresMission'): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['DEMANDEDATEFIN']; ?>
</span>	
				<?php elseif ($this->_tpl_vars['keyfldname'] == 'commentbillet' && $this->_tpl_vars['MODULE'] == 'OrdresMission'): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['DEMANDECOMMENTBILLET']; ?>
</span>	
					<?php elseif ($this->_tpl_vars['keyfldname'] == 'nomcomplet' && $this->_tpl_vars['MODULE'] == 'OrdresMission'): ?>
					<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['AGENTNOM']; ?>
</span>	
					<?php else: ?>
					<?php if ($this->_tpl_vars['MODULE'] == 'Incidents' && $this->_tpl_vars['keyfldname'] == 'popimpactee'): ?>
						&nbsp;&nbsp;<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['keyval']; ?>
<?php echo $this->_tpl_vars['ALL_POPULATION_CHECKED']; ?>
</span>
					<?php else: ?>
						&nbsp;&nbsp;<span id="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['keyval']; ?>
...
?>
				...
				<?php if ($this->_tpl_vars['selected_val'] != ''): ?>
					<?php if ($this->_tpl_vars['MODULE'] == 'TypeIncidents'): ?>
...
')" class="link"><?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
        ...
        <?php elseif ($this->_tpl_vars['keyid'] == '19' || $this->_tpl_vars['keyid'] == '20'): ?> <!--TextArea/Description-->
				...
				<?php endif; ?>
				<?php if ($this->_tpl_vars['MODULE'] == 'Documents' || $this->_tpl_vars['MODULE'] == 'HReports' || $this->_tpl_vars['MODULE'] == 'Demandes' || $this->_tpl_vars['MODULE'] == 'Incidents'): ?>
					<?php if ($this->_tpl_vars['keyfldname'] == 'description' || $this->_tpl_vars['keyfldname'] == 'objet' || $this->_tpl_vars['keyfldname'] == 'commentbillet'): ?>
						<!--To give hyperlink to URL-->
						<td width="100%" colspan="4" class="dvtCellInfo">
...
", ifFormat : '%Y-%m-%d', showsTime : false, button : "jscal_trigger_<?php echo $this->_tpl_vars['keyfldname']; ?>
", singleClick : true, step : 1
			...
			<?php if ($this->_tpl_vars['keyfldname'] == 'datelivraison' && $this->_tpl_vars['CATEGORY'] == 'Demandes'): ?>
				<td class="dvtCellLabel" align=right width=25%><input type="hidden" id="hdtxt_IsAdmin" value="posteur"></input><?php echo $this->_tpl_vars['MOD']['POSTEUR']; ?>
 </td>
				<td class="dvtCellInfo" align="left" width=25%">&nbsp;<?php echo $this->_tpl_vars['POSTEUR_INFO']; ?>
</td>
			<?php endif; ?>
		...
		<?php else: ?><!-- for Image Reflection and : Hodar crm  $keyid neq '27' pour ne pas afficher filelocationtype -->
			<td class="dvtCellInfo" align="left" width=25%">&nbsp;<?php echo $this->_tpl_vars['keyval']; ?>
</td>
			
						<?php if ($this->_tpl_vars['keyfldname'] == 'heurefin_relle' && $this->_tpl_vars['CATEGORY'] == 'Incidents'): ?>
				<tr style="height:25px"><td class="dvtCellLabel" align=right width=25%><input type="hidden" id="hdtxt_IsAdmin" value="posteur"></input><?php echo $this->_tpl_vars['MOD']['POSTEUR']; ?>
 </td>
				<td class="dvtCellInfo" align="left" width=25%">&nbsp;<?php echo $this->_tpl_vars['POSTEUR_INFO']; ?>
</td></tr>
			<?php endif; ?>
