<?php /* Smarty version 2.6.18, created on 2018-04-03 10:38:22
...
">
        ...
        <input type="hidden" name="return_action">
        <input type="hidden" name="return_id">
		 <input type="hidden" name="idToBackup">
...
<!-- for module timesheet hodar crm 30/07/09 -->
...
">
        ...
        <input type="hidden" name="return_module">
        <input type="hidden" name="return_action">
        <input type="hidden" name="timesheet_id" value="<?php echo $this->_tpl_vars['ID']; ?>
">
        <input type="hidden" name="account_id" value="<?php echo $this->_tpl_vars['ACCOUNTID']; ?>
">
		<input type="hidden" name="return_id">
...
<?php elseif ($this->_tpl_vars['MODULE'] == 'Demandes' || $this->_tpl_vars['MODULE'] == 'Incidents'): ?>
		<input type="hidden" name="module" value="<?php echo $this->_tpl_vars['MODULE']; ?>
">
        <input type="hidden" name="isDuplicate" value=false>
...
">
		<input type="hidden" name="return_id">
		<input type="hidden" name="dmd">
		<input type="hidden" name="opt">
		<input type="hidden" name="statut">
		<input type="hidden" name="cloturer" value=false>
		<input type="hidden" name="reserver" value=false>
