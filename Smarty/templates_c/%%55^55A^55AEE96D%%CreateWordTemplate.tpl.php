<?php /* Smarty version 2.6.18, created on 2009-07-08 15:54:34
         compiled from CreateWordTemplate.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'CreateWordTemplate.tpl', 16, false),)), $this); ?>
...
" class="crmButton small cancel" />
 ...
 <?php echo $this->_tpl_vars['UMOD']['LBL_TEMPLATE_FILE']; ?>
					...
					<tr>
						...
						<td class="cellText small" valign=top><textarea name="txtDescription" class=small style="width:90%;height:50px"><?php echo $_REQUEST['description']; ?>
</textarea></td>
					  </tr>
					<tr>
