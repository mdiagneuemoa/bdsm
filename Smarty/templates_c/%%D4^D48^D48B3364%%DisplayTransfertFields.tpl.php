<?php /* Smarty version 2.6.18, created on 2011-02-25 11:57:36
         compiled from DisplayTransfertFields.tpl */ ?>
...
?>
	<!-- Test permettant de ne pas afficher le champ Fichier joint -->
	<?php $this->assign('uitype', ($this->_tpl_vars['subdata'][1][0][0])); ?>
	<?php if ($this->_tpl_vars['uitype'] != 61): ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => 'EditViewTransfertUI.tpl', 'smarty_include_vars' => array()));
