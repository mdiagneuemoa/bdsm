<?php /* Smarty version 2.6.18, created on 2009-10-07 16:08:04
         compiled from ActivityEditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'ActivityEditView.tpl', 342, false),array('modifier', 'vtiger_imageurl', 'ActivityEditView.tpl', 812, false),)), $this); ?>
...
<form name="EditView" method="POST" action="index.php" <?php if ($this->_tpl_vars['ACTIVITY_MODE'] != 'Task'): ?> onsubmit="return check_form();" <?php else: ?> onsubmit="maintask_check_form();return formValidate();" <?php endif; ?> >
...
>
									...
									<tr>
										...
										<td class="cellInfo" align="left" colspan="3"><input name="subject" type="text" class="textbox" value="<?php echo $this->_tpl_vars['ACTIVITYDATA']['subject']; ?>
" style="width:50%">&nbsp;&nbsp;&nbsp;
										<!--
...
><?php echo $this->_tpl_vars['MOD']['LBL_PUBLIC']; ?>
							...
							<tr>
								...
								<td class="cellInfo" align="left" colspan="3"><textarea style="width:100%; height : 60px;" name="description"><?php echo $this->_tpl_vars['ACTIVITYDATA']['description']; ?>
</textarea></td>
                					</tr>
							<?php endif; ?>
							<tr>
...
" style="width:50%">
								<?php endif; ?>
								<td class="cellLabel" align="right"><?php if ($this->_tpl_vars['LABEL']['eventstatus'] != ''): ?><b><font color="red"><?php echo $this->_tpl_vars['TYPEOFDATA']['eventstatus']; ?>
...
><?php echo $this->_tpl_vars['arr'][0]; ?>
							...
							<tr>
								<td class="cellLabel" align="right"><?php if ($this->_tpl_vars['LABEL']['assigned_user_id'] != ''): ?><b><?php echo $this->_tpl_vars['LABEL']['assigned_user_id']; ?>
</b><?php endif; ?></td>
								<td class="cellInfo" align="left">
...
" type="hidden">
									...
									<?php if ($this->_tpl_vars['LABEL']['taskpriority'] != ''): ?>
										<td class="cellLabel" align="right"><b><?php echo $this->_tpl_vars['LABEL']['taskpriority']; ?>
</b>
										<td class="cellInfo" align="left">
...
><?php echo $this->_tpl_vars['arr'][0]; ?>
							...
							<tr>
						    <td class="cellLabel" align="right"><b><?php echo $this->_tpl_vars['MOD']['LBL_EVENTSTAT']; ?>
</b></td>
							<td class="cellInfo" align="left">
								<table>							
...
", showsTime : false, button : "jscal_trigger_date_start", singleClick : true, step : 1
							...
							<td class="cellLabel" align="right"><b><?php echo $this->_tpl_vars['MOD']['LBL_EVENTEDAT']; ?>
</b></td>
							<td class="cellInfo" align="left">
								<table>
							...
							<tr><td>
								<table border=0 cellspacing=0 cellpadding=3 width=100%>
									<tr>
										...
										<td id="cellTabInvite" class="dvtSelectedCell" align=center nowrap><a href="javascript:doNothing()" onClick="switchClass('cellTabInvite','on');switchClass('cellTabRelatedto','off');gshow('addEventInviteUI','',document.EditView.date_start.value,document.EditView.due_date.value,document.EditView.starthr.value,document.EditView.startmin.value,document.EditView.startfmt.value,document.EditView.endhr.value,document.EditView.endmin.value,document.EditView.endfmt.value);ghide('addEventRelatedtoUI');"><?php echo $this->_tpl_vars['MOD']['LBL_INVITE']; ?>
</a></td>
										<!--
										...
										<td id="cellTabRelatedto" class="dvtUnSelectedCell" align=center nowrap><a href="javascript:doNothing()" onClick="switchClass('cellTabInvite','off');switchClass('cellTabRelatedto','on');ghide('addEventInviteUI');gshow('addEventRelatedtoUI','',document.EditView.date_start.value,document.EditView.due_date.value,document.EditView.starthr.value,document.EditView.startmin.value,document.EditView.startfmt.value,document.EditView.endhr.value,document.EditView.endmin.value,document.EditView.endfmt.value);ghide('addEventRepeatUI');"><?php echo $this->_tpl_vars['MOD']['LBL_RELATEDTO']; ?>
</a></td>
										-->
										...
										<tr>
											...
											<td nowrap width=80% valign=top>
												...
												<tr>
													...
													<td colspan=2><?php echo $this->_tpl_vars['MOD']['LBL_ENABLE_REPEAT']; ?>
<td>
												</tr>
												<tr>
													<td colspan=2>
...
">
		...
		<table border="0" cellpadding="5" cellspacing="0" width="100%">
			<tr>
                        	<td class="cellLabel" align="right"><b><font color="red"><?php echo $this->_tpl_vars['TYPEOFDATA']['subject']; ?>
</font><?php echo $this->_tpl_vars['MOD']['LBL_TODO']; ?>
</b></td>
                        	<td class="cellInfo" colspan="3" align="left"><input name="subject" value="<?php echo $this->_tpl_vars['ACTIVITYDATA']['subject']; ?>
" class="textbox" style="width: 70%;" type="text"></td>
			...
			<tr>
				...
				<td class="cellInfo" align="left" colspan="3"><textarea style="width: 90%; height: 60px;" name="description"><?php echo $this->_tpl_vars['ACTIVITYDATA']['description']; ?>
</textarea>
				<?php endif; ?>
			...
			<?php if ($this->_tpl_vars['LABEL']['taskstatus'] != ''): ?>
				<td class="cellLabel" align="right"><b><font color="red"><?php echo $this->_tpl_vars['TYPEOFDATA']['taskstatus']; ?>
...
><?php echo $this->_tpl_vars['arr'][0]; ?>
				...
				<?php endif; ?>
				<?php if ($this->_tpl_vars['LABEL']['taskpriority'] != ''): ?>
						<td class="cellLabel" align="right"><b><font color="red"><?php echo $this->_tpl_vars['TYPEOFDATA']['taskpriority']; ?>
...
><?php echo $this->_tpl_vars['arr'][0]; ?>
			...
			<tr>
				<?php if ($this->_tpl_vars['LABEL']['assigned_user_id'] != ''): ?>
					<td  class="cellLabel" align="right"><b><?php echo $this->_tpl_vars['LABEL']['assigned_user_id']; ?>
</b></td>
					<td class="cellInfo" align="left">
						<?php $this->assign('check', 1); ?>
						<?php $_from = $this->_tpl_vars['ACTIVITYDATA']['assigned_user_id']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
?>
						...
						<?php if ($this->_tpl_vars['check'] == 0): ?>
								...
								<?php $this->assign('style_user', 'display:block'); ?>
								<?php $this->assign('style_group', 'display:none'); ?>
								<?php $this->assign('style_staffing', 'display:block'); ?>
						<?php else: ?>
								<?php $this->assign('select_group', 'checked'); ?>
								<?php $this->assign('style_user', 'display:none'); ?>
								<?php $this->assign('style_group', 'display:block'); ?>
								<?php $this->assign('style_staffing', 'display:none'); ?>
						<?php endif; ?>
						<?php if ($this->_tpl_vars['ACTIVITY_MODE'] == 'Task'): ?>
							<input type="radio" name="task_assigntype" <?php echo $this->_tpl_vars['select_user']; ?>
 value="U" onclick="toggleTaskAssignType(this.value)">&nbsp;<?php echo $this->_tpl_vars['APP']['LBL_USER']; ?>
 ...
 value="U" onclick="toggleAssignType(this.value)">&nbsp;<?php echo $this->_tpl_vars['APP']['LBL_USER']; ?>
						...
						<?php if ($this->_tpl_vars['secondvalue']['assigned_user_id'] != ''): ?>
							<?php if ($this->_tpl_vars['ACTIVITY_MODE'] == 'Task'): ?>
								<input type="radio" name="task_assigntype" <?php echo $this->_tpl_vars['select_group']; ?>
 value="T" onclick="toggleTaskAssignType(this.value)">&nbsp;<?php echo $this->_tpl_vars['APP']['LBL_GROUP']; ?>
 ...
 value="T" onclick="toggleAssignType(this.value)">&nbsp;<?php echo $this->_tpl_vars['APP']['LBL_GROUP']; ?>
						...
						<?php if ($this->_tpl_vars['ACTIVITY_MODE'] == 'Task'): ?>
							<span id="task_assign_user" style="<?php echo $this->_tpl_vars['style_user']; ?>
">
...
><?php echo $this->_tpl_vars['sel_value']; ?>
						...
						<?php if ($this->_tpl_vars['secondvalue']['assigned_user_id'] != ''): ?>
							<?php if ($this->_tpl_vars['ACTIVITY_MODE'] == 'Task'): ?>
								<span id="task_assign_team" style="<?php echo $this->_tpl_vars['style_group']; ?>
">
...
" type="hidden">
				<?php endif; ?>
				<td  class="cellLabel" align="right"><b>Staffing</b></td>	
				<td  class="cellInfo" align="left">
					<table cellspacing=0 cellpadding=3 width=95% id="team_task" style="<?php echo $this->_tpl_vars['style_staffing']; ?>
">
					<tr>
					<td align="right"><b>Chef d'Equipe</b></td>
						<td align=left>
							<input readonly name="chefequipe" id="chefequipe" class="small" type="text" value='<?php echo $this->_tpl_vars['ACTIVITYDATA']['chefequipe']; ?>
'>
							&nbsp;<input  type="button" class="small" value='Choisir' name=btn1 LANGUAGE=javascript onclick='return window.open("index.php?module=Users&action=Popup&form=UsersEditView&form_submit=false&fldname=chefequipe","test","width=640,height=603,resizable=0,scrollbars=0");'>
							&nbsp;<input type="image" src="<?php echo vtiger_imageurl('clear_field.gif', $this->_tpl_vars['THEME']); ?>
" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.chefequipe.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
						</td>
						<td align="right"><b>Coordonnateur</b></td>
						<td align=left nowrap>
							<input readonly name="coordonnateur" id="coordonnateur" class="small" type="text" value='<?php echo $this->_tpl_vars['ACTIVITYDATA']['coordonnateur']; ?>
'>
							&nbsp;<input  type="button" class="small" value='Choisir' name=btn1 LANGUAGE=javascript onclick='return window.open("index.php?module=Users&action=Popup&form=UsersEditView&form_submit=false&fldname=coordonnateur","test","width=640,height=603,resizable=0,scrollbars=0");'>
							&nbsp;<input type="image" src="<?php echo vtiger_imageurl('clear_field.gif', $this->_tpl_vars['THEME']); ?>
" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.coordonnateur.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
						</td>
					</tr>
					<tr>
						<td align="right"><b>Consultant1</b></td>
						<td align=left nowrap>
							<input readonly name="consultant1" id="consultant1" class="small" type="text" value='<?php echo $this->_tpl_vars['ACTIVITYDATA']['consultant1']; ?>
'>
							&nbsp;<input  type="button" class="small" value='Choisir' name=btn1 LANGUAGE=javascript onclick='return window.open("index.php?module=Users&action=Popup&form=UsersEditView&form_submit=false&fldname=consultant1","test","width=640,height=603,resizable=0,scrollbars=0");'>
							&nbsp;<input type="image" src="<?php echo vtiger_imageurl('clear_field.gif', $this->_tpl_vars['THEME']); ?>
" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.consultant1.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
						</td>
						<td align="right"><b>Consultant2</b></td>
						<td align=left nowrap>
							<input readonly name="consultant2" id="consultant2" class="small" type="text" value='<?php echo $this->_tpl_vars['ACTIVITYDATA']['consultant2']; ?>
'>
							&nbsp;<input  type="button" class="small" value='Choisir' name=btn1 LANGUAGE=javascript onclick='return window.open("index.php?module=Users&action=Popup&form=UsersEditView&form_submit=false&fldname=consultant2","test","width=640,height=603,resizable=0,scrollbars=0");'>
							&nbsp;<input type="image" src="<?php echo vtiger_imageurl('clear_field.gif', $this->_tpl_vars['THEME']); ?>
" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.consultant2.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
						</td>
					</tr>	
					<tr>
						<td align="right"><b>Assistant1</b></td>
						<td align=left nowrap>
							<input readonly name="assistant1" id="assistant1" class="small" type="text" value='<?php echo $this->_tpl_vars['ACTIVITYDATA']['assistant1']; ?>
'>
							&nbsp;<input  type="button" class="small" value='Choisir' name=btn1 LANGUAGE=javascript onclick='return window.open("index.php?module=Users&action=Popup&form=UsersEditView&form_submit=false&fldname=assistant1","test","width=640,height=603,resizable=0,scrollbars=0");'>
							&nbsp;<input type="image" src="<?php echo vtiger_imageurl('clear_field.gif', $this->_tpl_vars['THEME']); ?>
" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.assistant1.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
						</td>
						<td align="right"><b>Assistant2</b></td>
						<td align=left nowrap>
							<input readonly name="assistant2" id="assistant2" class="small" type="text" value='<?php echo $this->_tpl_vars['ACTIVITYDATA']['assistant2']; ?>
'>
							&nbsp;<input  type="button" class="small" value='Choisir' name=btn1 LANGUAGE=javascript onclick='return window.open("index.php?module=Users&action=Popup&form=UsersEditView&form_submit=false&fldname=assistant2","test","width=640,height=603,resizable=0,scrollbars=0");'>
							&nbsp;<input type="image" src="<?php echo vtiger_imageurl('clear_field.gif', $this->_tpl_vars['THEME']); ?>
" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.assistant2.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
						</td>
					</tr>	
				</table>
			</td>
	...
	<tr>
		<td class="cellLabel" align="right"><b><?php echo $this->_tpl_vars['MOD']['LBL_TODODATETIME']; ?>
</b></td>
		<td class="cellInfo" align="left">
			<table>
				<tr><td><?php echo $this->_tpl_vars['STARTHOUR']; ?>
</td></tr>
				<tr><td class="cellInfo" align="left">
					<?php $_from = $this->_tpl_vars['ACTIVITYDATA']['date_start']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['date_value'] => $this->_tpl_vars['time_value']):
?>
	                	<?php $this->assign('date_val', ($this->_tpl_vars['date_value'])); ?>
...
", showsTime : false, button : "jscal_trigger_date_start", singleClick : true, step : 1
		...
		<td class="cellLabel" align="right"><b><?php echo $this->_tpl_vars['LABEL']['due_date']; ?>
</b></td>
		<td class="cellInfo" align="left">
			<?php $_from = $this->_tpl_vars['ACTIVITYDATA']['due_date']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['date_value'] => $this->_tpl_vars['time_value']):
...
unset($_smarty_tpl_vars);
 ?>
		...
		<table align="center" border="0" cellpadding="0" cellspacing="0" width="95%" bgcolor="#FFFFFF">
			...
			<tr>
				<td style="padding:10px;" class="cellInfo" align="left"  width="100%">
           		...
           		<table width="100%" cellpadding="5" cellspacing="0" border="0">
					<?php if ($this->_tpl_vars['LABEL']['parent_id'] != ''): ?>
                	    <tr>
                            ...
                            <td>
								<input name="task_parent_id" type="hidden" value="<?php echo $this->_tpl_vars['secondvalue']['parent_id']; ?>
">
								<input name="del_actparent_rel" type="hidden" >
                                <select name="task_parent_type" class="small" id="task_parent_type" onChange="document.EditView.task_parent_name.value='';document.EditView.task_parent_id.value=''">
									<?php unset($this->_sections['combo']);
$this->_sections['combo']['name'] = 'combo';
$this->_sections['combo']['loop'] = is_array($_loop=$this->_tpl_vars['LABEL']['parent_id']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['combo']['show'] = true;
...
><?php echo $this->_tpl_vars['LABEL']['parent_id'][$this->_sections['combo']['index']]; ?>
							 ...
							 <td>
								<div id="taskrelatedto" align="left">
									<input name="task_parent_name" readonly type="text" class="calTxt small" value="<?php echo $this->_tpl_vars['ACTIVITYDATA']['parent_id']; ?>
">
									<input type="button" name="selectparent" class="crmButton small edit" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT']; ?>
" onclick="return window.open('index.php?module='+document.EditView.task_parent_type.value+'&action=Popup&maintab=Calendar','test','width=640,height=602,resizable=0,scrollbars=0,top=150,left=200');">
									<input type='button' value='del' class="crmButton small edit" onclick="document.EditView.del_actparent_rel.value=document.EditView.task_parent_id.value;document.EditView.parent_id.value='';document.EditView.task_parent_name.value='';">
								 </div>
							</td>
						</tr>
					<?php endif; ?>
