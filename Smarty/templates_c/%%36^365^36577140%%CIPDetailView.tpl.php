<?php /* Smarty version 2.6.18, created on 2018-11-21 21:48:17
         compiled from CIPDetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'CIPDetailView.tpl', 204, false),array('modifier', 'replace', 'CIPDetailView.tpl', 793, false),array('modifier', 'number_format', 'CIPDetailView.tpl', 977, false),array('modifier', 'count', 'CIPDetailView.tpl', 1126, false),array('modifier', 'getTranslatedString', 'CIPDetailView.tpl', 1286, false),)), $this); ?>
...
&nbsp;">&nbsp;
							<?php if ($this->_tpl_vars['STATUT'] == 'open'): ?>
								<input 
									title="<?php echo $this->_tpl_vars['MOD']['LBL_SOUMETTRECC_BUTTON_LABEL']; ?>
" 
									class="crmbutton small edit" 
									onclick="this.form.return_module.value='Demandes'; 
										this.form.return_action.value='DetailView'; 
...
&nbsp;">&nbsp;
						...
						<?php endif; ?>	
											<?php if (( $this->_tpl_vars['CURRENT_USER_PROFIL'] == '22' || $this->_tpl_vars['CURRENT_USER_PROFIL'] == '20' || $this->_tpl_vars['IS_INTERIMDIRCAB'] == '1' ) && $this->_tpl_vars['STATUT'] == 'sup_submitted'): ?> 						<input 
...
&nbsp;">&nbsp;
					...
					<?php if (( $this->_tpl_vars['IS_DIRCABPCOM'] == '1' || $this->_tpl_vars['IS_INTERIMDIRCABPCOM'] == '1' ) && ( $this->_tpl_vars['STATUT'] == 'dcpc_submitted' )): ?> 
						<input 
...
&nbsp;">&nbsp;
					...
					<?php if (( $this->_tpl_vars['CURRENT_USER_PROFIL'] == '27' || $this->_tpl_vars['CURRENT_USER_PROFIL'] == '20' || $this->_tpl_vars['IS_INTERIMRUMV'] == '1' ) && ( $this->_tpl_vars['STATUT'] == 'rumv_accepted' )): ?>								<input 
...
">Retour à la demande</a> ]
		...
		<?php if ($this->_tpl_vars['MODULE'] == 'Demandes'): ?>
			<?php if ($this->_tpl_vars['STATUT'] == 'open'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('open_cip.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>	
			<?php if ($this->_tpl_vars['STATUT'] == 'ag_cancelled' || $this->_tpl_vars['STATUT'] == 'ch_cancelled'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('ag_cancelled_cip.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
			<?php if ($this->_tpl_vars['STATUT'] == 'sup_submitted'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('submitted_cip.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
			<?php if ($this->_tpl_vars['STATUT'] == 'signed'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('signed_cip.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>	
			<?php if ($this->_tpl_vars['STATUT'] == 'authorized'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('authorized_cip.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
			
			
			<?php if ($this->_tpl_vars['STATUT'] == 'umv_denied'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('umv_denied_cip.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
			
			<?php if ($this->_tpl_vars['STATUT'] == 'umv_accepted'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('umv_accepted_cip.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
			<?php endif; ?>
			<?php if ($this->_tpl_vars['STATUT'] == 'omgenered'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('omgenered_cip.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
