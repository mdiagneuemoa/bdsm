<?php /* Smarty version 2.6.18, created on 2018-01-03 17:21:14
         compiled from Buttons_List1.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'Buttons_List1.tpl', 53, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['MODULELABEL']; ?>
	...
	<?php elseif ($this->_tpl_vars['MODULE'] == 'TraitementConventions' || $this->_tpl_vars['RIGHT_LABEL'] == 'TraitementConventions'): ?>
...
"><?php echo $this->_tpl_vars['APP']['TraitementConventions']; ?>
	...
	<?php elseif ($this->_tpl_vars['MODULE'] == 'SuiviConventions'): ?>
		<td style="padding-left:10px;padding-right:50px" class="moduleName" nowrap><?php echo $this->_tpl_vars['APP'][$this->_tpl_vars['CATEGORY']]; ?>
...
"><?php echo $this->_tpl_vars['APP']['SuiviConventions']; ?>
	...
	<?php elseif ($this->_tpl_vars['MODULE'] == 'ExecutionConventions'): ?>
		<td style="padding-left:10px;padding-right:50px" class="moduleName" nowrap><?php echo $this->_tpl_vars['APP'][$this->_tpl_vars['CATEGORY']]; ?>
...
"><?php echo $this->_tpl_vars['APP']['ExecutionConventions']; ?>
	...
	<?php else: ?>
		<?php if ($this->_tpl_vars['MODULE'] == 'StatisticsDemandes' || $this->_tpl_vars['MODULE'] == 'StatisticsIncidents'): ?>
			<td style="padding-left:10px;padding-right:50px" class="moduleName" nowrap><?php echo $this->_tpl_vars['APP'][$this->_tpl_vars['CATEGORY']]; ?>
...
..." title="<?php echo $this->_tpl_vars['APP']['LBL_CREATE_BUTTON_LABEL']; ?>
 <?php echo $this->_tpl_vars['SINGLE_MOD']; ?>
..." border=0></a></td>
								 	<?php elseif ($this->_tpl_vars['MODULE'] == 'ReportingConventions' || $this->_tpl_vars['MODULE'] == 'TraitementConventions' || $this->_tpl_vars['MODULE'] == 'ExecutionConventions' || $this->_tpl_vars['MODULE'] == 'SuiviConventions' || $this->_tpl_vars['MODULE'] == 'SBConventions'): ?>
										<td style="padding-right:0px;padding-left:10px;"><img src="<?php echo vtiger_imageurl('btnL3Add-Faded.gif', $this->_tpl_vars['THEME']); ?>
" border=0></td>	
                	   			 	<?php else: ?>
                        		       	                	   			 <?php endif; ?>
			              	...
			              	<?php endif; ?>
					<?php elseif ($this->_tpl_vars['MODULE'] == 'TraitementDemandes' || $this->_tpl_vars['MODULE'] == 'TraitementIncidents' || $this->_tpl_vars['MODULE'] == 'TraitementConventions' || $this->_tpl_vars['MODULE'] == 'SBConventions'): ?>
						<td style="padding-right:0px;padding-left:10px;"><img src="<?php echo vtiger_imageurl('btnL3Add-Faded.gif', $this->_tpl_vars['THEME']); ?>
" border=0></td>	
					<?php else: ?>
						<td style="padding-right:0px;padding-left:10px;"><img src="<?php echo vtiger_imageurl('btnL3Add-Faded.gif', $this->_tpl_vars['THEME']); ?>
...
" border=0></td>
						<?php if ($this->_tpl_vars['CATEGORY'] == 'Analytics'): ?>
...
" border=0 onClick="fnvshobj(this,'tracker');">
		...
		<td class="small">
			...
			<?php if ($this->_tpl_vars['MODULE'] == 'Vendors' || $this->_tpl_vars['MODULE'] == 'HelpDesk' || $this->_tpl_vars['MODULE'] == 'Contacts' || $this->_tpl_vars['MODULE'] == 'Leads' || $this->_tpl_vars['MODULE'] == 'Accounts' || $this->_tpl_vars['MODULE'] == 'Potentials' || $this->_tpl_vars['MODULE'] == 'Products' || $this->_tpl_vars['CUSTOM_MODULE'] == 'true'): ?>
		   		<?php if ($this->_tpl_vars['CHECK']['Import'] == 'yes'): ?>	
					<td style="padding-right:0px;padding-left:10px;"><a href="index.php?module=<?php echo $this->_tpl_vars['MODULE']; ?>
