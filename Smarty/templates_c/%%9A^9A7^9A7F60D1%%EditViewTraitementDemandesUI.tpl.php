<?php /* Smarty version 2.6.18, created on 2017-12-07 15:11:51
         compiled from EditViewTraitementDemandesUI.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'EditViewTraitementDemandesUI.tpl', 34, false),array('modifier', 'substr', 'EditViewTraitementDemandesUI.tpl', 564, false),array('function', 'html_options', 'EditViewTraitementDemandesUI.tpl', 211, false),)), $this); ?>
		...
		<?php if ($this->_tpl_vars['typeofdata'] == 'O'): ?>
...
_mass_edit_check" class="small"><?php endif; ?>
			...
			<?php if ($this->_tpl_vars['fldname'] == 'ticket' && $this->_tpl_vars['MODULE'] == 'Demandes' && $this->_tpl_vars['OP_MODE'] == 'create_view'): ?>
				<td width=30% align=left class="dvtCellInfo">
...
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
			...
			<?php elseif ($this->_tpl_vars['fldname'] == 'ticket' && $this->_tpl_vars['MODULE'] == 'Demandes' && $this->_tpl_vars['OP_MODE'] == 'edit_view'): ?>
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="<?php echo $this->_tpl_vars['fldname']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
...
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
			...
			<?php elseif ($this->_tpl_vars['fldname'] == 'user' && $this->_tpl_vars['MODULE'] == 'TraitementDemandes' && $this->_tpl_vars['OP_MODE'] == 'create_view'): ?>
				<td width=30% align=left class="dvtCellInfo">
...
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
			...
			<?php elseif ($this->_tpl_vars['fldname'] == 'user' && $this->_tpl_vars['MODULE'] == 'TraitementDemandes' && $this->_tpl_vars['OP_MODE'] == 'edit_view'): ?>
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="vue" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" readonly="true" value="<?php echo $this->_tpl_vars['USER']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
...
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
				...
				<?php elseif ($this->_tpl_vars['fldname'] == 'nom' && $this->_tpl_vars['MODULE'] == 'TraitementDemandes' && $this->_tpl_vars['OP_MODE'] == 'create_view'): ?>
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="<?php echo $this->_tpl_vars['fldname']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" readonly="true" value="<?php echo $this->_tpl_vars['NOMAGENT']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
				</td> 
				<?php elseif ($this->_tpl_vars['fldname'] == 'matricule' && $this->_tpl_vars['MODULE'] == 'TraitementDemandes' && $this->_tpl_vars['OP_MODE'] == 'create_view'): ?>
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="<?php echo $this->_tpl_vars['fldname']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" readonly="true" value="<?php echo $this->_tpl_vars['NOMAGENT']; ?>
...
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
				...
				<?php elseif ($this->_tpl_vars['fldname'] == 'service' && $this->_tpl_vars['MODULE'] == 'TraitementDemandes' && $this->_tpl_vars['OP_MODE'] == 'create_view'): ?>
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="<?php echo $this->_tpl_vars['fldname']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" readonly="true" value="<?php echo $this->_tpl_vars['SERVICEAGENT']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
				</td> 
				<?php elseif ($this->_tpl_vars['fldname'] == 'fonction' && $this->_tpl_vars['MODULE'] == 'TraitementDemandes' && $this->_tpl_vars['OP_MODE'] == 'create_view'): ?>
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="<?php echo $this->_tpl_vars['fldname']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" readonly="true" value="<?php echo $this->_tpl_vars['FONCTIONAGENT']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
				</td> 
...
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
			...
			<?php elseif ($this->_tpl_vars['fldname'] == 'datemodification' && $this->_tpl_vars['MODULE'] == 'TraitementDemandes'): ?>
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="<?php echo $this->_tpl_vars['fldname']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
...
_mass_edit_check" class="small" ><?php endif; ?>
			...
			<?php if ($this->_tpl_vars['fldname'] == 'motif'): ?>
					<select name="<?php echo $this->_tpl_vars['fldname']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" class="small" style="width:260px;">
