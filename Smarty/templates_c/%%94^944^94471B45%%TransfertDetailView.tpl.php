<?php /* Smarty version 2.6.18, created on 2019-04-22 12:04:35
         compiled from TransfertDetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'TransfertDetailView.tpl', 204, false),array('modifier', 'number_format', 'TransfertDetailView.tpl', 512, false),array('modifier', 'replace', 'TransfertDetailView.tpl', 582, false),array('function', 'html_options', 'TransfertDetailView.tpl', 697, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['MOD']['LBL_ENGAGEMENT_BUTTON_LABEL']; ?>
					...
					<?php if (( $this->_tpl_vars['IS_POSTEURDEMANDE'] == '1' || $this->_tpl_vars['CURRENT_USER_PROFIL'] == '20' ) && ( $this->_tpl_vars['STATUT'] != 'mt_cancelled' || $this->_tpl_vars['STATUT'] != 'cancelled' )): ?>
						...
						<input 
										title="<?php echo $this->_tpl_vars['MOD']['LBL_CANCELTRANSFERT_BUTTON_LABEL']; ?>
" 
										...
										type="submit" 
										name="Edit" 
										value="&nbsp;<?php echo $this->_tpl_vars['MOD']['LBL_CANCELTRANSFERT_BUTTON_LABEL']; ?>
&nbsp;">&nbsp;
...
&nbsp;">&nbsp;
						...
						<?php if ($this->_tpl_vars['IS_DEMANDEVALIDE']['bool'] == '1'): ?>
...
&nbsp;">&nbsp;
		...
		<?php if ($this->_tpl_vars['MODULE'] == 'Transfert'): ?>
			<?php if ($this->_tpl_vars['STATUT'] == 'open'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('open_transfert.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
				
			<?php if ($this->_tpl_vars['STATUT'] == 'submitted'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('submitted_transfert.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>				
			<?php endif; ?>	
			<?php if ($this->_tpl_vars['STATUT'] == 'dc_accepted'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('dc_accepted_transfert.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
			<?php if ($this->_tpl_vars['STATUT'] == 'dc_cancelled' || $this->_tpl_vars['STATUT'] == 'dc_denied'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('dc_denied_transfert.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
			<?php if ($this->_tpl_vars['STATUT'] == 'db_accepted'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('db_accepted_transfert.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
			
			<?php if ($this->_tpl_vars['STATUT'] == 'db_denied'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('db_denied_transfert.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
			
						
			<?php if ($this->_tpl_vars['STATUT'] == 'com_cancelled' || $this->_tpl_vars['STATUT'] == 'com_denied'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('com_denied_transfert.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
...
"></td></tr>
		...
		<?php if ($this->_tpl_vars['IS_DEMANDEVALIDE']['bool'] == '0'): ?>
			<!-- Demande de transfert nécessaire sur certains comptes natures -->
			<tr><td align=center><font color='red'><b><?php echo $this->_tpl_vars['IS_DEMANDEVALIDE']['msg']; ?>
</b></font></td></tr>
		<?php endif; ?>
                <tr>
...
" class="traitementbut" onclick="this.form.action.value='SaveTraitement';" type="submit" " name="button" value="Enregistrer Livraison" >
    ...
    foreach ($_from as $this->_tpl_vars['index'] => $this->_tpl_vars['linedeb']):
?>

																				<tr bgcolor=white class=lvtColDataHover>
																					<td align=center><?php echo $this->_tpl_vars['linedeb']['typebudget']; ?>
</td>
																					<td nowrap align=center><?php echo $this->_tpl_vars['linedeb']['sourcefinlib']; ?>
</td>
																					<td width=400><?php echo $this->_tpl_vars['linedeb']['codebudget']; ?>
 : <br><?php echo $this->_tpl_vars['linedeb']['libactivite']; ?>
</td>
																					<td align=center><?php echo $this->_tpl_vars['linedeb']['comptenat']; ?>
</td>
																					<td align=right>
																					<?php if ($this->_tpl_vars['linedeb']['montant'] > $this->_tpl_vars['linedeb']['mntdispo']): ?>
																						<font color='red'><b><?php echo ((is_array($_tmp=$this->_tpl_vars['linedeb']['montant'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ",", ' ') : number_format($_tmp, 0, ",", ' ')); ?>
</b></font>
																					<?php else: ?>
																						<b><?php echo ((is_array($_tmp=$this->_tpl_vars['linedeb']['montant'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ",", ' ') : number_format($_tmp, 0, ",", ' ')); ?>
</b>
																					<?php endif; ?>
																					<br><span style="font-family: Arial, Helvetica, sans-serif;font-weight:bold;font-size: 11px;color:gray;">
																						Dispo :<?php echo ((is_array($_tmp=$this->_tpl_vars['linedeb']['mntdispo'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ",", ' ') : number_format($_tmp, 0, ",", ' ')); ?>
</span>
																					</td>
																				</tr>
																				<?php $this->assign('totaldeptransfert', $this->_tpl_vars['totaldeptransfert']+$this->_tpl_vars['linedeb']['montant']); ?>
																			<?php endforeach; endif; unset($_from); ?>
																			
																			<tr>
																				<td colspan=4 align=right><b>TOTAL D&Eacute;BIT :</b></td>
																				<td align=right><b><?php echo ((is_array($_tmp=$this->_tpl_vars['totaldeptransfert'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ",", ' ') : number_format($_tmp, 0, ",", ' ')); ?>
</b></td>
																			</tr>
																			</table>
    ...
    foreach ($_from as $this->_tpl_vars['index'] => $this->_tpl_vars['linecred']):
?>
																				<tr bgcolor=white class=lvtColDataHover>
																					<td align=center><?php echo $this->_tpl_vars['linecred']['typebudget']; ?>
</td>
																					<td nowrap align=center><?php echo $this->_tpl_vars['linecred']['sourcefinlib']; ?>
</td>
																					<td width=400><?php echo $this->_tpl_vars['linecred']['codebudget']; ?>
 : <br><?php echo $this->_tpl_vars['linecred']['libactivite']; ?>
</td>
																					<td align=center><?php echo $this->_tpl_vars['linecred']['comptenat']; ?>
</td>
																					<td align=right>
																						<b><?php echo ((is_array($_tmp=$this->_tpl_vars['linecred']['montant'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ",", ' ') : number_format($_tmp, 0, ",", ' ')); ?>
</b>
																						<br><span style="font-family: Arial, Helvetica, sans-serif;font-weight:bold;font-size: 10px;color:gray;">Dispo :<?php echo ((is_array($_tmp=$this->_tpl_vars['linedeb']['mntdispo'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ",", ' ') : number_format($_tmp, 0, ",", ' ')); ?>
</span>
																						</td>
																				</tr>
																			...
																			<tr>
																				...
																				<td align=right><b><?php echo ((is_array($_tmp=$this->_tpl_vars['totalcredtransfert'])) ? $this->_run_mod_handler('number_format', true, $_tmp, 0, ",", ' ') : number_format($_tmp, 0, ",", ' ')); ?>
</b></td>
																			</tr>
																			</table>
																	</table>
...
" style="<?php echo $this->_tpl_vars['DISPLAY_COORDBANK2']; ?>
 height:25px">	
								...
								<?php elseif ($this->_tpl_vars['header'] == $this->_tpl_vars['MOD']['LBL_TRANSFERT_DEBITCREDIT'] && $this->_tpl_vars['MODULE'] == 'Transfert'): ?>
...
?>
 ...
 (<?php echo $this->_tpl_vars['ligne']['comptenat']; ?>
			...
			<?php if ($this->_tpl_vars['MODULE'] == 'Transfert'): ?>
					<tr><td>&nbsp;</td></tr>
					<tr><td class="small"><b><u>Inititeur Transfert</u> : <?php echo $this->_tpl_vars['POSTEURDEMANDE']; ?>
<b></td></tr>	
				<?php endif; ?>										
		<tr>           
...
unset($_smarty_tpl_vars);
 ?>
			...
			-->
 				...
 				<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'ListViewTraitementTransfert.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
