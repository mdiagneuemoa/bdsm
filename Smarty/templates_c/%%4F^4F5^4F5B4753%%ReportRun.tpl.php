...
');">
	...
	<td style="border-left: 2px dotted rgb(109, 109, 109); padding: 10px;" width="30%">
		<span class="fontMarron"><?php echo $this->_tpl_vars['MOD']['LBL_SELECT_ANOTHER_REPORT']; ?>
 : </span><br>
...
<table class="small reportGenerateTable" align="center" cellpadding="5" cellspacing="0" width="100%" border=0>
<tr>
	...
	<table border=0 cellspacing=0 cellpadding=0 width=100%>
		<tr>
			...
			-->
			<td align=left class=small><b><?php echo $this->_tpl_vars['MOD']['LBL_SELECT_GROUPE']; ?>
 </b></td><td class=small>&nbsp;</td>
			<td align=left class=small><b><?php echo $this->_tpl_vars['MOD']['LBL_SELECT_TYPOLOGIE']; ?>
 </b></td><td class=small>&nbsp;</td>
			<td align=center class=small><b> Periode </b></td><td class=small>&nbsp;</td>
