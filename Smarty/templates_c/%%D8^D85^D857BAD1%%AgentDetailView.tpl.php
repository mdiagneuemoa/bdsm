<?php /* Smarty version 2.6.18, created on 2018-11-02 10:04:54
         compiled from AgentDetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'AgentDetailView.tpl', 204, false),array('modifier', 'replace', 'AgentDetailView.tpl', 791, false),array('modifier', 'number_format', 'AgentDetailView.tpl', 979, false),array('modifier', 'count', 'AgentDetailView.tpl', 1128, false),array('modifier', 'getTranslatedString', 'AgentDetailView.tpl', 1288, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ...
 <?php echo $this->_tpl_vars['APP']['LBL_INFORMATION']; ?>
					...
					<?php if ($this->_tpl_vars['MODULE'] == 'Demandes'): ?>
						...
						<?php if (( $this->_tpl_vars['IS_CHARGEMISSIONDEMANDE'] == '1' ) && ( $this->_tpl_vars['STATUT'] == 'submitted' && ( $this->_tpl_vars['STATUT'] != 'om_cancelled' || $this->_tpl_vars['STATUT'] != 'ag_cancelled' ) )): ?>
...
&nbsp;">&nbsp;
						<?php endif; ?>
						<?php if (( $this->_tpl_vars['IS_POSTEURDEMANDE'] == '1' || $this->_tpl_vars['CURRENT_USER_PROFIL'] == '20' ) && ( $this->_tpl_vars['STATUT'] != 'om_cancelled' || $this->_tpl_vars['STATUT'] != 'ag_cancelled' || $this->_tpl_vars['STATUT'] != 'ch_cancelled' || $this->_tpl_vars['STATUT'] != 'ch_cancelled' )): ?>
							<input 
...
&nbsp;">&nbsp;
							...
							<?php if ($this->_tpl_vars['STATUT'] == 'dcpc_submitted' || $this->_tpl_vars['STATUT'] == 'dc_submitted' || $this->_tpl_vars['STATUT'] == 'dc_denied' || $this->_tpl_vars['STATUT'] == 'dc_authorized'): ?>
...
" class="crmbutton small edit" 
											onclick="this.form.return_module.value='Demandes'; 
													...
													this.form.dmd.value='<?php echo $this->_tpl_vars['ID']; ?>
'; 
													return soumettreDemandeDCPC('Demandes');"   
											type="submit"  
											name="Edit" 
...
&nbsp;">&nbsp;
								<?php else: ?>
									...
									<input 
										title="<?php echo $this->_tpl_vars['MOD']['LBL_DC_SOUMETTRE_BUTTON_LABEL']; ?>
" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
											this.form.return_action.value='DetailView'; 
...
'; 
									...
									type="submit"  
									name="Edit" 
									value="&nbsp;<?php echo $this->_tpl_vars['MOD']['LBL_DC_SOUMETTRE_BUTTON_LABEL']; ?>
&nbsp;">&nbsp;
							<?php endif; ?>				
...
&nbsp;">&nbsp;
					...
					<?php if (( $this->_tpl_vars['CURRENT_USER_PROFIL'] == '22' || $this->_tpl_vars['IS_INTERIMDIRCAB'] == '1' ) && ( $this->_tpl_vars['IS_DIRCABPCOM'] != '1' ) && $this->_tpl_vars['STATUT'] == 'dc_submitted'): ?> 						<input 
...
&nbsp;">&nbsp;
					...
					<?php if (( $this->_tpl_vars['IS_DIRCABPCOM'] == '1' || $this->_tpl_vars['IS_INTERIMDIRCABPCOM'] == '1' ) && $this->_tpl_vars['STATUT'] == 'dcpc_submitted'): ?> 						<input 
										title="<?php echo $this->_tpl_vars['MOD']['LBL_REJET_DC_BUTTON_LABEL']; ?>
" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
...
&nbsp;">&nbsp;
					...
					<?php if (( $this->_tpl_vars['CURRENT_USER_PROFIL'] == '26' || $this->_tpl_vars['CURRENT_USER_PROFIL'] == '20' || $this->_tpl_vars['IS_INTERIMRUMV'] == '1' ) && $this->_tpl_vars['STATUT'] != 'om_cancelled'): ?>  								
							<?php if ($this->_tpl_vars['STATUT'] == 'dc_authorized' || $this->_tpl_vars['STATUT'] == 'authorized'): ?>
								<input 
...
&nbsp;">&nbsp;
							<?php endif; ?>
							<input 
										title="<?php echo $this->_tpl_vars['MOD']['LBL_VISERUMV_DC_BUTTON_LABEL']; ?>
" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
											this.form.return_action.value='DetailView'; 
...
'; 
										...
										type="submit" 
										name="Edit" 
										value="&nbsp;<?php echo $this->_tpl_vars['MOD']['LBL_VISERUMV_DC_BUTTON_LABEL']; ?>
&nbsp;">&nbsp;
							<input title="<?php echo $this->_tpl_vars['APP']['LBL_EDIT_BUTTON_TITLE']; ?>
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_EDIT_BUTTON_KEY']; ?>
" class="crmbutton small edit" onclick="this.form.return_module.value='<?php echo $this->_tpl_vars['MODULE']; ?>
...
&nbsp;">&nbsp;
					...
					<?php if (( $this->_tpl_vars['CURRENT_USER_PROFIL'] == '27' || $this->_tpl_vars['CURRENT_USER_PROFIL'] == '20' || $this->_tpl_vars['IS_INTERIMRUMV'] == '1' ) && ( $this->_tpl_vars['STATUT'] == 'rumv_accepted' || $this->_tpl_vars['STATUT'] == 'authorized' )): ?>								<input 
...
&nbsp;">&nbsp;
					...
					<?php endif; ?>
					<?php if (( $this->_tpl_vars['CURRENT_USER_PROFIL'] == '20' ) && $this->_tpl_vars['STATUT'] == 'omgenered'): ?>									<input title="<?php echo $this->_tpl_vars['APP']['LBL_EDIT_BUTTON_TITLE']; ?>
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_EDIT_BUTTON_KEY']; ?>
" class="crmbutton small edit" onclick="this.form.return_module.value='<?php echo $this->_tpl_vars['MODULE']; ?>
'; this.form.return_action.value='DetailView'; this.form.return_id.value='<?php echo $this->_tpl_vars['ID']; ?>
';this.form.module.value='<?php echo $this->_tpl_vars['MODULE']; ?>
...
">Retour à la demande</a> ]
		...
		<?php if ($this->_tpl_vars['MODULE'] == 'Demandes'): ?>
			<?php if ($this->_tpl_vars['STATUT'] == 'open'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('open_agdepart.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>	
			<?php if ($this->_tpl_vars['STATUT'] == 'ag_cancelled' || $this->_tpl_vars['STATUT'] == 'ch_cancelled'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('cancelled_agdepart.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
			<?php if ($this->_tpl_vars['STATUT'] == 'dc_submitted' || $this->_tpl_vars['STATUT'] == 'dcpc_submitted'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('dc_submitted_agdepart.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
				
			<?php if ($this->_tpl_vars['STATUT'] == 'dc_authorized'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('dc_authorized_agdepart.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
			
			<?php if ($this->_tpl_vars['STATUT'] == 'dc_cancelled' || $this->_tpl_vars['STATUT'] == 'dc_denied'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('dc_denied_agdepart.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
						
			<?php if ($this->_tpl_vars['STATUT'] == 'umv_denied'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('umv_denied_agdepart.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
			
			<?php if ($this->_tpl_vars['STATUT'] == 'rumv_accepted' || $this->_tpl_vars['STATUT'] == 'umv_accepted'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('umv_accepted_agdepart.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
			<?php endif; ?>
