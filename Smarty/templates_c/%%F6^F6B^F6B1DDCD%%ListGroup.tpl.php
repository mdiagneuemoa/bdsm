<?php /* Smarty version 2.6.18, created on 2010-02-26 17:51:11
...
" border="0" align="absmiddle"></a> -->
								<a onClick="return confirm('<?php echo $this->_tpl_vars['CMOD']['CONFIRMATION_SUPPRESSION_UTILISATEUR']; ?>
');" href="index.php?module=Users&action=DeleteGroup&returnaction=listgroups&parenttab=Settings&delete_group_id=<?php echo $this->_tpl_vars['groupvalues']['groupid']; ?>
"><img src="<?php echo vtiger_imageurl('delete.gif', $this->_tpl_vars['THEME']); ?>
" alt="<?php echo $this->_tpl_vars['LNK_DELETE']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LNK_DELETE']; ?>
" border="0" align="absmiddle"></a>
