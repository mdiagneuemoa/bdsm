<?php /* Smarty version 2.6.18, created on 2010-04-19 13:22:15
         compiled from GroupEditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'GroupEditView.tpl', 180, false),)), $this); ?>
...
//					alert(response.responseText);
					alert('<?php echo $this->_tpl_vars['MOD']['GROUPE_EXISTANT']; ?>
');
			}
		}
		);
...
function constructSelectOptions(selectedMemberType,idArr,nameArr)
{
	...
	for(j=0;j<constructedOptionName.length;j++)
	{
		...
		{
			nowNamePrefix = 'RoleEtSubordonnés::'
		}
		else if(selectedMemberType == 'groups')
		{
			nowNamePrefix = 'Equipe::'
		}
		else if(selectedMemberType == 'users')
		{
			nowNamePrefix = 'Collaborateur::'
		}
...
function validate()
{
	...
	if( !emptyCheck( "groupName", "Group Name","text" ) )
		return false;
   	var supName = document.getElementById('superieurH').value;
	if(document.getElementById('supId').value == 0 || supName.length == 0)
    {
    	alert('<?php echo $this->_tpl_vars['MOD']['SUPERIEUR_H_REQUIRED']; ?>
');
		return false;
    }
    
    var coordName = document.getElementById('coordonnateur').value;
	if(document.getElementById('coordId').value == 0 || coordName.length == 0)
    {
   	alert('<?php echo $this->_tpl_vars['MOD']['COORDONATEUR_REQUIRED']; ?>
');
		return false;
    }
...
" onClick="window.history.back()">
					...
					<table width="100%"  border="0" cellspacing="0" cellpadding="5">
                      				<tr class="small">
							<td width="15%" class="small cellLabel"><?php echo $this->_tpl_vars['CMOD']['LBL_GROUP_NAME']; ?>
...
" class="detailedViewTextBox"> </td>
					...
					<!--			
							  	<tr class="small" width="20%">
									<td class="small"></font>
										<strong><?php echo $this->_tpl_vars['CMOD']['LBL_IDENTIFIANT']; ?>
</strong> :&nbsp;
										<input id="identifiant" name="identifiant" type="text" value="<?php echo $this->_tpl_vars['GROUPNAME']; ?>
" size="5">&nbsp;&nbsp;
										<input type="button" class="crmButton small" name="ok" value="  <?php echo $this->_tpl_vars['MOD']['LBL_OK_BUTTON_LABEL']; ?>
  " onClick="return;">
									</td>
								</tr>
...
:&nbsp;
 ...
 <?php echo $this->_tpl_vars['CMOD']['LBL_ENTITY']; ?>
<br>
										<select id="availList" name="availList" multiple size="10" class="small crmFormList2"></select>
										<input type="hidden" name="selectedColumnsString"/>
							
									</td>
									<td width="50">
										<div align="center">
											<input type="button" name="Button2" value="&nbsp;<?php echo $this->_tpl_vars['CMOD']['LBL_N_PLUS_UN']; ?>
&nbsp;" onClick="addSuperieurH()" class="crmButton small"/><br /><br />
											<input type="button" name="Button3" value="&nbsp;<?php echo $this->_tpl_vars['CMOD']['LBL_COORD']; ?>
&nbsp;" onClick="addCoordonnateur()" class="crmButton small"/><br /><br />
										...
										<table>
											...
											<tr>
												<td>
													...
													<strong><?php echo $this->_tpl_vars['CMOD']['LBL_SUPERIEUR_H']; ?>
</strong> <font color="red">*</font> :&nbsp;
												</td>
												<td>
													<input id="superieurH" name="superieurH" value="<?php echo $this->_tpl_vars['TABSUPCOORD']['supName']; ?>
" readonly="true" type="text" size="20" class="small">
...
" LANGUAGE=javascript onClick="this.form.superieurH.value=''; this.form.supId.value='';return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>
													<input type="hidden" id="supId" name="supId" value="<?php echo $this->_tpl_vars['TABSUPCOORD']['supId']; ?>
" class="small">
												</td>
											</tr>
											<tr>
												<td>
													<strong><?php echo $this->_tpl_vars['CMOD']['LBL_COORDONNATEUR']; ?>
</strong> <font color="red">*</font> :&nbsp;
												</td>
												<td>
													<input id="coordonnateur" name="coordonnateur" type="text"  value="<?php echo $this->_tpl_vars['TABSUPCOORD']['coordName']; ?>
" readonly="true" size="20" class="small">
													&nbsp;<input type="image" src="<?php echo vtiger_imageurl('clear_field.gif', $this->_tpl_vars['THEME']); ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" LANGUAGE=javascript onClick="this.form.coordonnateur.value=''; this.form.coordId.value='';return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>
													<input type="hidden" id="coordId" name="coordId"  value="<?php echo $this->_tpl_vars['TABSUPCOORD']['coordId']; ?>
" class="small">&nbsp;
												</td>
											</tr>
										</table>
								...
								<tr>
									<td colspan=3>
										<ul class=small>
											...
											<li><?php echo $this->_tpl_vars['CMOD']['LBL_GROUP_MESG4']; ?>
</li>
											<li><?php echo $this->_tpl_vars['CMOD']['LBL_GROUP_MESG5']; ?>
</li>
...
function addSuperieurH() 
        {
            ...
            for (i=0;i<availListObj.length;i++) 
            {
               ...
               //         newColObj.value=availListObj.options[i].value
                        if (browser_ie) 
                        document.getElementById('superieurH').value=availListObj.options[i].innerText
                        else if (browser_nn4 || browser_nn6) 
                        document.getElementById('superieurH').value=availListObj.options[i].text
             //           selectedColumnsObj.appendChild(newColObj)
             
             			document.getElementById('supId').value=availListObj.options[i].value
...
function addCoordonnateur() 
        {
            ...
            for (i=0;i<availListObj.length;i++) 
            {
               ...
               //         newColObj.value=availListObj.options[i].value
                        if (browser_ie) 
                        document.getElementById('coordonnateur').value=availListObj.options[i].innerText
                        else if (browser_nn4 || browser_nn6) 
                        document.getElementById('coordonnateur').value=availListObj.options[i].text
             //           selectedColumnsObj.appendChild(newColObj)
             
             			document.getElementById('coordId').value=availListObj.options[i].value
