<?php /* Smarty version 2.6.18, created on 2018-10-18 12:00:14
         compiled from CJDetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'CJDetailView.tpl', 204, false),array('modifier', 'replace', 'CJDetailView.tpl', 923, false),array('modifier', 'number_format', 'CJDetailView.tpl', 1379, false),array('modifier', 'count', 'CJDetailView.tpl', 1528, false),array('modifier', 'getTranslatedString', 'CJDetailView.tpl', 1688, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ...
 <?php echo $this->_tpl_vars['APP']['LBL_INFORMATION']; ?>
					...
					<td class="dvtTabCache" align="right" style="width:100%">
						...
						<?php if (( $this->_tpl_vars['IS_CHARGEMISSIONDEMANDE'] == '1' ) && ( $this->_tpl_vars['STATUT'] == 'submitted' && $this->_tpl_vars['STATUT'] != 'ag_cancelled' && $this->_tpl_vars['STATUT'] != 'ch_cancelled' )): ?>
...
&nbsp;">&nbsp;
						<?php endif; ?>
						<?php if (( $this->_tpl_vars['IS_POSTEURDEMANDE'] == '1' || $this->_tpl_vars['CURRENT_USER_PROFIL'] == '20' ) && ( $this->_tpl_vars['STATUT'] != 'cancelled' )): ?>
								<input 
...
&nbsp;">&nbsp;
								...
								<?php if ($this->_tpl_vars['STATUT'] == 'open'): ?>
									...
									<input title="<?php echo $this->_tpl_vars['MOD']['LBL_SOUMETTRECJ_BUTTON_LABEL']; ?>
" class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
												this.form.module.value='TraitementDemandes';
...
'; 
										...
										type="submit"  
										name="Edit" 
										value="&nbsp;<?php echo $this->_tpl_vars['MOD']['LBL_SOUMETTRECJ_BUTTON_LABEL']; ?>
&nbsp;">&nbsp;
...
&nbsp;">&nbsp;						
						<?php endif; ?>						
							...
							<?php if ($this->_tpl_vars['STATUT'] == 'sup_submitted' || $this->_tpl_vars['STATUT'] == 'dc_denied' || $this->_tpl_vars['STATUT'] == 'dc_authorized'): ?>
								<input 
...
&nbsp;">&nbsp;
						...
						<?php if (( $this->_tpl_vars['CURRENT_USER_PROFIL'] == '22' || $this->_tpl_vars['IS_INTERIMDIRCAB'] == '1' || $this->_tpl_vars['CURRENT_USER_PROFIL'] == '20' ) && $this->_tpl_vars['STATUT'] == 'sup_submitted'): ?>    								<input 
										title="<?php echo $this->_tpl_vars['MOD']['LBL_ANNULER_CJ_BUTTON_LABEL']; ?>
" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
...
'; 
										...
										type="submit" 
										name="Edit" 
										value="&nbsp;<?php echo $this->_tpl_vars['MOD']['LBL_ANNULER_CJ_BUTTON_LABEL']; ?>
&nbsp;">&nbsp;
										
								<input 
										title="<?php echo $this->_tpl_vars['MOD']['LBL_REJET_CJ_BUTTON_LABEL']; ?>
" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
...
'; 
										...
										type="submit" 
										name="Edit" 
										value="&nbsp;<?php echo $this->_tpl_vars['MOD']['LBL_REJET_CJ_BUTTON_LABEL']; ?>
&nbsp;">&nbsp;
													
										<input 
												title="<?php echo $this->_tpl_vars['MOD']['LBL_VISER_CJ_BUTTON_LABEL']; ?>
" 
												class="crmbutton small edit" 
												onclick="this.form.return_module.value='Demandes'; 
													this.form.return_action.value='DetailView'; 
...
'; 
											...
											type="submit"  
											name="Edit" 
												value="&nbsp;<?php echo $this->_tpl_vars['MOD']['LBL_VISER_CJ_BUTTON_LABEL']; ?>
&nbsp;">&nbsp;							
						<?php endif; ?>	
...
"></td></tr>
			...
			<?php if ($this->_tpl_vars['STATUT'] == 'submitted_cj' || $this->_tpl_vars['STATUT'] == 'sup_submitted'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('submitted_cj.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
			
			<?php if ($this->_tpl_vars['STATUT'] == 'dc_authorized'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('dc_authorized_cj.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
			
			<?php if ($this->_tpl_vars['STATUT'] == 'dc_denied' || $this->_tpl_vars['STATUT'] == 'grcj_cancelled'): ?>
				<tr><td align="left" ><img src="<?php echo vtiger_imageurl('dc_denied_cj.png', $this->_tpl_vars['THEME']); ?>
"></td></tr>
			<?php endif; ?>
...
"></td></tr>
			...
			<?php if ($this->_tpl_vars['STATUT'] == 'rumv_accepted'): ?>
