<?php /* Smarty version 2.6.18, created on 2015-11-29 23:48:32
         compiled from CreateViewTraitementConventions.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'CreateViewTraitementConventions.tpl', 53, false),)), $this); ?>
...
" class="crmbutton small save" onclick="this.form.action.value='Save'; if(!isFormTraitementValide(this.form)) return false; return formValidate();" type="submit"  name="button" value="  <?php echo $this->_tpl_vars['APP']['LBL_VALIDATE_BUTTON_LABEL']; ?>
  " style="width:75px" >
											<input title="<?php echo $this->_tpl_vars['APP']['LBL_REJETER_BUTTON_LABEL']; ?>
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_KEY']; ?>
" class="crmbutton small save" onclick="this.form.action.value='Save'; if(!isFormTraitementValide(this.form)) return false; return formValidate();" type="submit"  name="button" value="  <?php echo $this->_tpl_vars['APP']['LBL_REJETER2_BUTTON_LABEL']; ?>
  " style="width:75px" >
