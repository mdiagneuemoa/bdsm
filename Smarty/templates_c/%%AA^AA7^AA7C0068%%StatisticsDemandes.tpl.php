<?php /* Smarty version 2.6.18, created on 2011-07-15 13:10:54
         compiled from StatisticsDemandes.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'StatisticsDemandes.tpl', 259, false),array('modifier', 'vtiger_imageurl', 'StatisticsDemandes.tpl', 469, false),)), $this); ?>
...
<td width="100%" valign="top" style="padding: 10px;" class="showPanelBg">
 ...
 <table align="center" border="0" cellpadding="5" cellspacing="1" width="100%" valign="top">
		<tr>
			<td>
			<?php if ($this->_tpl_vars['DEMANDES_NB_DECLARES'] != 0): ?>
						...
						<tr>
							<td class=lvtCol colspan=6>
								<table width="100%">
									<tr>
										<td align=left>
										 <?php echo $this->_tpl_vars['MOD']['LBL_STAT_DEMANDES']; ?>
 
										</td>
								 		<td align=right>
								           <?php echo $this->_tpl_vars['MOD']['LBL_TOTAL_DEMANDES']; ?>
 : <?php echo $this->_tpl_vars['DEMANDES_NB_DECLARES']; ?>
						...
						<tr class=lvtColData>
							<td colspan=2 align="center"><b> <?php echo $this->_tpl_vars['MOD']['LBL_ATRAITER_DEMANDES']; ?>
 </b></td>
							<td colspan=4 align="center">
								<table width="100%">
									<tr>
										<td align=left>
										 <b> <?php echo $this->_tpl_vars['MOD']['LBL_TRAITE_DEMANDES']; ?>
 </b>
										</td>
										<?php if ($this->_tpl_vars['TYPOLOGY'] != ''): ?>
								 		<td align=right>
								          <b> <?php echo $this->_tpl_vars['MOD']['LBL_DUREE_MOYENNE_DEMANDES']; ?>
 : <?php echo $this->_tpl_vars['DEMANDES_DUREE_MOYENNE_TRAITEMENT']; ?>
</b>
							            </td>
							            <?php endif; ?>
							         </tr>
						...
						<tr class=lvtColData>
							<td> <?php echo $this->_tpl_vars['MOD']['LBL_NON_SOUFFRANT_DEMANDES']; ?>
 </td>
						...
						<tr class="lvtColData">
							<td align="center"> <?php echo $this->_tpl_vars['DEMANDES_NON_TRAITE']; ?>
 </td>
							<td align="center"> <?php echo $this->_tpl_vars['DEMANDES_NB_EN_SOUFFRANCE']; ?>
 </td>
							<td align="center"> <?php echo $this->_tpl_vars['DEMANDES_NB_TRAITES_DANS_DELAIS']; ?>
 </td>
							<td align="center"> <?php echo $this->_tpl_vars['DEMANDES_NB_TRAITES_AU_DELA_DELAIS']; ?>
 </td>
							<td align="center"> <?php echo $this->_tpl_vars['DEMANDES_NB_ORIGINE_INTERNE']; ?>
 </td>
					        <td align="center"> <?php echo $this->_tpl_vars['DEMANDES_NB_ORIGINE_EXTERNE']; ?>
 </td>
						</tr>
						...
						<tr>
							<td class=lvtCol colspan=4>
								<table width="100%">
									<tr>
										<td align=left>
										 <?php echo $this->_tpl_vars['MOD']['LBL_DEMANDES_TABLEAU']; ?>
 ...
 : <?php echo $this->_tpl_vars['DEMANDES_NB_DECLARES']; ?>
						...
						<tr class=lvtColData>
							<td colspan=2 align="center"><b> <?php echo $this->_tpl_vars['MOD']['LBL_DEMANDES_NON_TRAITES']; ?>
 </b></td>
								...
								<table width="100%">
									<tr>
										<td align=left>
								 		...
								 		<td align=right>
								          <b> <?php echo $this->_tpl_vars['MOD']['LBL_TAUX_DEMANDES']; ?>
 : <?php echo $this->_tpl_vars['DEMANDES_TAUX_TRAITEMENT']; ?>
</b>
							            </td>
							         </tr>
							      </table>
