<?php /* Smarty version 2.6.18, created on 2011-04-13 17:55:30
         compiled from EditViewTraitementIncidentsUI.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'EditViewTraitementIncidentsUI.tpl', 34, false),array('modifier', 'substr', 'EditViewTraitementIncidentsUI.tpl', 585, false),)), $this); ?>
		...
		<?php else: ?>
			<?php $this->assign('mandatory_field', "(f)"); ?>
		<?php endif; ?>
...
_mass_edit_check" class="small"><?php endif; ?>
			...
			<?php if ($this->_tpl_vars['fldname'] == 'ticket' && $this->_tpl_vars['MODULE'] == 'Incidents' && $this->_tpl_vars['OP_MODE'] == 'create_view'): ?>
				<td width=30% align=left class="dvtCellInfo">
...
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
			...
			<?php elseif ($this->_tpl_vars['fldname'] == 'ticket' && $this->_tpl_vars['MODULE'] == 'Incidents' && $this->_tpl_vars['OP_MODE'] == 'edit_view'): ?>
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="<?php echo $this->_tpl_vars['fldname']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
...
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
			...
			<?php elseif ($this->_tpl_vars['fldname'] == 'user' && $this->_tpl_vars['MODULE'] == 'TraitementIncidents' && $this->_tpl_vars['OP_MODE'] == 'create_view'): ?>
				<td width=30% align=left class="dvtCellInfo">
...
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
			...
			<?php elseif ($this->_tpl_vars['fldname'] == 'user' && $this->_tpl_vars['MODULE'] == 'TraitementIncidents' && $this->_tpl_vars['OP_MODE'] == 'edit_view'): ?>
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="vue" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" readonly="true" value="<?php echo $this->_tpl_vars['USER']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
...
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
			...
			<?php elseif ($this->_tpl_vars['fldname'] == 'ticket' && $this->_tpl_vars['MODULE'] == 'TraitementIncidents' && $this->_tpl_vars['OP_MODE'] == 'create_view'): ?>
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="<?php echo $this->_tpl_vars['fldname']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
...
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
			...
			<?php elseif ($this->_tpl_vars['fldname'] == 'ticket' && $this->_tpl_vars['MODULE'] == 'TraitementIncidents' && $this->_tpl_vars['OP_MODE'] == 'edit_view'): ?>
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="<?php echo $this->_tpl_vars['fldname']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" readonly="true" value="<?php echo $this->_tpl_vars['fldvalue']; ?>
...
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
			...
			<?php elseif ($this->_tpl_vars['fldname'] == 'datemodification' && $this->_tpl_vars['MODULE'] == 'TraitementIncidents'): ?>
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="<?php echo $this->_tpl_vars['fldname']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
...
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'" rows=2><?php echo $this->_tpl_vars['fldvalue']; ?>
		...
		<?php elseif (( $this->_tpl_vars['uitype'] == 15 || $this->_tpl_vars['uitype'] == 16 ) && $this->_tpl_vars['fldname'] == 'statut'): ?>
			<input type="hidden" name="<?php echo $this->_tpl_vars['fldname']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" id ="<?php echo $this->_tpl_vars['fldname']; ?>
" value="<?php echo $this->_tpl_vars['STATUT']; ?>
">
			
		<?php elseif ($this->_tpl_vars['fldname'] != 'statut' && ( $this->_tpl_vars['uitype'] == 15 || $this->_tpl_vars['uitype'] == 16 ) && $this->_tpl_vars['fldname'] != 'destination'): ?> <!-- uitype 111 added for noneditable existing picklist values - ahmed -->
...
" disabled class="small" >	
				<?php elseif ($this->_tpl_vars['MODULE'] == 'TraitementIncidents' && $this->_tpl_vars['STATUT'] == 'closed' && $this->_tpl_vars['fldname'] == 'origine' && $this->_tpl_vars['ORIGINE'] != ''): ?>
			   		<select name="<?php echo $this->_tpl_vars['fldname']; ?>
" disabled class="small" >	
				<?php elseif ($this->_tpl_vars['MODULE'] == 'TraitementIncidents' && $this->_tpl_vars['STATUT'] == 'traited' && $this->_tpl_vars['fldname'] == 'origine' && $this->_tpl_vars['ORIGINE'] != ''): ?>
			   		<select name="<?php echo $this->_tpl_vars['fldname']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" class="small">
				<?php else: ?>
...
" class="small">
			   ...
			   STATUT : <?php echo $this->_tpl_vars['STATUT']; ?>
 <br/> fldname : <?php echo $this->_tpl_vars['fldname']; ?>
<br/>  ORIGINE : <?php echo $this->_tpl_vars['ORIGINE']; ?>
<br/>
...
?>
					<?php if (( $this->_tpl_vars['MODULE'] == 'TraitementIncidents' && $this->_tpl_vars['STATUT'] == 'closed' && $this->_tpl_vars['fldname'] == 'origine' && $this->_tpl_vars['ORIGINE'] != '' ) || ( $this->_tpl_vars['MODULE'] == 'TraitementIncidents' && $this->_tpl_vars['STATUT'] == 'traited' && $this->_tpl_vars['fldname'] == 'origine' && $this->_tpl_vars['ORIGINE'] != '' )): ?>
						
						<?php if ($this->_tpl_vars['arr'][0] == $this->_tpl_vars['APP']['LBL_NOT_ACCESSIBLE']): ?>
							<?php if ($this->_tpl_vars['arr'][0] == $this->_tpl_vars['ORIGINE']): ?>
								<?php $this->assign('IS_SELECTED', 'selected'); ?>
							<?php else: ?>	
								<?php $this->assign('IS_SELECTED', ''); ?>
							<?php endif; ?>
							<option value="<?php echo $this->_tpl_vars['arr'][0]; ?>
" <?php echo $this->_tpl_vars['IS_SELECTED']; ?>
>
								<?php echo $this->_tpl_vars['arr'][0]; ?>

							</option>
						<?php else: ?>
							<?php if ($this->_tpl_vars['arr'][1] == $this->_tpl_vars['ORIGINE']): ?>
								<?php $this->assign('IS_SELECTED', 'selected'); ?>
							<?php else: ?>	
								<?php $this->assign('IS_SELECTED', ''); ?>
							<?php endif; ?>
...
?>
				...
				<?php if ($this->_tpl_vars['uitype'] == 6 && $this->_tpl_vars['CATEGORY'] == 'Incidents'): ?>
