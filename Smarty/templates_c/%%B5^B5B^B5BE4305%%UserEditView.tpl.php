<?php /* Smarty version 2.6.18, created on 2009-09-29 09:58:19
         compiled from UserEditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'UserEditView.tpl', 64, false),)), $this); ?>
...
">
	...
	<tr><td align="left">
		...
		<tr>
			<td rowspan="2"><img src="<?php echo vtiger_imageurl('ico-users.gif', $this->_tpl_vars['THEME']); ?>
" align="absmiddle"></td>
			<td>	
...
?>
					<tr><td class="dvtCellLabel" align="right" width="30%"><?php echo $this->_tpl_vars['UMOD'][$this->_tpl_vars['values']]; ?>
</td>
...
. <?php echo $this->_tpl_vars['UMOD']['LBL_TAGCLOUD_DISPLAY']; ?>
				...
				<br>
				<tr><td colspan=4><div><font color="red">(f) : champs facultatifs</font></div></td></tr>
