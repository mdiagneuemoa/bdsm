<?php /* Smarty version 2.6.18, created on 2009-10-06 20:27:35
         compiled from ComposeEmail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'ComposeEmail.tpl', 80, false),)), $this); ?>
...
?>
   ...
   <tr>
	<td class="mailSubHeader" align="right"><b><?php echo $this->_tpl_vars['MOD']['LBL_TO']; ?>
</b></td>
...
_hidden" value="" />
	...
	<?php if ($_REQUEST['attachment'] != ''): ?>
                <tr><td width="100%" colspan="2"><?php echo $_REQUEST['attachment']; ?>
<input type="hidden" value="<?php echo $_REQUEST['attachment']; ?>
