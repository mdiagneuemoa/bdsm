<?php /* Smarty version 2.6.18, created on 2009-10-06 17:50:59
         compiled from HReportsListView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'HReportsListView.tpl', 215, false),array('function', 'html_options', 'HReportsListView.tpl', 249, false),)), $this); ?>
...
<table border="1" width="100%" class="tableDoc">
	<tr valign=top>
		<td width="100">
			<div><?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'ListFolders.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?></div>	
		</td>
		<td valign="top">
			...
			<div id="ListViewContents" class="small" style="width:100%;">
				<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "HReportsListViewEntries.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
			</div>
...
<!-- Add new Folder UI for HReports module starts -->
...
<!-- Add new folder UI for HReports module ends -->
