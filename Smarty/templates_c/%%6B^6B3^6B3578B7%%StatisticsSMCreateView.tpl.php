<?php /* Smarty version 2.6.18, created on 2021-02-23 16:07:04
         compiled from StatisticsSMCreateView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'StatisticsSMCreateView.tpl', 343, false),array('modifier', 'date_format', 'StatisticsSMCreateView.tpl', 464, false),array('function', 'html_options', 'StatisticsSMCreateView.tpl', 380, false),)), $this); ?>
...
')" class="crmbuttom small edit" >
 ...
 " onClick="totalnoofrows();callSearch('Advanced');">
							...
							<hr>
				<div><b>INTERFACE DE SAISIE DES DONN&Eacute;ES</b></div>
                
					<div id="divContainer">
					<br>
					<!--div>
						<textarea  name="excel_data" id="excel_data"></textarea>
					</div-->
				<table border=0 cellspacing=0 cellpadding=0 width=98% align=center>
				 ...
				 <td>
					<div id="filterAcc3" style="z-index:1;display:block;position:relative;">
						<form name="basicFilter3" method="post" action="index.php">
							<table width="98%" cellpadding="5" cellspacing="5"  class="searchUIBasic small" align="center" border=0>
								...
								<!--tr>
									...
									<td class="small" nowrap align=left colspan=2>
										 ...
										 <input type="radio" id="pays" name="pays" value="CI"><label for="pays">CÔTE D'IVOIRE</label>&nbsp;&nbsp;
								...
								<input type="hidden" id="pays" name="pays" value="BN">
									<tr>
									...
									<tr>
									<td class="small" nowrap width=50 nowrap><b>FICHE</b>&nbsp;:</td>
									<td class="small" nowrap align=left colspan=2>
										
												<select name="cfiche" id="cfiche" onchange="getFichesByCat();" class="txtBox" style="width:200px">
													<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['CFICHES']), $this);?>

												</select>
												<select name="fiche" id="fiche" onchange="getSousFichesByFiche();"  class="txtBox" style="width:220px">
													<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['FICHES']), $this);?>

												</select>
												<select name="sousfiche" id="sousfiche" class="txtBox" style="width:220px">
													<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['SFICHES']), $this);?>

												</select>															
																			
									</td>
									<tr>
									<td class="small"  nowrap><b>TYPE DE COLLECTE</b>&nbsp;:</td>
									<td class="small" nowrap align=left >
										 <input type="radio"  id="typesaisie" name="typesaisie" value="FORM" ><label for="typesaisie"><b>FORMULAIRE DE SAISIE</b></label>&nbsp;&nbsp;
										 <input type="radio" id="typesaisie" name="typesaisie" value="UPLOAD" checked><label for="typesaisie"><b>CHARGEMENT FICHIER EXCEL</b></label>&nbsp;&nbsp;
										
									</td>	
																	
									<td class="small" nowrap align="right" >
											<input name="submit" type="button" class="crmbutton small create" onClick="callSaisie();" value=" Lancer la saisie ">&nbsp;
										</td>	
									</tr>
