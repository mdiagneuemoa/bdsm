<?php /* Smarty version 2.6.18, created on 2015-12-02 23:03:45
         compiled from ListViewUsersGID.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'ListViewUsersGID.tpl', 217, false),array('function', 'html_options', 'ListViewUsersGID.tpl', 250, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
	  ...
	  <?php if ($this->_tpl_vars['MODULE'] != 'Documents'): ?>
			<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "ListViewEntriesUsersGID.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	  <?php else: ?>
