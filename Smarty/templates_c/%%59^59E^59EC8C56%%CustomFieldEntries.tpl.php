<?php /* Smarty version 2.6.18, created on 2009-07-23 14:19:05
...
">
				...
				<table  class="listTableTopButtons" border="0" cellpadding="5" cellspacing="0" width="100%">
					...
					<?php if ($this->_tpl_vars['MODULE'] == 'Calendar'): ?>
						<td align="right"><input type="radio" name="activitytype" value="E" checked>&nbsp;<?php echo $this->_tpl_vars['APP']['Event']; ?>
