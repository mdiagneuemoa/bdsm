<?php /* Smarty version 2.6.18, created on 2009-09-17 13:00:44
         compiled from Webmails.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'Webmails.tpl', 17, false),)), $this); ?>
...
&return_module=Webmails&return_action=index" class="webMnu"><?php echo $this->_tpl_vars['MOD']['LBL_SETTINGS']; ?>
						...
						<tr>
							<td colspan=2> 
								<table border=0 width="100%" cellspacing=5 cellspacing=5>
									<tr>
										<td rowspan=6 valign=top class="MatrixLayer1">
											<table  border=0 width="100%" cellspacing=0 cellspacing=0>
												<tr>	
													<td width="20%" nowrap  class="big mailSubHeader"><b><?php echo $this->_tpl_vars['MOD']['LBL_EMAIL_FOLDERS']; ?>
</b></td>
												</tr>
												<tr>
													<td>
...
?>
									...
									<tr><td  class="hdrNameBg"  style="height:20px;">&nbsp;</td></tr>
