<?php /* Smarty version 2.6.18, created on 2009-10-06 16:56:48
				...
				<?php if ($this->_tpl_vars['MOD'][$this->_tpl_vars['reportdetails']['reportname']] != ''): ?>
					<td>
						<span class="fontMarron">
							<a href="index.php?module=Reports&action=SaveAndRun&record=<?php echo $this->_tpl_vars['reportdetails']['reportid']; ?>
...
"><?php echo $this->_tpl_vars['reportdetails']['reportname']; ?>
				...
				<?php if ($this->_tpl_vars['reportdetails']['customizable'] == '1'): ?>
...
..." border="0"></a>
				<?php endif; ?>
				<?php if ($this->_tpl_vars['reportdetails']['state'] != 'SAVED'): ?>
