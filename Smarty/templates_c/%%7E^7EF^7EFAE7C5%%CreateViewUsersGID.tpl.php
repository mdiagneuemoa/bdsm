<?php /* Smarty version 2.6.18, created on 2011-02-24 17:42:47
         compiled from CreateViewUsersGID.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'CreateViewUsersGID.tpl', 218, false),array('function', 'html_options', 'CreateViewUsersGID.tpl', 251, false),)), $this); ?>
...
Ajax&ajax=true&search=true',
			postBody:urlstring +'query=true&file=CreateUsersGID&module=<?php echo $this->_tpl_vars['MODULE']; ?>
&action=<?php echo $this->_tpl_vars['MODULE']; ?>
Ajax&ajax=true&search=true',
...
//			postBody: 'module='+module+'&action='+module+'Ajax&file=index&ajax=true&search=true&'+url,
			postBody: 'module='+module+'&action='+module+'Ajax&file=CreateUsersGID&ajax=true&search=true&'+url,
			onComplete: function(response) {
				$("status").style.display="none";
				result = response.responseText.split('&#&#&#');
				$("ListViewContents").innerHTML= result[2];
...
<table width="80%" cellpadding="5" cellspacing="0"  class="searchUIBasic small" align="center" border=0>
	<tr>
		...
		<td class="small" nowrap align=right> </td>
...
">
						<input type="hidden" name="action" value="CreateUsersGID"> 
...
unset($_smarty_tpl_vars);
 ?>
	  ...
	  <?php if ($this->_tpl_vars['MODULE'] != 'Documents'): ?>
			<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "CreateViewEntriesUsersGID.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	  <?php else: ?>
