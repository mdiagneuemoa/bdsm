<?php /* Smarty version 2.6.18, created on 2009-05-14 16:08:35
         compiled from Inventory/ProductDetails.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'Inventory/ProductDetails.tpl', 171, false),)), $this); ?>
...
function displayCoords(currObj,obj,mode,curr_row) 
{
	if(mode != 'discount_final' && mode != 'sh_tax_div_title' && mode != 'group_tax_div_title')
	{
		...
		if(curr_productid == '')
		{
			alert("<?php echo $this->_tpl_vars['APP']['PLEASE_SELECT_PRODUCT']; ?>
");
			return false;
		}
...
><?php echo $this->_tpl_vars['currency_details']['currencylabel']; ?>
...
">
				<img id="searchIcon1" src="<?php echo vtiger_imageurl('search.gif', $this->_tpl_vars['THEME']); ?>
...
" onClick="$('<?php echo $this->_tpl_vars['comment']; ?>
