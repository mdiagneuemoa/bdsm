...
{ldelim}
    ...
    {ldelim}
    	alert('{$MOD.SUPERIEUR_H_REQUIRED}');
		return false;
    {rdelim}
    ...
    {ldelim}
   	alert('{$MOD.COORDONATEUR_REQUIRED}');
		return false;
    {rdelim}
			...
			<tr>
				<td valign=top>
					...
					<table width="100%"  border="0" cellspacing="0" cellpadding="5">
                      				<tr class="small">
							<td width="15%" class="small cellLabel">{$CMOD.LBL_GROUP_NAME}</strong> <font color="red">*</font></td>
					...
					<!--			
							  	<tr class="small" width="20%">
									<td class="small"></font>
										<strong>{$CMOD.LBL_IDENTIFIANT}</strong> :&nbsp;
										<input id="identifiant" name="identifiant" type="text" value="{$GROUPNAME}" size="5">&nbsp;&nbsp;
										<input type="button" class="crmButton small" name="ok" value="  {$MOD.LBL_OK_BUTTON_LABEL}  " onClick="return;">
									</td>
								</tr>
                    ...
                    -->	     
                    			...
                    			<input type="hidden" name="findStr" class="small">&nbsp;	
                          		...
                          		<tr class=small>
									...
									<td width="50">
										<div align="center">
											<input type="button" name="Button2" value="&nbsp;{$CMOD.LBL_N_PLUS_UN}&nbsp;" onClick="addSuperieurH()" class="crmButton small"/><br /><br />
											<input type="button" name="Button3" value="&nbsp;{$CMOD.LBL_COORD}&nbsp;" onClick="addCoordonnateur()" class="crmButton small"/><br /><br />
										...
										<table>
											...
											<tr>
												<td>
													...
													<strong>{$CMOD.LBL_SUPERIEUR_H}</strong> <font color="red">*</font> :&nbsp;
												</td>
												<td>
													<input id="superieurH" name="superieurH" value="{$TABSUPCOORD.supName}" readonly="true" type="text" size="20" class="small">
													&nbsp;<input type="image" src="{'clear_field.gif'|@vtiger_imageurl:$THEME}" alt="{$APP.LBL_CLEAR}" title="{$APP.LBL_CLEAR}" LANGUAGE=javascript onClick="this.form.superieurH.value=''; this.form.supId.value='';return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>
													<input type="hidden" id="supId" name="supId" value="{$TABSUPCOORD.supId}" class="small">
												</td>
											</tr>
											<tr>
												<td>
													<strong>{$CMOD.LBL_COORDONNATEUR}</strong> <font color="red">*</font> :&nbsp;
												</td>
												<td>
													<input id="coordonnateur" name="coordonnateur" type="text"  value="{$TABSUPCOORD.coordName}" readonly="true" size="20" class="small">
													&nbsp;<input type="image" src="{'clear_field.gif'|@vtiger_imageurl:$THEME}" alt="{$APP.LBL_CLEAR}" title="{$APP.LBL_CLEAR}" LANGUAGE=javascript onClick="this.form.coordonnateur.value=''; this.form.coordId.value='';return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>
													<input type="hidden" id="coordId" name="coordId"  value="{$TABSUPCOORD.coordId}" class="small">&nbsp;
												</td>
											</tr>
										</table>
								...
								<tr>
									<td colspan=3>
										<ul class=small>
											...
											<li>{$CMOD.LBL_GROUP_MESG4}</li>
											<li>{$CMOD.LBL_GROUP_MESG5}</li>
