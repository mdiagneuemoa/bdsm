		...
		<tr>
			<td>
				...
				<tr>
					...
					{if ($IS_CHARGEMISSIONDEMANDE eq '1') && ($STATUT eq 'submitted' && ($STATUT neq 'om_cancelled' || $STATUT neq 'ag_cancelled' || $STATUT neq 'ch_cancelled'))}
					...
					{/if}
					{if ($IS_POSTEURDEMANDE eq '1' || $CURRENT_USER_PROFIL eq '20') && ($STATUT neq 'om_cancelled' || $STATUT neq 'ag_cancelled'  || $STATUT neq 'ch_cancelled') }
						<input 
										...
										{if $STATUT eq 'signed' || $STATUT eq 'com_submitted' || $STATUT eq 'com_denied' || $STATUT eq 'umv_denied'}
						...
						{if $STATUT eq 'open'}
							...
							{if  $IS_DEMANDEPCOM eq '1' || $IS_DEMANDECCR eq '1'}
								<input title="{$MOD.LBL_SOUMETTREDCPC_BUTTON_LABEL}" class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
												this.form.module.value='TraitementDemandes';
												this.form.action.value='Save';
												this.form.statut.value='signed';
												this.form.dmd.value='{$ID}'; 
												return soumettreDemande('Demandes');"   
										type="submit"  
										name="Edit" 
										value="&nbsp;{$MOD.LBL_SOUMETTREDCPC_BUTTON_LABEL}&nbsp;">&nbsp;
							{else}
							
								<input title="{$MOD.LBL_SOUMETTRECOM_BUTTON_LABEL}" class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
												this.form.module.value='TraitementDemandes';
												this.form.action.value='Save';
												this.form.statut.value='com_submitted';
												this.form.dmd.value='{$ID}'; 
												return soumettreDemande('Demandes');"   
										type="submit"  
										name="Edit" 
										value="&nbsp;{$MOD.LBL_SOUMETTRECOM_BUTTON_LABEL}&nbsp;">&nbsp;
							{/if}
					...
					{/if}	
					{if  ($CURRENT_USER_PROFIL eq '25'  || $CURRENT_USER_PROFIL eq '20' || $IS_INTERIMCOMMISSAIRE eq '1') && $STATUT eq 'com_submitted'} {*    PROFIL COMMISSAIRE *}
							<input 
					...
					{/if}
						...
						{if  ($CURRENT_USER_PROFIL eq '26'  || $CURRENT_USER_PROFIL eq '20'  || $IS_INTERIMRUMV eq '1') && $STATUT neq 'om_cancelled'}  {*    PROFIL RESPONS UMV *}
						...
						{/if}
						{if  ($IS_DIRCABPCOM eq '1' || $IS_INTERIMDIRCABPCOM eq '1' ) && ($STATUT eq 'umv_accepted')} 
							<input 
						...
						{if  ($IS_PRESIDENTCOM eq '1' || $IS_INTERIMPCOM eq '1') && ($STATUT eq 'umv_accepted')} 
							<input 
								title="{$MOD.LBL_REJET_PCOM_BUTTON_LABEL}" 
								class="crmbutton small edit" 
								onclick="this.form.return_module.value='Demandes'; 
								onclick="this.form.return_module.value='Demandes'; 
										this.form.return_action.value='DetailView'; 
								...
								type="submit" 
								name="Edit" 
								value="&nbsp;{$MOD.LBL_REJET_PCOM_BUTTON_LABEL}&nbsp;">&nbsp;
																		
							<input 
								title="{$MOD.LBL_VISER_PCOM_BUTTON_LABEL}" 
								class="crmbutton small edit" 
								onclick="this.form.return_module.value='Demandes'; 
									this.form.return_action.value='DetailView'; 
									this.form.module.value='TraitementDemandes';
									this.form.action.value='Save';
									this.form.statut.value='pcom_authorized';
									this.form.dmd.value='{$ID}'; 
									return ViserDemande('Demandes');"   
								type="submit" 
								name="Edit" 
								value="&nbsp;{$MOD.LBL_VISER_PCOM_BUTTON_LABEL}&nbsp;">&nbsp;
										
						
						{/if}						
						
						{if  ($CURRENT_USER_PROFIL eq '27'  || $CURRENT_USER_PROFIL eq '20') && ($STATUT eq 'authorized' || $STATUT eq 'pcom_authorized')}	{*    PROFIL AGENT UMV *}
							<input 
		...
		{if $MODULE == 'Demandes' }
			{if $STATUT eq 'open'}
				{if  $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'open_mo_pcom.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'open_mo.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}	
			{if $STATUT eq 'com_submitted'}
				{if  $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'submitted_mo_pcom.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'submitted_mo.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}
			{if $STATUT eq 'signed'}
				{if  $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'signed_mo_pcom.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'signed_mo.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}
			{if $STATUT eq 'umv_accepted'}
				{if  $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'umv_accepted_mo_pcom.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'umv_accepted_mo.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}
					
			{if $STATUT eq 'authorized' || $STATUT eq 'pcom_authorized'}
				{if  $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'authorized_mo_pcom.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'authorized_mo.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}
			
			{if $STATUT eq 'umv_denied' }
				{if  $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'umv_denied_mo_pcom.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'umv_denied_mo.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}
			
			{if $STATUT eq 'omgenered' }
				{if  $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'omgenered_mo_pcom.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'omgenered_mo.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}
			
			{if $STATUT eq 'dcpc_denied' || $STATUT eq 'dcpc_cancelled' }
				{if  $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'dcpc_denied_mo_pcom.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'dcpc_denied_mo.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}
			{if $STATUT eq 'dcpc_denied' || $STATUT eq 'dcpc_cancelled' }
				{if  $IS_DEMANDEPCOM eq '1'}
				...
				{/if}
			{/if}
			{if $STATUT eq 'com_denied'}
				{if  $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'com_denied_mo_pcom.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'com_denied_mo.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}
			{if $STATUT eq 'ag_cancelled' || $STATUT eq 'ch_cancelled'}
				{if  $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'ag_cancelled_mo_pcom.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'ag_cancelled_mo.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}
