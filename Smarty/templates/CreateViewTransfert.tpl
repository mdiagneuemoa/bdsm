								...
								<table border=0 cellspacing=0 cellpadding=0 width="100%" class="small">
								   <tr>
									<td  colspan=4 style="padding:5px">
									   <div align="center">
											<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" onclick="this.form.action.value='Save'; this.form.mode.value='transfered'; return formValidate()" type="submit"  name="button" value="  {$APP.LBL_TRANSFERER}  " style="width:75px" >
								   ...
								   <tr>
									<td colspan=2 class="detailedViewHeader">
										{if $header eq 'Description' || $header eq 'DESCRIPTION'}
											<b>{$MOD.LBL_TRANSFERT_COMMENTAIRE}</b></td>
										{else}
											<b>{$header}</b></td>
										{/if}
		                            </tr>
								   ...
								   {include file="DisplayTransfertFields.tpl"}							
