								...
								<table border=0 cellspacing=0 cellpadding=0 width="100%" class="small">
								   <tr>
									<td  colspan=4 style="padding:5px">
									   <div align="center">
											<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" onclick="this.form.action.value='Save'; if(!isFormTraitementValide(this.form)) return false; return formValidate();" type="submit"  name="button" value="  {$APP.LBL_SAVE_BUTTON_LABEL}  " style="width:75px" >
                                            {if $STATUT neq 'closed'}
												<input title="{$APP.LBL_SAVE_TRANSFERT_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_TRANSFERT_BUTTON_TITLE_KEY}" class="crmbutton small save" onclick="this.form.action.value='Save'; this.form.mode.value='traited&transfered'; if(!isFormTraitementValide(this.form)) return false; return formValidate()" type="submit"  name="button" value="  {$APP.LBL_SAVE_TRANSFERT_BUTTON_LABEL}  " style="width:150px" >
											{/if}
										    <input title="{$APP.LBL_CANCEL_BUTTON_TITLE}" accessKey="{$APP.LBL_CANCEL_BUTTON_KEY}" class="crmbutton small cancel" onclick="window.history.back()" type="button" readonly="true" name="button" value="  {$APP.LBL_CANCEL_BUTTON_LABEL}  " style="width:70px">
									   </div>
									</td>
								   </tr>
								   ...
								   <tr>
									<td colspan=4 class="detailedViewHeader">
										{if $STATUT eq 'closed'}
											{if $header eq 'TRAITEMENT INCIDENT'}
												<b>{$MOD.LBL_BLOCK_CLOTURE_INCIDENT}</b>
								   ...
								   {include file="DisplayTraitementIncidentsFields.tpl"}							
...
{if ($MODULE eq 'Emails' || 'Documents' || 'HReports') and ($FCKEDITOR_DISPLAY eq 'true')}
       ...
       {/if}
		{if $MODULE eq 'TraitementIncidents'}
