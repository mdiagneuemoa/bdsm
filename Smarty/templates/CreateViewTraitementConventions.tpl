								...
								<table border=0 cellspacing=0 cellpadding=0 width="100%" class="small">
								   <tr>
									<td  colspan=4 style="padding:5px">
									   <div align="center">
											<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" onclick="this.form.action.value='Save'; if(!isFormTraitementValide(this.form)) return false; return formValidate();" type="submit"  name="button" value="  {$APP.LBL_VALIDATE_BUTTON_LABEL}  " style="width:75px" >
											<input title="{$APP.LBL_REJETER_BUTTON_LABEL}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" onclick="this.form.action.value='Save'; if(!isFormTraitementValide(this.form)) return false; return formValidate();" type="submit"  name="button" value="  {$APP.LBL_REJETER2_BUTTON_LABEL}  " style="width:75px" >
