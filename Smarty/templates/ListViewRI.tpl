...
{ldelim}
	document.location.href="index.php?module={$MODULE}&action=CreateXL&parenttab={$CATEGORY}";
{rdelim}
...
<div id="filterAcc" style="z-index:1;display:none;position:relative;">
	<form name="basicFilter" method="post" action="index.php" onSubmit="return callFilter();">
		<table width="80%" cellpadding="5" cellspacing="0"  class="searchUIBasic small" align="center" border=0>
			...
			<tr>
				<td colspan = 4  class="small" nowrap><b>{$MOD.LBL_PERIODE}</b>&nbsp;</td>
			</tr>
			<tr>
				<td width=80% align=center class=small colspan = 3><b> {$MOD.LNK_LIST_START} </b>&nbsp;
