...
<tr>
	...
	<td class="showPanelBg" valign=top width=100%>
		...
		{if  $MODULE == 'Candidats' && $CURRENT_USER_PROFIL_ID eq '50' }
			<tr><td colspan=2><marquee direction="left" color="red"><font color="red">Dernier d&eacute;lai pour enregister votre candidature &agrave; l'&eacute;dition {$BOURSEEDITION}, {$DELAICANDIDATURE}.</font></MARQUEE>
		{/if}
		<tr>
			<td>
				...
				<tr>
					...
					{*********************************** NOMADE ***************************************************}
					{if  $MODULE eq 'UsersNomade' && ($CURRENT_USER_PROFIL =='20' || $CURRENT_USER_PROFIL =='26' || $CURRENT_USER_PROFIL =='27')}
					...
					{if ($IS_CHARGEMISSIONDEMANDE eq '1') && ($STATUT eq 'submitted' && ($STATUT neq 'om_cancelled' || $STATUT neq 'ag_cancelled' && $STATUT neq 'ch_cancelled' && $STATUT neq 'dir_cancelled'))}
					...
					{/if}
					{if ($IS_POSTEURDEMANDE eq '1' || $CURRENT_USER_PROFIL eq '20') && ($STATUT neq 'om_cancelled' || $STATUT neq 'ag_cancelled' && $STATUT neq 'ch_cancelled' && $STATUT neq 'dir_cancelled') }
						<input 
						...
						{if $STATUT eq 'umv_denied' || $STATUT eq 'open'}
						
							 {if  $ISDEMREJETPOURHORSDELAI eq '1'}
								<input 
										title="{$MOD.LBL_SOUMETTRE_HORSDELAI_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
											this.form.return_action.value='DetailView'; 
											this.form.module.value='TraitementDemandes';
										...
										type="submit" 
										name="Edit" 
										value="&nbsp;{$MOD.LBL_SOUMETTRE_HORSDELAI_BUTTON_LABEL}&nbsp;">&nbsp;
							{/if}
							
							{if  $ISDEMREJETPOURHORSBUDGET eq '1'}
								<input 
										title="{$MOD.LBL_SOUMETTRE_HORSBUDGET_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
											this.form.return_action.value='DetailView'; 
											this.form.module.value='TraitementDemandes';
										...
										type="submit" 
										name="Edit" 
										value="&nbsp;{$MOD.LBL_SOUMETTRE_HORSBUDGET_BUTTON_LABEL}&nbsp;">&nbsp;
							{/if}
							
						{/if}
						{if $STATUT eq 'open'}
						
								{if $CATEROGIEAGENT eq '21' || $CATEROGIEAGENT eq '23'}
								
									{if  $IS_DEMANDEPCOM eq '1' || $IS_DEMANDECIP eq '1' || $IS_DEMANDECJ eq '1'}
										<input 
									...
									{else}
										<input title="{$MOD.LBL_SOUMETTRE_BUTTON_LABEL}" class="crmbutton small edit" 
											onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
												this.form.module.value='TraitementDemandes';
												this.form.action.value='Save';
									...
									{else}
										<input title="{$MOD.LBL_SOUMETTRE_BUTTON_LABEL}" class="crmbutton small edit" 
											onclick="this.form.return_module.value='Demandes'; 
												...
												this.form.module.value='TraitementDemandes';
												this.form.action.value='Save';
												this.form.statut.value='dc_accepted';
												this.form.dmd.value='{$ID}'; 
												return soumettreDemande('Demandes');"   
										type="submit"  
										name="Edit" 
						...
						{/if}	
								...
								{*if $STATUT neq 'submitted' || $STATUT eq 'dir_denied' || $STATUT eq 'umv_tobecorrected' || $STATUT eq 'com_denied' || $STATUT eq 'umv_denied' || $STATUT eq 'dcpc_denied'*}				
									{if $CURRENT_USER_PROFIL neq '20' && $STATUT neq 'om_cancelled'}
										<input 
					...
					{/if}	
						{if  ($CURRENT_USER_PROFIL eq '21' || $CURRENT_USER_PROFIL eq '20' || $IS_INTERIMDIRECTEUR eq '1' || $IS_INTERIMDIRCAB eq '1') && $STATUT eq 'submitted'}    {*    PROFIL DIRECTEUR *}
								<input 
										title="{$MOD.LBL_ANNULER_DIR_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
												this.form.module.value='TraitementDemandes';
										...
										type="submit" 
										name="Edit" 
										value="&nbsp;{$MOD.LBL_ANNULER_DIR_BUTTON_LABEL}&nbsp;">&nbsp;
										
								<input 
										title="{$MOD.LBL_REJET_DIR_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
												this.form.module.value='TraitementDemandes';
										...
										type="submit" 
										name="Edit" 
										value="&nbsp;{$MOD.LBL_REJET_DIR_BUTTON_LABEL}&nbsp;">&nbsp;
						
						
								{if  $IS_DEMANDEPCOM eq '1' || $IS_DEMANDECIP eq '1' || $IS_DEMANDECJ eq '1'}
										<input 
												title="{$MOD.LBL_VISER_DIR_BUTTON_LABEL}" 
												class="crmbutton small edit" 
												onclick="this.form.return_module.value='Demandes'; 
													this.form.return_action.value='DetailView'; 
													this.form.module.value='TraitementDemandes';
											...
											type="submit"  
											name="Edit" 
												value="&nbsp;{$MOD.LBL_VISER_DIR_BUTTON_LABEL}&nbsp;">&nbsp;
								{else}
										<input 
												title="{$MOD.LBL_VISER_DIR_BUTTON_LABEL}" 
												class="crmbutton small edit" 
					...
					{if  ($CURRENT_USER_PROFIL eq '22'  || $CURRENT_USER_PROFIL eq '20' || $IS_INTERIMDIRCAB eq '1') && $STATUT eq 'dir_accepted' && $IS_DIRCABPCOM neq '1'} {*    PROFIL DIRCAB *}
							<input 
						...
						{if  ($CURRENT_USER_PROFIL eq '22'  || $CURRENT_USER_PROFIL eq '20') && $STATUT eq 'submitted' && IS_DIRCAB eq '1'} {*    PROFIL DIRCAB *}
							<input 
										title="{$MOD.LBL_REJET_DC_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
						...
						{if  ($CURRENT_USER_PROFIL eq '25'  || $CURRENT_USER_PROFIL eq '20' || $IS_INTERIMCOMMISSAIRE eq '1') && $STATUT eq 'dc_accepted' && $IS_DIRCABPCOM neq '1'} {*    PROFIL COMMISSAIRE *}
							<input 
										title="{$MOD.LBL_REJET_COM_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
												this.form.module.value='TraitementDemandes';
												this.form.action.value='EditView';
												this.form.statut.value='com_denied';
												this.form.dmd.value='{$ID}'; 
												return RejeterDemande('Demandes');"
										type="submit" 
										name="Edit" 
										value="&nbsp;{$MOD.LBL_REJET_COM_BUTTON_LABEL}&nbsp;">&nbsp;
																		
						<input 
										title="{$MOD.LBL_VISER_COM_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
											this.form.return_action.value='DetailView'; 
											this.form.module.value='TraitementDemandes';
										...
										type="submit" 
										name="Edit" 
										value="&nbsp;{$MOD.LBL_VISER_COM_BUTTON_LABEL}&nbsp;">&nbsp;
						{/if}
						
						{if  ($CURRENT_USER_PROFIL eq '26'  || $CURRENT_USER_PROFIL eq '20') && $STATUT neq 'om_cancelled'}  {*    PROFIL RESPONS UMV *}
								
							{if  $STATUT eq 'com_accepted'}
								<input 
						...
						{/if}
						{if  ($IS_DIRCABPCOM eq '1' || $IS_INTERIMDIRCABPCOM eq '1') && ($STATUT eq 'umv_accepted' || $STATUT eq 'submitted_outdeadline' || $STATUT eq 'submitted_outbudget')} 
						<input 
						...
						<input 
										...
										onclick="this.form.return_module.value='Demandes'; 
											...
											this.form.module.value='TraitementDemandes';
											this.form.action.value='Save';
											this.form.statut.value='authorized';
											this.form.dmd.value='{$ID}'; 
											return ViserDemande('Demandes');"   
										type="submit" 
										name="Edit" 
						...
						{*<input 
										title="{$MOD.LBL_ANNULER_DCPC_OM_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
												this.form.module.value='TraitementDemandes';
												this.form.action.value='EditView';
												this.form.statut.value='dcpc_omcancelled';
												this.form.dmd.value='{$ID}'; 
												return AnnulerDemande('Demandes');"
										type="submit" 
										name="Edit" 
										value="&nbsp;{$MOD.LBL_ANNULER_DCPC_OM_BUTTON_LABEL}&nbsp;">&nbsp;*}
						{/if}
						
						{*if  ($IS_DIRCABPCOM eq '1' && $IS_DEMANDEPCOM eq '1') && $STATUT eq 'umv_accepted'} 
						<input 
										title="{$MOD.LBL_REJET_DCPC_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												...
												this.form.dmd.value='{$ID}'; 
												this.form.statut.value='com_denied';
												this.form.opt.value='com_denied;
												this.form.action.value='EditView';" 
										type="submit" 
										name="Edit" 
										value="&nbsp;{$MOD.LBL_REJET_DCPC_BUTTON_LABEL}&nbsp;">&nbsp;
						...
						{if  ($CURRENT_USER_PROFIL eq '27'  || $CURRENT_USER_PROFIL eq '20') && $STATUT eq 'authorized'}	{*    PROFIL AGENT UMV *}
							<input 
					...
					{if  $MODULE eq 'OrdresMission' && $STATUTOM neq 'om_cancelled'}
							...
							{*	<input 
											title="{$MOD.LBL_EMETTREBILLER_BUTTON_LABEL}" 
											class="crmbutton small edit" 
											onclick="emettrebilletAvion();" 
											type="button" 
											name="Edit" 
											value="&nbsp;{$MOD.LBL_EMETTREBILLER_BUTTON_LABEL}&nbsp;">&nbsp;	*}
							
							<!--input onclick="changePeriodeMission();" class="crmbutton small edit" type="button" name="savePBut" value="Modifier Période Mission" -->
					...
					{if $MODULE eq 'TypeDemandes' || $MODULE eq 'TypeIncidents' }
		...
		{if $MODULE == 'Demandes' }
			{if $STATUT eq 'open'}
				{if $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'open.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{elseif $IS_DEMANDECJ eq '1'}
					<tr><td align="left" ><img src="{'open_cj.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'open_depart.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}	
			{if $STATUT eq 'submitted'}
				{if $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'submitted.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'submitted_depart.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}
			{if $STATUT eq 'submitted_cj'}
				<tr><td align="left" ><img src="{'submitted_cj.png'|@vtiger_imageurl:$THEME}"></td></tr>
			{/if}
			{if $STATUT eq 'dir_accepted'}
				{if $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'dir_accepted.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'dir_accepted_depart.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
					
			{/if}
			{if $STATUT eq 'grcj_accepted'}
				<tr><td align="left" ><img src="{'supcj_accepted.png'|@vtiger_imageurl:$THEME}"></td></tr>
			{/if}
			{if $STATUT eq 'dir_cancelled' || $STATUT eq 'dir_denied'}
				{if $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'dir_denied.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'dir_denied_depart.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}
			{if $STATUT eq 'grcj_denied' || $STATUT eq 'grcj_cancelled'}
				<tr><td align="left" ><img src="{'sup_denied_cj.png'|@vtiger_imageurl:$THEME}"></td></tr>
			{/if}
			{if $STATUT eq 'prcj_denied' || $STATUT eq 'prcj_cancelled'}
				<tr><td align="left" ><img src="{'pr_denied_cj.png'|@vtiger_imageurl:$THEME}"></td></tr>
			{/if}
			{if $STATUT eq 'dc_accepted'}
				{if $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'dc_accepted.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'dc_accepted_depart.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			...
			{if $STATUT eq 'grcj_accepted'}
				<tr><td align="left" ><img src="{'supcj_accepted.png'|@vtiger_imageurl:$THEME}"></td></tr>
			{/if}
			{if $STATUT eq 'prcj_accepted'}
				<tr><td align="left" ><img src="{'prcj_accepted.png'|@vtiger_imageurl:$THEME}"></td></tr>
			{/if}
			{if $STATUT eq 'prcj_accepted'}
				<tr><td align="left" ><img src="{'prcj_accepted.png'|@vtiger_imageurl:$THEME}"></td></tr>
			{/if}
			{if $STATUT eq 'dc_cancelled' || $STATUT eq 'dc_denied'}
				{if $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'dc_denied.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'dc_denied_depart.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}
			{if $STATUT eq 'com_accepted' || $STATUT eq 'pr_accepted'}
				{if $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'dir_accepted.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{elseif $IS_DEMANDECJ eq '1'}
					<tr><td align="left" ><img src="{'pr_accepted_cj.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'com_accepted_depart.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
					
			{/if}
			{if $STATUT eq 'com_cancelled' || $STATUT eq 'com_denied' || $STATUT eq 'pr_denied'}
				{if $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'com_denied.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{elseif $IS_DEMANDECJ eq '1'}
					<tr><td align="left" ><img src="{'pr_denied_cj.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'com_denied_depart.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}
			{if $STATUT eq 'umv_denied' }
				{if $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'umv_denied.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{elseif $IS_DEMANDECJ eq '1'}
					<tr><td align="left" ><img src="{'umv_denied_cj.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'umv_denied_depart.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}
			
			{if $STATUT eq 'umv_accepted' }
				{if $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'umv_accepted.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{elseif $IS_DEMANDECJ eq '1'}
					<tr><td align="left" ><img src="{'umv_accepted_cj.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'umv_accepted_depart.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}
			{if $STATUT eq 'omgenered' }
				{if $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'omgenered.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{elseif $IS_DEMANDECJ eq '1'}
					<tr><td align="left" ><img src="{'omgenered_cj.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'omgenered_depart.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}

			{/if}
			{if $STATUT eq 'authorized' }
				{if $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'authorized.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{elseif $IS_DEMANDECJ eq '1'}
					<tr><td align="left" ><img src="{'authorized_cj.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'authorized_depart.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}
			{if $STATUT eq 'dcpc_denied' || $STATUT eq 'dcpc_cancelled' }
				{if $IS_DEMANDEPCOM eq '1'}
					<tr><td align="left" ><img src="{'dcpc_denied.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{elseif $IS_DEMANDECJ eq '1'}
					<tr><td align="left" ><img src="{'dcpc_denied_cj.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{else}
					<tr><td align="left" ><img src="{'dcpc_denied_depart.png'|@vtiger_imageurl:$THEME}"></td></tr>
				{/if}
			{/if}
		...
		{if  $MODULE == 'Candidats' && $CURRENT_USER_PROFIL_ID eq '50' }
				<tr><td align="right" class="big4">Bonjour, <b>{$CURRENT_USER_NOMPRENOM}</b></td></tr>
					...
					<!--div id="savetraitbut" style="display:none" align=center >
							...
							{if $header== $MOD.LBL_AGENTS_COORDONNEES_BANQUAIRES && $MODULE == 'Agentuemoa'}
								...
								{elseif $header== $MOD.LBL_AGENTS_DONNEES_FAMILLE_ENFANT6 && $MODULE == 'Agentuemoa'}
								 ...
								 {elseif $header== $MOD.LBL_CHOIX_ETABLISSEMENT_2 && $MODULE == 'Candidats'}
									<tr id="donneesenfant6header" style="{$DISPLAY_ETABLISSEMENT2}">		
									<td colspan=2 class="detailedViewHeader">
												<b>{$header}</b>
											</td>
								 </tr>
								 {elseif $header== $MOD.LBL_CHOIX_ETABLISSEMENT_3 && $MODULE == 'Candidats'}
									<tr id="donneesenfant6header" style="{$DISPLAY_ETABLISSEMENT3}">		
									<td colspan=2 class="detailedViewHeader">
												<b>{$header}</b>
											</td>
								 </tr>
								 {elseif $header== $MOD.LBL_DEMANDE_2 && $MODULE == 'Demandes'}
									<tr id="donneesdem2" style="{$DISPLAY_DEMANDE2}">		
									<td colspan=2 class="detailedViewHeader">
												<b>{$header}</b>
											</td>
									<td id="statutdem2" class="detailedViewHeader" align="right" style="display:none">
										<select name="statutdemande2" id="statutdemande2"  tabindex="{$vt_tab}" onchange="showformtraintement2();" class="small" >
											<option value="1">Livr&eacute;</option>
											<option selected value="0">Non Livr&eacute;</option>
										</select>
									</td>	
									{if $header== $MOD.LBL_DEMANDE_2 && $DISPLAY_LIVRAISON2.statut== '1' && $MODULE == 'Demandes' && $CURRENT_USER_PROFIL_ID eq 20}
											<td align="right" ><img src="{'delivered.png'|@vtiger_imageurl:$THEME}"></td>
									{/if}
								 </tr>
								  {elseif $header== $MOD.LBL_DEMANDE_3 && $MODULE == 'Demandes'}
									<tr id="donneesdem3" style="{$DISPLAY_DEMANDE3}">		
									<td colspan=2 class="detailedViewHeader">
												<b>{$header}</b>
											</td>
									<td id="statutdem3" class="detailedViewHeader" align="right" style="display:none">
										<select name="statutdemande3" id="statutdemande3"  tabindex="{$vt_tab}" class="small" onchange="showformtraintement3();">
											<option value="1">Livr&eacute;</option>
											<option selected value="0">Non Livr&eacute;</option>
										</select>
									</td>
									{if $header== $MOD.LBL_DEMANDE_3 && $DISPLAY_LIVRAISON3.statut== '1' && $MODULE == 'Demandes' && $CURRENT_USER_PROFIL_ID eq 20}
											<td align="right" ><img src="{'delivered.png'|@vtiger_imageurl:$THEME}"></td>
									{/if}	
								 </tr>
								  {elseif $header== $MOD.LBL_DEMANDE_4 && $MODULE == 'Demandes'}
									<tr id="donneesdem4" style="{$DISPLAY_DEMANDE4}">		
									<td colspan=2 class="detailedViewHeader">
												<b>{$header}</b>
											</td>
									<td id="statutdem4" class="detailedViewHeader" align="right" style="display:none">
										<select name="statutdemande4" id="statutdemande4"   tabindex="{$vt_tab}" class="small" onchange="showformtraintement4();">
											<option value="1">Livr&eacute;</option>
											<option selected value="0">Non Livr&eacute;</option>
										</select>
									</td>
									{if $header== $MOD.LBL_DEMANDE_4 && $DISPLAY_LIVRAISON4.statut== '1' && $MODULE == 'Demandes' && $CURRENT_USER_PROFIL_ID eq 20}
											<td align="right" ><img src="{'delivered.png'|@vtiger_imageurl:$THEME}"></td>
									{/if}
								 </tr>
								  {elseif $header== $MOD.LBL_DEMANDE_5 && $MODULE == 'Demandes'}
									<tr id="donneesdem5" style="{$DISPLAY_DEMANDE5}">		
									<td colspan=2 class="detailedViewHeader">
												<b>{$header}</b>
											</td>
									<td id="statutdem5" class="detailedViewHeader" align="right" style="display:none">
										<select name="statutdemande5" id="statutdemande5"  tabindex="{$vt_tab}" class="small" onchange="showformtraintement5();">
											<option value="1">Livr&eacute;</option>
											<option selected value="0">Non Livr&eacute;</option>
										</select>
									</td>
									{if $header== $MOD.LBL_DEMANDE_5 && $DISPLAY_LIVRAISON5.statut== '1' && $MODULE == 'Demandes' && $CURRENT_USER_PROFIL_ID eq 20}
											<td align="right" ><img src="{'delivered.png'|@vtiger_imageurl:$THEME}"></td>
									{/if}
								 </tr>
						...
						{if $header neq 'Comments'}
							...
							<table border=0 cellspacing=0 cellpadding=0 width="100%" class="small">
								...
								{elseif $header== $MOD.LBL_CHOIX_ETABLISSEMENT_2 && $MODULE == 'Candidats'}
									<tr id="enfantAgent6fields_{$label}" style="{$DISPLAY_ETABLISSEMENT2} height:25px">	
								{elseif $header== $MOD.LBL_CHOIX_ETABLISSEMENT_3 && $MODULE == 'Candidats'}
									<tr id="enfantAgent6fields_{$label}" style="{$DISPLAY_ETABLISSEMENT3} height:25px">	
								{elseif $header== $MOD.LBL_DEMANDE_2 && $MODULE == 'Demandes'}
								...
								{/if}	
									{foreach key=label item=data from=$detail}
									   ...
									   {assign var=keyadmin value=$data.isadmin}
										...
										{/if}
										{/if}
										{if $keyfldname eq 'datedepart'}
											{assign var=datedepr value=$data.value}
										{/if}
										{if $keyfldname eq 'datearrivee'}
											{assign var=datearrivr value=$data.value}
										{/if}
										{if $keyfldname eq 'duree'}
											{assign var=dureer value=$data.value}
										{/if}
									{/foreach}
								</tr>
							...
							{if $header== $MOD.LBL_DEMANDE_INFORMATION && $DISPLAY_LIVRAISON1.statut== '1' && $MODULE == 'Demandes' && $CURRENT_USER_PROFIL_ID eq 20}
									...
									<td class="dvtCellLabel" align=right width=25%>Description Article</td>
									<td width=25% class="dvtCellInfo" align="left">	
										<span class=detailedViewTextBox>{$DISPLAY_LIVRAISON1.descarticle}</span>
									</td>
									<td class="dvtCellLabel" align=right width=25%>N° de s&eacute;rie </td>
									<td width=25% class="dvtCellInfo" align="left">
										<span class=detailedViewTextBox>{$DISPLAY_LIVRAISON1.numseriearticle}</span>									
									</td>
									</tr>
									<tr height="25">
									<td class="dvtCellLabel" align=right width=25%>Date Livraison</td>
									<td width=25% class="dvtCellInfo" align="left">
										<span class=detailedViewTextBox>{$DISPLAY_LIVRAISON1.datelivraison}</span>									
									</td>
									<td class="dvtCellLabel" align=right width=25%>Commentaire</td>
									<td width=25% class="dvtCellInfo" align="left" colspan=3>
										<textarea class="detailedViewTextBox"cols="110" rows="12">{$DISPLAY_LIVRAISON1.commentaire}</textarea>
									</td>
									</tr>
							{/if}
								{if $DISPLAY_DEMANDE2=='display:;' && $header== $MOD.LBL_DEMANDE_2 && $MODULE == 'Demandes'}
									...
									<td class="dvtCellLabel" align=right width=25%>Description Article</td>
									<td width=25% class="dvtCellInfo" align="left">	
										<input type="text" name="descarticle2" id="descarticle2" tabindex="{$vt_tab}"  class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
									</td>
									<td class="dvtCellLabel" align=right width=25%>N° de s&eacute;rie </td>
									<td width=25% class="dvtCellInfo" align="left">
										<input type="text" name="numserie2" id="numserie2" tabindex="{$vt_tab}"  class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
									</td>
									</tr>
									<tr height="25" id="info2traitement2" style="display:none">
									<td class="dvtCellLabel" align=right width=25%>Commentaire</td>
									<td width=25% class="dvtCellInfo" align="left" colspan=3>
										<textarea class="detailedViewTextBox" tabindex="{$vt_tab}" onFocus="this.className='detailedViewTextBoxOn'" name="comment2" id="comment2"  onBlur="this.className='detailedViewTextBox'" cols="110" rows="12"></textarea>
									</td>
							...
							{if $header== $MOD.LBL_DEMANDE_2 && $DISPLAY_LIVRAISON2.statut== '1' && $MODULE == 'Demandes' && $CURRENT_USER_PROFIL_ID eq 20}
									...
									<td class="dvtCellLabel" align=right width=25%>Description Article</td>
									<td width=25% class="dvtCellInfo" align="left">	
										<span class=detailedViewTextBox>{$DISPLAY_LIVRAISON2.descarticle}</span>
									</td>
									<td class="dvtCellLabel" align=right width=25%>N° de s&eacute;rie </td>
									<td width=25% class="dvtCellInfo" align="left">
										<span class=detailedViewTextBox>{$DISPLAY_LIVRAISON2.numseriearticle}</span>									
									</td>
									</tr>
									<tr height="25">
									<td class="dvtCellLabel" align=right width=25%>Date Livraison</td>
									<td width=25% class="dvtCellInfo" align="left">
										<span class=detailedViewTextBox>{$DISPLAY_LIVRAISON2.datelivraison}</span>									
									</td>
									<td class="dvtCellLabel" align=right width=25%>Commentaire</td>
									<td width=25% class="dvtCellInfo" align="left" colspan=3>
										<textarea class="detailedViewTextBox"cols="110" rows="12">{$DISPLAY_LIVRAISON2.commentaire}</textarea>
									</td>
									</tr>
							{/if}
							{if $DISPLAY_DEMANDE3=='display:;' && $header== $MOD.LBL_DEMANDE_3 && $MODULE == 'Demandes'}
									...
									<td class="dvtCellLabel" align=right width=25%>Description Article</td>
									<td width=25% class="dvtCellInfo" align="left">	
										<input type="text" name="descarticle3" id="descarticle3" tabindex="{$vt_tab}"  class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
									</td>
									<td class="dvtCellLabel" align=right width=25%>N° de s&eacute;rie </td>
									<td width=25% class="dvtCellInfo" align="left">
										<input type="text" name="numserie3" id="numserie3" tabindex="{$vt_tab}"  class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
									</td>
									</tr>
									<tr height="25" id="info2traitement3" style="display:none">
									<td class="dvtCellLabel" align=right width=25%>Commentaire</td>
									<td width=25% class="dvtCellInfo" align="left" colspan=3>
										<textarea class="detailedViewTextBox" tabindex="{$vt_tab}" onFocus="this.className='detailedViewTextBoxOn'" name="comment3" id="comment3"  onBlur="this.className='detailedViewTextBox'" cols="110" rows="12"></textarea>
									</td>
							...
							{if $header== $MOD.LBL_DEMANDE_3 && $DISPLAY_LIVRAISON3.statut== '1' && $MODULE == 'Demandes' && $CURRENT_USER_PROFIL_ID eq 20}
									...
									<td class="dvtCellLabel" align=right width=25%>Description Article</td>
									<td width=25% class="dvtCellInfo" align="left">	
										<span class=detailedViewTextBox>{$DISPLAY_LIVRAISON3.descarticle}</span>
									</td>
									<td class="dvtCellLabel" align=right width=25%>N° de s&eacute;rie </td>
									<td width=25% class="dvtCellInfo" align="left">
										<span class=detailedViewTextBox>{$DISPLAY_LIVRAISON3.numseriearticle}</span>									
									</td>
									</tr>
									<tr height="25">
									<td class="dvtCellLabel" align=right width=25%>Date Livraison</td>
									<td width=25% class="dvtCellInfo" align="left">
										<span class=detailedViewTextBox>{$DISPLAY_LIVRAISON3.datelivraison}</span>									
									</td>
									<td class="dvtCellLabel" align=right width=25%>Commentaire</td>
									<td width=25% class="dvtCellInfo" align="left" colspan=3>
										<textarea class="detailedViewTextBox"cols="110" rows="12">{$DISPLAY_LIVRAISON3.commentaire}</textarea>
									</td>
									</tr>
							{/if}
							{if $DISPLAY_DEMANDE4=='display:;' && $header== $MOD.LBL_DEMANDE_4 && $MODULE == 'Demandes'}
									...
									<td class="dvtCellLabel" align=right width=25%>Description Article</td>
									<td width=25% class="dvtCellInfo" align="left">	
										<input type="text" name="descarticle4" id="descarticle4" tabindex="{$vt_tab}"  class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
									</td>
									<td class="dvtCellLabel" align=right width=25%>N° de s&eacute;rie </td>
									<td width=25% class="dvtCellInfo" align="left">
										<input type="text" name="numserie4" id="numserie4" tabindex="{$vt_tab}"  class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
									</td>
									</tr>
									<tr height="25" id="info2traitement4" style="display:none">
									<td class="dvtCellLabel" align=right width=25%>Commentaire</td>
									<td width=25% class="dvtCellInfo" align="left" colspan=3>
										<textarea class="detailedViewTextBox" tabindex="{$vt_tab}" onFocus="this.className='detailedViewTextBoxOn'" name="comment4" id="comment4"  onBlur="this.className='detailedViewTextBox'" cols="110" rows="12"></textarea>
									</td>
							...
							{if $header== $MOD.LBL_DEMANDE_4 && $DISPLAY_LIVRAISON4.statut== '1' && $MODULE == 'Demandes' && $CURRENT_USER_PROFIL_ID eq 20}
									...
									<td class="dvtCellLabel" align=right width=25%>Description Article</td>
									<td width=25% class="dvtCellInfo" align="left">	
										<span class=detailedViewTextBox>{$DISPLAY_LIVRAISON4.descarticle}</span>
									</td>
									<td class="dvtCellLabel" align=right width=25%>N° de s&eacute;rie </td>
									<td width=25% class="dvtCellInfo" align="left">
										<span class=detailedViewTextBox>{$DISPLAY_LIVRAISON4.numseriearticle}</span>									
									</td>
									</tr>
									<tr height="25">
									<td class="dvtCellLabel" align=right width=25%>Date Livraison</td>
									<td width=25% class="dvtCellInfo" align="left">
										<span class=detailedViewTextBox>{$DISPLAY_LIVRAISON4.datelivraison}</span>									
									</td>
									<td class="dvtCellLabel" align=right width=25%>Commentaire</td>
									<td width=25% class="dvtCellInfo" align="left" colspan=3>
										<textarea class="detailedViewTextBox"cols="110" rows="12">{$DISPLAY_LIVRAISON4.commentaire}</textarea>
									</td>
									</tr>
							{/if}
							{if $DISPLAY_DEMANDE5=='display:;' && $header== $MOD.LBL_DEMANDE_5 && $MODULE == 'Demandes'}
									...
									<td class="dvtCellLabel" align=right width=25%>Description Article</td>
									<td width=25% class="dvtCellInfo" align="left">	
										<input type="text" name="descarticle5" id="descarticle5" tabindex="{$vt_tab}"  class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
									</td>
									<td class="dvtCellLabel" align=right width=25%>N° de s&eacute;rie </td>
									<td width=25% class="dvtCellInfo" align="left">
										<input type="text" name="numserie5" id="numserie5" tabindex="{$vt_tab}"  class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
									</td>
									</tr>
									<tr height="25" id="info2traitement5" style="display:none">
									<td class="dvtCellLabel" align=right width=25%>Commentaire</td>
									<td width=25% class="dvtCellInfo" align="left" colspan=3>
										<textarea class="detailedViewTextBox" tabindex="{$vt_tab}" onFocus="this.className='detailedViewTextBoxOn'" name="comment5" id="comment5"  onBlur="this.className='detailedViewTextBox'" cols="110" rows="12"></textarea>
									</td>
							...
							{if $header== $MOD.LBL_DEMANDE_5 && $DISPLAY_LIVRAISON5.statut== '1' && $MODULE == 'Demandes' && $CURRENT_USER_PROFIL_ID eq 20}
									...
									<td class="dvtCellLabel" align=right width=25%>Description Article</td>
									<td width=25% class="dvtCellInfo" align="left">	
										<span class=detailedViewTextBox>{$DISPLAY_LIVRAISON5.descarticle}</span>
									</td>
									<td class="dvtCellLabel" align=right width=25%>N° de s&eacute;rie </td>
									<td width=25% class="dvtCellInfo" align="left">
										<span class=detailedViewTextBox>{$DISPLAY_LIVRAISON5.numseriearticle}</span>									
									</td>
									</tr>
									<tr height="25">
									<td class="dvtCellLabel" align=right width=25%>Date Livraison</td>
									<td width=25% class="dvtCellInfo" align="left">
										<span class=detailedViewTextBox>{$DISPLAY_LIVRAISON5.datelivraison}</span>									
									</td>
									<td class="dvtCellLabel" align=right width=25%>Commentaire</td>
									<td width=25% class="dvtCellInfo" align="left" colspan=3>
										<textarea class="detailedViewTextBox"cols="110" rows="12">{$DISPLAY_LIVRAISON5.commentaire}</textarea>
									</td>
									</tr>
							{/if}
					{/if}	
		...
		<td style="padding:10px">
			...
			{if $MODULE eq 'OrdresMission' && $CURRENT_USER_PROFIL eq 20 }

				<tr id="changeperiode" style="display: none;" ><td align="center">
						<table width="90%" align=center border=1 cellspacing=1 cellpadding=3 width=100% class="lvt small" valign=top>
							<tr>		
										<td colspan=6 class="detailedViewHeader2">
													<b>ENREGISTREMENT DE LA PERIODE REELLE DE LA MISSION</b>
										</td>
							</tr>
							<tr height="25">
									<td class="dvtCellLabel" align=right width=25%>Date D&eacute;part r&eacute;elle</td>
									<td width=25% class="dvtCellInfo" align="left">
										<input name="datedebutreel" id="datedebutreel" type="date" value="{$DATEDEPR}" tabindex="{$vt_tab}" id="datedebutreel" style="border:1px solid #bababa;" size="11">
										</td>
									<td class="dvtCellLabel" align=right width=25%>Date Arriv&eacute;e r&eacute;elle</td>
									<td width=25% class="dvtCellInfo" align="left">	
										<input name="datefinreel" id="datefinreel" type="date" value="{$DATEARRIVR}" tabindex="{$vt_tab}" id="datefinreel" style="border:1px solid #bababa;" size="11">
									</td>
							
									<td class="dvtCellLabel" align=right width=25%>Dur&eacute;e r&eacute;elle</td>
									<td width=25% class="dvtCellInfo" align="left">	
										<input name="dureereel" type="text" value="{$dureer}" disabled="true" tabindex="{$vt_tab}" id="dureereel" solid #bababa;" size="11" maxlength="10">
									</td>
									<tr>		
										<td colspan=6 class="detailedViewHeader2" align="right">
												<input onclick="cancelPeriodeReelle();" type="button" name="cancelPBut" value="Annuler" >
												<input onclick="savePeriodeReelle({$ID});" type="button" name="savePBut" value="Enregistrer" >
										</td>
									</tr>
			...
			{/if}
				...
				{/if}	
				{if ($MODULE eq 'OrdresMission' || $MODULE eq 'Demandes') && $NBLINEBUDGETDISP neq '0' }
...
{if  $MODULE eq 'OrdresMission' && ( $CURRENT_USER_PROFIL eq '27' || $CURRENT_USER_PROFIL eq '26'  || $CURRENT_USER_PROFIL eq '20')}
						...
						<!--input 
										title="{$MOD.LBL_CORRIGER_ENGAGEMENT_BUTTON_LABEL}" 
										class="crmbutton small edit" 
												onclick="return corrigerengagement('{$ID}');"
												type="button" 
												name="Edit" 
										value="&nbsp;{$MOD.LBL_CORRIGER_ENGAGEMENT_BUTTON_LABEL}&nbsp;"-->&nbsp;</td></tr>
						{else}
							<tr><td align=right><input 
