...
alt="Clear" title="Clear" LANGUAGE=javascript	onClick="this.form.{$fldname}.value=''; this.form.{$fldname}_display.value=''; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
		...
		{elseif $uitype eq 2}
			...
			{if $fldname eq 'ticket' && $MODULE eq 'Demandes' && $OP_MODE eq 'create_view' }
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="{$fldname}" tabindex="{$vt_tab}" readonly="true" value="{$NEXTTICKET}" tabindex="{$vt_tab}" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
				</td> 
			{elseif $fldname eq 'ticket' && $MODULE eq 'Demandes' && $OP_MODE eq 'edit_view' }
				<td width=30% align=left class="dvtCellInfo">
			...
			{elseif $fldname eq 'user' && $MODULE eq 'TraitementDemandes' && $OP_MODE eq 'create_view' }
				<td width=30% align=left class="dvtCellInfo">
			...
			{elseif $fldname eq 'user' && $MODULE eq 'TraitementDemandes' && $OP_MODE eq 'edit_view' }
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="vue" tabindex="{$vt_tab}" readonly="true" value="{$USER}" tabindex="{$vt_tab}" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
					<input type="hidden" name="{$fldname}" tabindex="{$vt_tab}" value="{$USER_ID}" tabindex="{$vt_tab}" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
				</td>
			{elseif $fldname eq 'ticket' && $MODULE eq 'TraitementDemandes' && $OP_MODE eq 'create_view' }
				...
				{elseif $fldname eq 'nom' && $MODULE eq 'TraitementDemandes' && $OP_MODE eq 'create_view' }
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="{$fldname}" tabindex="{$vt_tab}" readonly="true" value="{$NOMAGENT}" tabindex="{$vt_tab}" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
				</td> 
				{elseif $fldname eq 'matricule' && $MODULE eq 'TraitementDemandes' && $OP_MODE eq 'create_view' }
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="{$fldname}" tabindex="{$vt_tab}" readonly="true" value="{$NOMAGENT}" tabindex="{$vt_tab}" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
				</td> 
				{elseif $fldname eq 'service' && $MODULE eq 'TraitementDemandes' && $OP_MODE eq 'create_view' }
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="{$fldname}" tabindex="{$vt_tab}" readonly="true" value="{$SERVICEAGENT}" tabindex="{$vt_tab}" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
				</td> 
				{elseif $fldname eq 'fonction' && $MODULE eq 'TraitementDemandes' && $OP_MODE eq 'create_view' }
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="{$fldname}" tabindex="{$vt_tab}" readonly="true" value="{$FONCTIONAGENT}" tabindex="{$vt_tab}" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
				</td> 
				{elseif $fldname eq 'ticket' && $MODULE eq 'TraitementDemandes' && $OP_MODE eq 'edit_view' }
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="{$fldname}" tabindex="{$vt_tab}" readonly="true" value="{$fldvalue}" tabindex="{$vt_tab}" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
				</td>
			{elseif $fldname eq 'datemodification' && $MODULE eq 'TraitementDemandes' }
				<td width=30% align=left class="dvtCellInfo">
		...
		{elseif ($uitype eq 15 || $uitype eq 16) && $fldname eq 'statut' }
			<input type="hidden" name="{$fldname}" tabindex="{$vt_tab}" id ="{$fldname}" value="{$STATUT}">
			
		{elseif $fldname neq 'statut' && ( $uitype eq 15 || $uitype eq 16) && $fldname neq 'destination' } <!-- uitype 111 added for noneditable existing picklist values - ahmed -->
			...
			{if $fldname eq 'motif'}
					<select name="{$fldname}" tabindex="{$vt_tab}" class="small" style="width:260px;">
