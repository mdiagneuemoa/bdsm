...
<table border="0" cellpadding="5" cellspacing="0" width="100%">
					  ...
					  <tr>
					     <td style="padding:10px">
							...
							<td colspan=4 class="tableHeading">
						     ...
						     {if $ACTIVITY_MODE neq 'Task'}
									...
									<tr>
										...
										<td class="cellInfo" align="left" colspan="3"><input name="subject" type="text" class="textbox" value="{$ACTIVITYDATA.subject}" style="width:50%">&nbsp;&nbsp;&nbsp;
										<!--
							...
							<tr>
								...
								<td class="cellInfo" align="left" colspan="3"><textarea style="width:100%; height : 60px;" name="description">{$ACTIVITYDATA.description}</textarea></td>
                					</tr>
							{/if}
							<tr>
								...
								{/if}
								<td class="cellLabel" align="right">{if $LABEL.eventstatus neq ''}<b><font color="red">{$TYPEOFDATA.eventstatus}</font>{$LABEL.eventstatus}</b>{/if}</td>                                        
							...
							<tr>
								<td class="cellLabel" align="right">{if $LABEL.assigned_user_id != ''}<b>{$LABEL.assigned_user_id}</b>{/if}</td>
								<td class="cellInfo" align="left">
									...
									{if $LABEL.taskpriority neq ''}
										<td class="cellLabel" align="right"><b>{$LABEL.taskpriority}</b>
										<td class="cellInfo" align="left">
							...
							<tr><td>
								<table border=0 cellspacing=0 cellpadding=3 width=100%>
									<tr>
										...
										<td id="cellTabInvite" class="dvtSelectedCell" align=center nowrap><a href="javascript:doNothing()" onClick="switchClass('cellTabInvite','on');switchClass('cellTabRelatedto','off');gshow('addEventInviteUI','',document.EditView.date_start.value,document.EditView.due_date.value,document.EditView.starthr.value,document.EditView.startmin.value,document.EditView.startfmt.value,document.EditView.endhr.value,document.EditView.endmin.value,document.EditView.endfmt.value);ghide('addEventRelatedtoUI');">{$MOD.LBL_INVITE}</a></td>
										<!--
										...
										<td id="cellTabRelatedto" class="dvtUnSelectedCell" align=center nowrap><a href="javascript:doNothing()" onClick="switchClass('cellTabInvite','off');switchClass('cellTabRelatedto','on');ghide('addEventInviteUI');gshow('addEventRelatedtoUI','',document.EditView.date_start.value,document.EditView.due_date.value,document.EditView.starthr.value,document.EditView.startmin.value,document.EditView.startfmt.value,document.EditView.endhr.value,document.EditView.endmin.value,document.EditView.endfmt.value);ghide('addEventRepeatUI');">{$MOD.LBL_RELATEDTO}</a></td>
										-->
		...
		<table border="0" cellpadding="5" cellspacing="0" width="100%">
			<tr>
                        	<td class="cellLabel" align="right"><b><font color="red">{$TYPEOFDATA.subject}</font>{$MOD.LBL_TODO}</b></td>
                        	<td class="cellInfo" colspan="3" align="left"><input name="subject" value="{$ACTIVITYDATA.subject}" class="textbox" style="width: 70%;" type="text"></td>
           		</tr>
			
			<tr>
				{if $LABEL.description != ''}
				<td class="cellLabel" align="right"><b><font color="red">{$TYPEOFDATA.description}</font>{$LABEL.description}</b></td>
				<td class="cellInfo" align="left" colspan="3"><textarea style="width: 90%; height: 60px;" name="description">{$ACTIVITYDATA.description}</textarea>
				{/if}
				
			</tr>
			<tr>
			{if $LABEL.taskstatus != ''}
				<td class="cellLabel" align="right"><b><font color="red">{$TYPEOFDATA.taskstatus}</font>{$LABEL.taskstatus}</b></td>
				<td class="cellInfo" align="left">
				...
				{if $LABEL.taskpriority != ''}
						<td class="cellLabel" align="right"><b><font color="red">{$TYPEOFDATA.taskpriority}</font>{$LABEL.taskpriority}</b></td>
						<td class="cellInfo" align="left">
			...
			<tr>
				{if $LABEL.assigned_user_id != ''}
					...
					<td class="cellInfo" align="left">
						...
						{if $check eq 0}
								...
								{assign var=style_user value='display:block'}
								{assign var=style_group value='display:none'}
								{assign var=style_staffing value='display:block'}
						{else}
								{assign var=select_group value='checked'}
								{assign var=style_user value='display:none'}
								{assign var=style_group value='display:block'}
								{assign var=style_staffing value='display:none'}
						{/if}
						{if $ACTIVITY_MODE eq 'Task'}
							<input type="radio" name="task_assigntype" {$select_user} value="U" onclick="toggleTaskAssignType(this.value)">&nbsp;{$APP.LBL_USER}
						{else}
							<input type="radio" name="assigntype" {$select_user} value="U" onclick="toggleAssignType(this.value)">&nbsp;{$APP.LBL_USER}
						{/if}
						...
						{if $secondvalue.assigned_user_id neq ''}
							{if $ACTIVITY_MODE eq 'Task'}
								<input type="radio" name="task_assigntype" {$select_group} value="T" onclick="toggleTaskAssignType(this.value)">&nbsp;{$APP.LBL_GROUP}
							{else}
								<input type="radio" name="assigntype" {$select_group} value="T" onclick="toggleAssignType(this.value)">&nbsp;{$APP.LBL_GROUP}
							{/if}
						{/if}
						...
						{if $ACTIVITY_MODE eq 'Task'}
							<span id="task_assign_user" style="{$style_user}">
						...
						{if $secondvalue.assigned_user_id neq ''}
							{if $ACTIVITY_MODE eq 'Task'}
								<span id="task_assign_team" style="{$style_group}">
				...
				<td  class="cellInfo" align="left">
					<table cellspacing=0 cellpadding=3 width=95% id="team_task" style="{$style_staffing}">
					<tr>
					<td align="right"><b>Chef d'Equipe</b></td>
						<td align=left>
							<input readonly name="chefequipe" id="chefequipe" class="small" type="text" value='{$ACTIVITYDATA.chefequipe}'>
							...
							&nbsp;<input type="image" src="{'clear_field.gif'|@vtiger_imageurl:$THEME}" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.chefequipe.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
						</td>
						<td align="right"><b>Coordonnateur</b></td>
						<td align=left nowrap>
							<input readonly name="coordonnateur" id="coordonnateur" class="small" type="text" value='{$ACTIVITYDATA.coordonnateur}'>
							...
							&nbsp;<input type="image" src="{'clear_field.gif'|@vtiger_imageurl:$THEME}" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.coordonnateur.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
						</td>
					</tr>
					<tr>
						<td align="right"><b>Consultant1</b></td>
						<td align=left nowrap>
							<input readonly name="consultant1" id="consultant1" class="small" type="text" value='{$ACTIVITYDATA.consultant1}'>
							...
							&nbsp;<input type="image" src="{'clear_field.gif'|@vtiger_imageurl:$THEME}" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.consultant1.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
						</td>
						<td align="right"><b>Consultant2</b></td>
						<td align=left nowrap>
							<input readonly name="consultant2" id="consultant2" class="small" type="text" value='{$ACTIVITYDATA.consultant2}'>
							...
							&nbsp;<input type="image" src="{'clear_field.gif'|@vtiger_imageurl:$THEME}" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.consultant2.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
						</td>
					</tr>	
					<tr>
						<td align="right"><b>Assistant1</b></td>
						<td align=left nowrap>
							<input readonly name="assistant1" id="assistant1" class="small" type="text" value='{$ACTIVITYDATA.assistant1}'>
							...
							&nbsp;<input type="image" src="{'clear_field.gif'|@vtiger_imageurl:$THEME}" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.assistant1.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
						</td>
						<td align="right"><b>Assistant2</b></td>
						<td align=left nowrap>
							<input readonly name="assistant2" id="assistant2" class="small" type="text" value='{$ACTIVITYDATA.assistant2}'>
							...
							&nbsp;<input type="image" src="{'clear_field.gif'|@vtiger_imageurl:$THEME}" alt="Effacer" title="Effacer" LANGUAGE=javascript	onClick="this.form.assistant2.value=''; this.form.onsubmit='false'; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
						</td>
					</tr>	
				</table>
			</td>
	...
	<tr>
		<td class="cellLabel" align="right"><b>{$MOD.LBL_TODODATETIME}</b></td>
		<td class="cellInfo" align="left">
			<table>
				<tr><td>{$STARTHOUR}</td></tr>
		...
		<td class="cellInfo" align="left">
			{foreach key=date_value item=time_value from=$ACTIVITYDATA.due_date}
				...
				{assign var=time_val value="$time_value"}
			{/foreach}
			<input name="due_date" id="due_date" class="textbox" style="width: 90px;" value="{$date_val}" type="text">
			<img src="{$IMAGE_PATH}btnL3Calendar.gif" alt="{$MOD.LBL_SET_DATE}" title="{$MOD.LBL_SET_DATE}" id="jscal_trigger_due_date" border="0">
			{foreach key=date_fmt item=date_str from=$secondvalue.due_date}
            	{assign var=date_vl value="$date_fmt"}
            {/foreach}
			<script type="text/javascript">
           		...
           		<table width="100%" cellpadding="5" cellspacing="0" border="0">
					{if $LABEL.parent_id neq ''}
                	    <tr>
                            ...
                            <td>
								<input name="task_parent_id" type="hidden" value="{$secondvalue.parent_id}">
								<input name="del_actparent_rel" type="hidden" >
							 ...
							 <td>
								<div id="taskrelatedto" align="left">
									<input name="task_parent_name" readonly type="text" class="calTxt small" value="{$ACTIVITYDATA.parent_id}">
									<input type="button" name="selectparent" class="crmButton small edit" value="{$APP.LBL_SELECT}" onclick="return window.open('index.php?module='+document.EditView.task_parent_type.value+'&action=Popup&maintab=Calendar','test','width=640,height=602,resizable=0,scrollbars=0,top=150,left=200');">
