					  ...
					  <tr>
						...
						<td class="listTableRow small" valign=top nowrap>
							...
							<!--<a href="#" onClick="deletegroup(this,'{$groupvalues.groupid}')";><img src="{'delete.gif'|@vtiger_imageurl:$THEME}" alt="{$LNK_DELETE}" title="{$APP.LNK_DELETE}" border="0" align="absmiddle"></a> -->
								<a onClick="return confirm('{$CMOD.CONFIRMATION_SUPPRESSION_UTILISATEUR}');" href="index.php?module=Users&action=DeleteGroup&returnaction=listgroups&parenttab=Settings&delete_group_id={$groupvalues.groupid}"><img src="{'delete.gif'|@vtiger_imageurl:$THEME}" alt="{$LNK_DELETE}" title="{$APP.LNK_DELETE}" border="0" align="absmiddle"></a>
						</td>
