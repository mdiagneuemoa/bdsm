...
alt="Clear" title="Clear" LANGUAGE=javascript	onClick="this.form.{$fldname}.value=''; this.form.{$fldname}_display.value=''; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
		...
		{elseif $uitype eq 2 }
			...
			{if $fldname eq 'ticket' }
				...
				<td width=30% align=left class="dvtCellInfo">
					<input type="text" name="{$fldname}" tabindex="{$vt_tab}" readonly="true" value="{$TICKET}" tabindex="{$vt_tab}" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'"  size="20">
				</td> 
			{elseif $fldname eq 'datemodification' }
						<input type="hidden" name="{$fldname}" tabindex="{$vt_tab}" readonly="true" value="{$DATEMODIF}" tabindex="{$vt_tab}" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'"  size="20">
			{elseif $fldname eq 'user' }
				<input type="hidden" name="{$fldname}" tabindex="{$vt_tab}" readonly="true" value="{$USER_ID}" tabindex="{$vt_tab}" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'"  size="20">
			{/if }
		...
		{elseif  $fldname eq 'destination' } <!-- uitype 111 added for noneditable existing picklist values - ahmed -->
			<td width="20%" class="dvtCellLabel" align=right>
