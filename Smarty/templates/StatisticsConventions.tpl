...
<td width="100%" valign="top" style="padding: 10px;" class="showPanelBg">
 ...
 <table align="center" border="0" cellpadding="5" cellspacing="1" width="100%" valign="top">
		<tr>
			<td>
			{if $INCIDENTS_NB_DECLARES neq 0 }
					<table align="center" class="lvt small" border="0" cellpadding="5" cellspacing="1" width="100%">
						...
						<tr>
							<td class=lvtCol colspan=6>
								<table width="100%">
									<tr>
										<td align=left>
										 {$MOD.LBL_STAT_INCIDENTS} 
										</td>
								 		<td align=right>
								           {$MOD.LBL_TOTAL_INCIDENTS} : {$INCIDENTS_NB_DECLARES}
							            </td>
							         </tr>
							       </table>
							 </td>
						...
						<tr class=lvtColData>
							<td colspan=2 align="center"><b> {$MOD.LBL_ATRAITER_INCIDENTS} </b></td>
							<td colspan=4 align="center">
								<table width="100%">
									<tr>
										<td align=left>
										 <b> {$MOD.LBL_TRAITE_INCIDENTS} </b>
										</td>
										{if $TYPOLOGY neq '' }
								 		<td align=right>
								          <b> {$MOD.LBL_DUREE_MOYENNE_INCIDENTS} : {$INCIDENTS_DUREE_MOYENNE_TRAITEMENT}</b>
							            </td>
							            {/if}
							         </tr>
							       </table>
						...
						<tr class=lvtColData>
							<td> {$MOD.LBL_NON_SOUFFRANT_INCIDENTS} </td>
							<td> {$MOD.LBL_INCIDENTS_NB_EN_SOUFFRANCE} </td>
							<td> {$MOD.LBL_INCIDENTS_NB_TRAITES_DANS_DELAIS} </td>
							<td> {$MOD.LBL_INCIDENTS_NB_TRAITES_AU_DELA_DELAIS} </td>
							<td> {$MOD.LBL_INCIDENTS_NB_ORIGINE_INTERNE} </td>
					        <td> {$MOD.LBL_INCIDENTS_NB_ORIGINE_EXTERNE} </td>
						</tr>
						<tr class="lvtColData">
							<td align="center"> {$INCIDENTS_NON_TRAITE} </td>
							<td align="center"> {$INCIDENTS_NB_EN_SOUFFRANCE} </td>
							<td align="center"> {$INCIDENTS_NB_TRAITES_DANS_DELAIS} </td>
							<td align="center"> {$INCIDENTS_NB_TRAITES_AU_DELA_DELAIS} </td>
							<td align="center"> {$INCIDENTS_NB_ORIGINE_INTERNE} </td>
					        <td align="center"> {$INCIDENTS_NB_ORIGINE_EXTERNE} </td>
						</tr>
				...
				<td>
					<table align="center" class="lvt small" border="0" cellpadding="5" cellspacing="1" width="100%">
						...
						<tr class=lvtColData>
							<td colspan=2 align="center"><b> {$MOD.LBL_INCIDENTS_NON_TRAITES} </b></td>
								...
								<table width="100%">
									<tr>
										<td align=left>
								 		...
								 		<td align=right>
								          <b> {$MOD.LBL_TAUX_INCIDENTS} : {$INCIDENTS_TAUX_TRAITEMENT}</b>
							            </td>
							         </tr>
							      </table>
							</td>
			...
			<tr>
					   <td align="center">
							<img src='/gidpcci/modules/StatisticsConventions/Diagramme.php' width="400" height="215"/>
				       </td>
				       <td align="center">
							<img src='/gidpcci/modules/StatisticsConventions/Diagramme2.php' width="400" height="215"/>
				      </td>
			</tr>
