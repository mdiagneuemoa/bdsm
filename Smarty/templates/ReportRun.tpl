...
<table class="small reportGenHdr mailClient mailClientBg" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	<td style="border-left: 2px dotted rgb(109, 109, 109); padding: 10px;" width="30%">
		<span class="fontMarron">{$MOD.LBL_SELECT_ANOTHER_REPORT} : </span><br>
...
<tr>
	...
	<table border=0 cellspacing=0 cellpadding=0 width=100%>
		<tr>
			...
			-->
			<td align=left class=small><b>{$MOD.LBL_SELECT_GROUPE} </b></td><td class=small>&nbsp;</td>
			<td align=left class=small><b>{$MOD.LBL_SELECT_TYPOLOGIE} </b></td><td class=small>&nbsp;</td>
