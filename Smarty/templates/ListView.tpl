...
{rdelim}
		...
		{elseif $MODULE eq 'ReportingRegie'}	
			{include file='Buttons_List_ReportingRegie.tpl'}
		{elseif $MODULE eq 'UsersNomade'}	
			{include file='Buttons_List_UsersNomade.tpl'}		
		{else}
		...
		<table width="70%" cellpadding="2" cellspacing="5"  class="searchUIBasic small" align="center" border=0>
			...
			<tr>
				...
				<b> {$APP.LNK_LIST_START} </b>&nbsp;
					<input name="date_start" id="jscal_field_date_start" type="text" style="border:1px solid #bababa;" size="11" maxlength="10" value="{$smarty.now|date_format:"%d-%m-%Y"}">&nbsp;
				...
				<tr>
					<td class="small" nowrap width=40% colspan =4 align = center>
						  <input name="submit" type="button" class="crmbutton small create" onClick="callFilter2();" value=" {$APP.LBL_FILTER} ">&nbsp;
					</td>
				</tr>
	...
	<form name="basicFilter3" method="post" action="index.php" onSubmit="return callFilter3();">
		<table width="70%" cellpadding="2" cellspacing="5"  class="searchUIBasic small" align="center" border=0>
			...
			<tr>
				...
				<td class="small" nowrap align=left colspan=2>
					<div id="filter_depart">
						<select name="depart_field" id="filter_depart_field" class="txtBox" style="width:200px">
						 {html_options  options=$DEPARTEMENTS }
						</select>
					</div>
				</td>	
				</tr>
				...
				<b> {$APP.LNK_LIST_START} </b>&nbsp;
					<input name="date_start" id="jscal_field_date_start2" type="text" style="border:1px solid #bababa;" size="11" maxlength="10" value="{$DATEDEBFILTER}">&nbsp;
					<img src="{$IMAGE_PATH}btnL3Calendar.gif" id="jscal_trigger_date_start2">
					<font size="1"><em old="(yyyy-mm-dd)">({$DATEFORMAT})</em></font>
						<script type="text/javascript" id='massedit_calendar_date_start'>
							Calendar.setup ({ldelim}
							inputField : "jscal_field_date_start2", ifFormat : "{$JS_DATEFORMAT}", showsTime : false, button : "jscal_trigger_date_start2", singleClick : true, step : 1
							{rdelim});
						</script>
					
				<td  align=left>					
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>{$APP.LNK_LIST_END}</b>&nbsp;&nbsp;&nbsp;
					<input name="date_end" id="jscal_field_date_end2" type="text" style="border:1px solid #bababa;" size="11" maxlength="10" value="{$smarty.now|date_format:"%d-%m-%Y"}">&nbsp;
					<img src="{$IMAGE_PATH}btnL3Calendar.gif" id="jscal_trigger_date_end2">
					<font size="1"><em old="(yyyy-mm-dd)">({$DATEFORMAT})</em></font>
						<script type="text/javascript" id='massedit_calendar_date_end'>
							Calendar.setup ({ldelim}
							inputField : "jscal_field_date_end2", ifFormat : "{$JS_DATEFORMAT}", showsTime : false, button : "jscal_trigger_date_end2", singleClick : true, step : 1
							{rdelim});
						</script>
				...
				<tr>
					<td class="small" nowrap width=40% colspan =4 align = center>
						  <input name="submit" type="button" class="crmbutton small create" onClick="callFilter3();" value=" {$APP.LBL_FILTER} ">&nbsp;
					</td>
				</tr>
...
<br>
{if $MODULE eq "Candidats"}
<div align=center><span style="color: #27AE60; font-size: 14px;font-family: Arial, Helvetica, sans-serif;font-weight: bold;">Liste des Candidats à la bourse de Soutien de l’UEMOA à la formation et à la recherche Edition {$BOURSEEDITION}</span>	</div>										
{/if}
