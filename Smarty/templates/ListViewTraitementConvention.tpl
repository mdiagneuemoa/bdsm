					...
					{/if}
			 		{foreach key=libelle item=value from=$traitement}
					   ...
					   {if $libelle eq 'statut' }
						    ...
						    {if $value eq $APP.initiated}
								<td  class="initiate" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							{elseif $value eq $APP.denied}
								<td  class="denied" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							{elseif $value eq $APP.certifiedDFB}
								<td  class="certifiedDFB" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							{elseif $value eq $APP.certifiedDAJ}
								<td  class="certifiedDAJ" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							{elseif $value eq $APP.approve}
								<td  class="approve" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							{elseif $value eq $APP.validate}
								<td  class="validate" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							{elseif $value eq $APP.closed}
								<td  class="closed" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							{elseif $value eq $APP.running}
								<td  class="running" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							{elseif $value eq $APP.approveDAJ}
								<td  class="approveDAJ" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							{elseif $value eq $APP.finalised}
								<td  class="complete" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							{/if}
