	...
	<td class="showPanelBg" valign=top width=100%>
			...
			<td>
				...
				<tr>
					...
					{if  ($CURRENT_USER_PROFIL eq '22'  || $CURRENT_USER_PROFIL eq '20' || $IS_INTERIMDIRCAB eq '1') && $STATUT eq 'dir_accepted' && $IS_DIRCABPCOM neq '1'} {*    PROFIL DIRCAB *}
						...
						{if  ($CURRENT_USER_PROFIL eq '22'  || $CURRENT_USER_PROFIL eq '20') && $STATUT eq 'submitted' && (IS_DIRCAB eq '1' || $IS_DIRCABPCOM eq '1')} {*    PROFIL DIRCAB *}
							<input 
										title="{$MOD.LBL_REJET_DC_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
						...
						{/if}
						{if  ($IS_DIRCABPCOM eq '1') && ($STATUT eq 'submitted_outdeadline' || $STATUT eq 'submitted_outbudget')} 
						<input 
						...
						{if  ($CURRENT_USER_PROFIL eq '27'  || $CURRENT_USER_PROFIL eq '20') && $STATUT eq 'umv_accepted'}	{*    PROFIL AGENT UMV *}
							<input 
					...
					{if  ($CURRENT_USER_PROFIL eq '25'  || $CURRENT_USER_PROFIL eq '20' || $IS_INTERIMCOMMISSAIRE eq '1') && $STATUT eq 'umv_accepted'} {*    PROFIL COMMISSAIRE *}
							<input 
		...
		<td style="padding:10px">
			...
			<div id='divdecompteview'>
				...
				{foreach from=$BUDGETDISP item=budget key=k}
					<tr align=center>
						<td class="detailedViewHeader2">{$budget.codebudget}</td>
						<td class="detailedViewHeader2">{$budget.sourcefin}</td>
						<td class="detailedViewHeader2">{$budget.comptenat}</td>
						<td class="detailedViewHeader2">{$budget.fonddisp|number_format:0:",":" "}</td>
						<td class="detailedViewHeader2">{$budget.fondengage|number_format:0:",":" "}</td>
						<td class="detailedViewHeader2">{$budget.mntdispo|number_format:0:",":" "}</td>
					</tr>	
				{/foreach}
				{foreach from=$BUDGETBILLETDISP item=budget key=k}
					<tr align=center>
						<td class="detailedViewHeader2">{$budget.codebudget}</td>
						<td class="detailedViewHeader2">{$budget.sourcefin}</td>
						<td class="detailedViewHeader2">{$budget.comptenat}</td>
