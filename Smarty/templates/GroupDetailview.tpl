			...
			{include file='SetMenu.tpl'}
				...
				<td valign=top>
					...
					<table width="100%"  border="0" cellspacing="0" cellpadding="5">
                      ...
                      <tr class="small">
                        <td width="15%" class="small cellLabel"><strong>{$CMOD.LBL_SUPERIEUR_H}</strong></td>
                        <td width="85%" class="cellText" >{$GROUPINFO.2.supName}</td>
                      </tr>
                      <tr class="small">
                        <td class="small cellLabel"><strong>{$CMOD.LBL_COORDONNATEUR}</strong></td>
                        <td class="cellText">{$GROUPINFO.2.coordName}</td>
                      </tr>
