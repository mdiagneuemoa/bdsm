					...
					{/if}
			 		{foreach key=libelle item=value from=$traitement}
					   ...
					   {if $libelle eq 'statut' }
							value={$value}
						    {if $value eq $APP.open}
								<td  class="open" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							...
							{elseif $value eq $APP.dir_accepted}
							...
							{elseif $value eq $APP.dc_accepted}
								<td  class="accepted" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							{elseif $value eq $APP.com_accepted}
								<td  class="accepted" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							{elseif $value eq $APP.umv_accepted}
								<td  class="accepted" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							{elseif $value eq $APP.authorized}
								<td  class="authorized" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							{elseif $value eq $APP.ch_cancelled}
								<td  class="cancelled" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							{elseif $value eq $APP.dir_cancelled}
								<td  class="cancelled" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							{elseif $value eq $APP.dc_cancelled}
								<td  class="cancelled" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
							{elseif $value eq $APP.com_cancelled}
								<td  class="cancelled" width=180 height=80 onClick="javascript:displayTraitementById('tab_{$i}' , {$NBTRAITEMENT });">
						{/if}
					{/if}	
					{/foreach}
