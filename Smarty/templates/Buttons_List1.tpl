...
<tr>
	...
	{elseif $MODULE eq 'TraitementConventions' || $RIGHT_LABEL eq 'TraitementConventions'}
	...
	{elseif $MODULE eq 'SuiviConventions'}
	...
	{elseif $MODULE eq 'ExecutionConventions'}
	...
	{else}
		{if $MODULE eq 'StatisticsDemandes' || $MODULE eq 'StatisticsIncidents'}
				...
				<tr>
					{if $CHECK.EditView eq 'yes'}
			        		{if $MODULE eq 'Calendar'}
                	   		...
                	   		{elseif $MODULE eq 'HReports' || $MODULE eq 'Documents'}
                	   		...
                	   		{else}	 
                	   			 {if $MODULE eq 'UsersGID'}
                        		       	<td style="padding-right:0px;padding-left:10px;"><a href="index.php?module={$MODULE}&action=CreateUsersGID&return_action=ListView&parenttab={$CATEGORY}"><img src="{$IMAGE_PATH}btnL3Add.gif" alt="{$APP.LBL_CREATE_BUTTON_LABEL} {$SINGLE_MOD}..." title="{$APP.LBL_CREATE_BUTTON_LABEL} {$SINGLE_MOD}..." border=0></a></td>
								 	{elseif $MODULE eq 'ReportingConventions' || $MODULE eq 'TraitementConventions' || $MODULE eq 'ExecutionConventions' || $MODULE eq 'SuiviConventions' || $MODULE eq 'SBConventions'}
										<td style="padding-right:0px;padding-left:10px;"><img src="{'btnL3Add-Faded.gif'|@vtiger_imageurl:$THEME}" border=0></td>	
                	   			 	{else}
			              	...
			              	{/if}
					{elseif $MODULE eq 'TraitementDemandes' || $MODULE eq 'TraitementIncidents' || $MODULE eq 'TraitementConventions' || $MODULE eq 'SBConventions' }
						<td style="padding-right:0px;padding-left:10px;"><img src="{'btnL3Add-Faded.gif'|@vtiger_imageurl:$THEME}" border=0></td>	
					{else}
						<td style="padding-right:0px;padding-left:10px;"><img src="{'btnL3Add-Faded.gif'|@vtiger_imageurl:$THEME}" border=0></td>	
					{/if}
