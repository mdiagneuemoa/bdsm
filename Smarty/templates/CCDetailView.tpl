	...
	<td class="showPanelBg" valign=top width=100%>
			...
			<td>
				...
				<tr>
					...
					{if  $MODULE eq 'Demandes'}
							...
							{if ($IS_CHARGEMISSIONDEMANDE eq '1') && ($STATUT eq 'submitted' && ($STATUT neq 'ag_cancelled' && $STATUT neq 'ch_cancelled' && $STATUT neq 'dir_cancelled'))}
							...
							{/if}
							{if ($IS_POSTEURDEMANDE eq '1' || $CURRENT_USER_PROFIL eq '20') && ($STATUT neq 'ag_cancelled' && $STATUT neq 'ch_cancelled' && $STATUT neq 'dir_cancelled') }
								<input 
								...
								{if $STATUT eq 'open'}
									...
									<input title="{$MOD.LBL_SOUMETTRECC_BUTTON_LABEL}" class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
												this.form.module.value='TraitementDemandes';
												this.form.action.value='Save';
							...
							{/if}	
						{if  ($CURRENT_USER_PROFIL eq '22' || $CURRENT_USER_PROFIL eq '20' || $IS_INTERIMDIRECTEUR eq '1') && $STATUT eq 'submitted'}    {*    PROFIL DIRECTEUR *}
								<input 
										title="{$MOD.LBL_ANNULER_SUP_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
												this.form.module.value='TraitementDemandes';
										...
										type="submit" 
										name="Edit" 
										value="&nbsp;{$MOD.LBL_ANNULER_SUP_BUTTON_LABEL}&nbsp;">&nbsp;
					...
					{if  ($CURRENT_USER_PROFIL eq '22'  || $CURRENT_USER_PROFIL eq '20' || $IS_INTERIMDIRCAB eq '1') && $STATUT eq 'dir_accepted'} {*    PROFIL DIRCAB *}
							<input 
										title="{$MOD.LBL_REJET_SGCC_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
												this.form.module.value='TraitementDemandes';
										...
										type="submit" 
										name="Edit" 
										value="&nbsp;{$MOD.LBL_REJET_SGCC_BUTTON_LABEL}&nbsp;">&nbsp;
																		
							<input 
										title="{$MOD.LBL_VISER_SGCC_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
											this.form.return_action.value='DetailView'; 
											this.form.module.value='TraitementDemandes';
										...
										type="submit" 
										name="Edit" 
										value="&nbsp;{$MOD.LBL_VISER_SGCC_BUTTON_LABEL}&nbsp;">&nbsp;
							<input title="{$APP.LBL_EDIT_BUTTON_TITLE}" accessKey="{$APP.LBL_EDIT_BUTTON_KEY}" class="crmbutton small edit" onclick="this.form.return_module.value='{$MODULE}'; this.form.return_action.value='DetailView'; this.form.return_id.value='{$ID}';this.form.module.value='{$MODULE}';this.form.action.value='EditView'" type="submit" name="Edit" value="&nbsp;{$APP.LBL_EDIT_BUTTON_LABEL}&nbsp;">&nbsp;

						{/if}
						
						{if  ($CURRENT_USER_PROFIL eq '26'  || $CURRENT_USER_PROFIL eq '20' || $IS_INTERIMRUMV eq '1')}  {*    PROFIL RESPONS UMV *}
						...
						{/if}
						{if  ($IS_PRESIDENTCC eq '1' || $IS_INTERIMPRESIDENTCC eq '1') && ($STATUT eq 'umv_accepted' || $STATUT eq 'submitted_outdeadline' || $STATUT eq 'submitted_outbudget')} 
							<input 
										title="{$MOD.LBL_REJET_PRCC_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
										...
										type="submit" 
										name="Edit" 
										value="&nbsp;{$MOD.LBL_REJET_PRCC_BUTTON_LABEL}&nbsp;">&nbsp;
																		
							<input 
										title="{$MOD.LBL_VISER_PRCC_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
											this.form.return_action.value='DetailView'; 
											this.form.module.value='TraitementDemandes';
										...
										type="submit" 
										name="Edit" 
										value="&nbsp;{$MOD.LBL_VISER_PRCC_BUTTON_LABEL}&nbsp;">&nbsp;
										
						
						{/if}
						
												
						{if  ($CURRENT_USER_PROFIL eq '26'  || $CURRENT_USER_PROFIL eq '20' || $IS_INTERIMRUMV eq '1') && ($STATUT eq 'pr_authorized' || $STATUT eq 'authorized')}	{*    PROFIL AGENT UMV *}
							<input 
							...
							{/if}
							{if  ($CURRENT_USER_PROFIL eq '26'  || $CURRENT_USER_PROFIL eq '20') && $STATUT eq 'omgenered'}	{*    PROFIL AGENT UMV *}
								<input title="{$APP.LBL_EDIT_BUTTON_TITLE}" accessKey="{$APP.LBL_EDIT_BUTTON_KEY}" class="crmbutton small edit" onclick="this.form.return_module.value='{$MODULE}'; this.form.return_action.value='DetailView'; this.form.return_id.value='{$ID}';this.form.module.value='{$MODULE}';this.form.action.value='EditView'" type="submit" name="Edit" value="&nbsp;{$APP.LBL_EDIT_BUTTON_LABEL}&nbsp;">&nbsp;
							{/if}							
					{/if}
					{if  $MODULE eq 'OrdresMission'}
							...
							<input title="{$MOD.LBL_OMVERSO_BUTTON_LABEL}" class="crmbutton small edit" 
										onclick="window.open('http://ouavlibre01/portailnomade/ordremission/ordremissioncc.php?demandeid={$ID}','','');return false;"   
										type="submit"  
										name="Edit" 
										value="&nbsp;{$MOD.LBL_OMRECTOVERSO_BUTTON_LABEL}&nbsp;">&nbsp;
										
							<input title="{$MOD.LBL_OMDECOMPTE_BUTTON_LABEL}" class="crmbutton small edit" 
										onclick="window.open('http://ouavlibre01/portailnomade/ordremission/decomptecc.php?demandeid={$ID}','','');return false;"   
										type="submit"  
										name="Edit" 
		...
		{if $MODULE == 'Demandes' }
			{if $STATUT eq 'open'}
					...
					<tr><td align="left" ><img src="{'open_cc.png'|@vtiger_imageurl:$THEME}"></td></tr>
		
			{/if}	
			{if $STATUT eq 'submitted'}
				
					<tr><td align="left" ><img src="{'submitted_cc.png'|@vtiger_imageurl:$THEME}"></td></tr>
			
			{/if}	
			{if $STATUT eq 'dir_accepted'}
				
					<tr><td align="left" ><img src="{'dir_accepted_cc.png'|@vtiger_imageurl:$THEME}"></td></tr>
			
			{/if}
			{if $STATUT eq 'dir_cancelled' || $STATUT eq 'dir_denied'}
				
					<tr><td align="left" ><img src="{'dir_denied_cc.png'|@vtiger_imageurl:$THEME}"></td></tr>
			
			{/if}
			{if $STATUT eq 'dc_accepted'}
			
					<tr><td align="left" ><img src="{'dc_accepted_cc.png'|@vtiger_imageurl:$THEME}"></td></tr>
			
			{/if}
			{if $STATUT eq 'dc_cancelled' || $STATUT eq 'dc_denied'}
				
					<tr><td align="left" ><img src="{'dc_denied_cc.png'|@vtiger_imageurl:$THEME}"></td></tr>
			
			{/if}
			{if $STATUT eq 'com_accepted' || $STATUT eq 'pr_accepted'}
				
					<tr><td align="left" ><img src="{'com_accepeted_cc.png'|@vtiger_imageurl:$THEME}"></td></tr>
			
			{/if}
			{if $STATUT eq 'com_cancelled' || $STATUT eq 'com_denied' || $STATUT eq 'pr_denied'}
				
					<tr><td align="left" ><img src="{'com_denied_cc.png'|@vtiger_imageurl:$THEME}"></td></tr>
				
			{/if}
			{if $STATUT eq 'umv_denied' }
				
					<tr><td align="left" ><img src="{'umv_denied_cc.png'|@vtiger_imageurl:$THEME}"></td></tr>
				
			{/if}
			
			{if $STATUT eq 'umv_accepted' }
				
					<tr><td align="left" ><img src="{'umv_accepted_cc.png'|@vtiger_imageurl:$THEME}"></td></tr>
			
			{/if}
			{if $STATUT eq 'omgenered' }
				
					<tr><td align="left" ><img src="{'omgenered_cc.png'|@vtiger_imageurl:$THEME}"></td></tr>
			
			{/if}
			{if $STATUT eq 'authorized' || $STATUT eq 'pr_authorized' }
				
					<tr><td align="left" ><img src="{'authorized_cc.png'|@vtiger_imageurl:$THEME}"></td></tr>
				
			{/if}
			{if $STATUT eq 'dcpc_denied' || $STATUT eq 'dcpc_cancelled' || $STATUT eq 'pr_denied'}
				
					<tr><td align="left" ><img src="{'dcpc_denied_cc.png'|@vtiger_imageurl:$THEME}"></td></tr>
		...
		<div id='divdecompteview'>
				...
				<caption class="big2" align=center> RECAPITULATIF DE LA DECOMPTE</caption>
					{if   $CURRENT_USER_PROFIL eq '27' || $CURRENT_USER_PROFIL eq '26'  || $CURRENT_USER_PROFIL eq '20'}
