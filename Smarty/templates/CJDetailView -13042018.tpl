...
<tr>
	...
	<td class="showPanelBg" valign=top width=100%>
			...
			<td>
				...
				<tr>
					...
					{if  $MODULE eq 'Demandes'}
						...
						{if ($IS_CHARGEMISSIONDEMANDE eq '1') && ($STATUT eq 'submitted' && $STATUT neq 'ag_cancelled' && $STATUT neq 'ch_cancelled')}
						...
						{/if}
						{if ($IS_POSTEURDEMANDE eq '1' || $CURRENT_USER_PROFIL eq '20') && ($STATUT neq 'cancelled') }
								<input 
								...
								{if $STATUT eq 'open'}
									...
									<input title="{$MOD.LBL_SOUMETTRECJ_BUTTON_LABEL}" class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
												this.form.module.value='TraitementDemandes';
												...
												this.form.dmd.value='{$ID}'; 
												return soumettreDemandeCJ('Demandes');"   
										type="submit"  
										name="Edit" 
										value="&nbsp;{$MOD.LBL_SOUMETTRECJ_BUTTON_LABEL}&nbsp;">&nbsp;
						...
						{if $CURRENT_USER_PROFIL neq '20' && $STATUT neq 'ag_cancelled' && $STATUT neq 'ch_cancelled'}
							<input 
						...
						{if  ($CURRENT_USER_PROFIL eq '22' || $IS_INTERIMDIRCAB eq '1' || $CURRENT_USER_PROFIL eq '20') && $STATUT eq 'sup_submitted'}    {*    PROFIL GREFFIER CJ *}
								<input 
										title="{$MOD.LBL_ANNULER_CJ_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
												this.form.module.value='TraitementDemandes';
												this.form.action.value='EditView';
												this.form.statut.value='cancelled';
												this.form.dmd.value='{$ID}'; 
												return AnnulerDemande('Demandes');"
										type="submit" 
										name="Edit" 
										value="&nbsp;{$MOD.LBL_ANNULER_CJ_BUTTON_LABEL}&nbsp;">&nbsp;
										
								<input 
										title="{$MOD.LBL_REJET_CJ_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
												this.form.module.value='TraitementDemandes';
												this.form.action.value='EditView';
												this.form.statut.value='grcj_denied';
												this.form.dmd.value='{$ID}'; 
												return RejeterDemande('Demandes');"
										type="submit" 
										name="Edit" 
										value="&nbsp;{$MOD.LBL_REJET_CJ_BUTTON_LABEL}&nbsp;">&nbsp;
													
										<input 
												title="{$MOD.LBL_VISER_CJ_BUTTON_LABEL}" 
												class="crmbutton small edit" 
												onclick="this.form.return_module.value='Demandes'; 
													this.form.return_action.value='DetailView'; 
													this.form.module.value='TraitementDemandes';
													this.form.action.value='Save';
													this.form.statut.value='grcj_accepted';
													this.form.dmd.value='{$ID}'; 
													return ViserDemande('Demandes');"   
											type="submit"  
											name="Edit" 
												value="&nbsp;{$MOD.LBL_VISER_CJ_BUTTON_LABEL}&nbsp;">&nbsp;							
						{/if}	
						{if  ($CURRENT_USER_PROFIL eq '25' || $CURRENT_USER_PROFIL eq '20') && $STATUT eq 'grcj_accepted'}    {*    PROFIL PRESIDENTE CJ *}
								<input 
										title="{$MOD.LBL_ANNULER_PRCJ_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
												this.form.module.value='TraitementDemandes';
										...
										type="submit" 
										name="Edit" 
										value="&nbsp;{$MOD.LBL_ANNULER_PRCJ_BUTTON_LABEL}&nbsp;">&nbsp;
										
								<input 
										title="{$MOD.LBL_REJET_PRCJ_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
												this.form.return_action.value='DetailView'; 
												this.form.module.value='TraitementDemandes';
												this.form.action.value='EditView';
												this.form.statut.value='prcj_denied';
												this.form.dmd.value='{$ID}'; 
												return RejeterDemande('Demandes');"
										type="submit" 
										name="Edit" 
										value="&nbsp;{$MOD.LBL_REJET_PRCJ_BUTTON_LABEL}&nbsp;">&nbsp;
													
										<input 
												title="{$MOD.LBL_VISER_PRCJ_BUTTON_LABEL}" 
												class="crmbutton small edit" 
												onclick="this.form.return_module.value='Demandes'; 
													this.form.return_action.value='DetailView'; 
													this.form.module.value='TraitementDemandes';
											...
											type="submit"  
											name="Edit" 
												value="&nbsp;{$MOD.LBL_VISER_PRCJ_BUTTON_LABEL}&nbsp;">&nbsp;							
						{/if}
						{if  ($CURRENT_USER_PROFIL eq '26'  || $CURRENT_USER_PROFIL eq '20') && $STATUT neq 'cancelled'}  {*    PROFIL RESPONS UMV *}
						...
						{/if}
						{if  ($CURRENT_USER_PROFIL eq '25' || $CURRENT_USER_PROFIL eq '20') && $STATUT eq 'umv_accepted'}    {*    PROFIL PRESIDENT CJ *}
								<input 
										title="{$MOD.LBL_ANNULER_PRCJ_BUTTON_LABEL}" 
										class="crmbutton small edit" 
										onclick="this.form.return_module.value='Demandes'; 
		...
		{if $MODULE == 'Demandes' }
			...
			{if $STATUT eq 'submitted_cj' || $STATUT eq 'sup_submitted'}
