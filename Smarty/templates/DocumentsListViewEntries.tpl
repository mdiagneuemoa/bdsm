						...
						<td>
							<table border=0 cellspacing=0 cellpadding=0>
            					...
            					<td style="padding-right:5px">
            						<input type="button" name="move" value="{$MOD.LBL_MOVE}" class="crmbutton small edit" onClick="fnvshNrm('movefolderlist'); posLay(this,'movefolderlist');" title="{$MOD.LBL_MOVE_RAPPORTS}">
								...
								<!--<input title="Nouveau Document" class="button" onclick="this.form.action.value='EditView';this.form.module.value='{$MODULE}';this.form.return_action.value='DetailView';this.form.folderid.value='{$folder.folderid}';" type="submit" name="button" value="{$APP.LBL_CREATE_BUTTON_LABEL} {$APP.$SINGLE_MOD}">&nbsp;</td>-->
								<a href="index.php?module={$MODULE}&action=EditView&return_action=DetailView&parenttab={$CATEGORY}&folderid={$FOLDERID}"><img src="{$IMAGE_PATH}btnL3Add.gif" alt="{$APP.LBL_CREATE_BUTTON_LABEL} {$APP.$SINGLE_MOD}..." title="{$APP.LBL_CREATE_BUTTON_LABEL} {$APP.$SINGLE_MOD}..." border=0></a></td>
							</tr>
							</table>
						</td>
							...
							<table border=0 cellspacing=0 cellpadding=0 class="small">
								<tr>
									...
									<td style="padding-left:5px;padding-right:5px">
			                            <SELECT NAME="viewname" disabled id="viewname" class="small" onchange="showDefaultCustomView(this,'{$MODULE}','{$CATEGORY}')">{$CUSTOMVIEW_OPTION}</SELECT>
									</td>
			                       <!-- {if $ALL eq 'All'}
					...
					<table class="reportsListTable" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">		
						<tr>
							<td class="mailSubHeader" width="40%">
								<b><img src="{'dossier-ouvert.gif'|@vtiger_imageurl:$THEME}" border="0"  align="absmiddle" style="cursor:pointer;">&nbsp;{$folder.foldername}</b>
								&nbsp;&nbsp;
