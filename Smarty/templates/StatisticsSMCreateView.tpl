...
{*<!-- Searching UI -->*}
			...
			{*include file='StatisticsMenu.tpl'*}
				<hr>
						...
						<form name="basicFilter3" method="post" action="index.php">
							<table width="98%" cellpadding="5" cellspacing="5"  class="searchUIBasic small" align="center" border=0>
								...
								<input type="hidden" id="pays" name="pays" value="BN">
						            ...
						            <input type="hidden" name="sfiche" id="sfiche" value="{$SFICHE}">
						            <input type="hidden" name="sficheid" id="sficheid" value="{$SFICHEID}">
